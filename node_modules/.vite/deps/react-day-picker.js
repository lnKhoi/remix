...
function WeekNumber(props) {
  ...
  return import_react24.default.createElement("td", { ...tdProps });
}
...
// node_modules/react-day-picker/dist/esm/lib/dateLib.js
var dateLib = {
...
// node_modules/react-day-picker/dist/esm/helpers/getDateLib.js
...
function formatCaption(month, options, dateLib2 = dateLib) {
  return dateLib2.format(month, "LLLL y", options);
}
var formatMonthCaption = formatCaption;

// node_modules/react-day-picker/dist/esm/formatters/formatDay.js
function formatDay(date, options, dateLib2 = dateLib) {
  return dateLib2.format(date, "d", options);
}

// node_modules/react-day-picker/dist/esm/formatters/formatMonthDropdown.js
function formatMonthDropdown(monthNumber, locale = enUS) {
  var _a;
...
function formatWeekdayName(weekday, options, dateLib2 = dateLib) {
  return dateLib2.format(weekday, "cccccc", options);
}
...
function getMonthOptions(displayMonth, navStart, navEnd, formatters2, locale, dateLib2) {
  if (!navStart)
    return void 0;
  if (!navEnd)
    return void 0;
  const { addMonths: addMonths2, startOfMonth: startOfMonth2, isBefore: isBefore2, Date: Date2 } = dateLib2;
  const year = displayMonth.getFullYear();
  const months = [];
  let month = navStart;
  while (months.length < 12 && isBefore2(month, addMonths2(navEnd, 1))) {
  ...
  const options = sortedMonths.map((value) => {
    const label = formatters2.formatMonthDropdown(value, locale);
    const disabled = navStart && new Date2(year, value) < startOfMonth2(navStart) || navEnd && new Date2(year, value) > startOfMonth2(navEnd) || false;
...
function getWeekdays(locale, weekStartsOn, ISOWeek, dateLib2 = dateLib) {
  const start = ISOWeek ? dateLib2.startOfISOWeek(new dateLib2.Date()) : dateLib2.startOfWeek(new dateLib2.Date(), { locale, weekStartsOn });
  const days = [];
  for (let i = 0; i < 7; i++) {
...
function getYearOptions(displayMonth, calendarStart, calendarEnd, formatters2, dateLib2) {
  if (!calendarStart)
    return void 0;
  if (!calendarEnd)
    return void 0;
  const { startOfMonth: startOfMonth2, startOfYear: startOfYear2, endOfYear: endOfYear2, addYears: addYears2, isBefore: isBefore2, isSameYear: isSameYear2, Date: Date2 } = dateLib2;
  ...
  return years.map((value) => {
    const disabled = calendarStart && new Date2(value, month) < startOfMonth2(calendarStart) || month && calendarEnd && new Date2(value, month) > startOfMonth2(calendarEnd) || false;
...
function labelGrid(date, options, dateLib2 = dateLib) {
  return dateLib2.format(date, "LLLL y", options);
}
var labelCaption = labelGrid;

// node_modules/react-day-picker/dist/esm/labels/labelGridcell.js
function labelGridcell(date, modifiers, options, dateLib2 = dateLib) {
  let label = dateLib2.format(date, "PPPP", options);
...
function labelDayButton(date, modifiers, options, dateLib2 = dateLib) {
  let label = dateLib2.format(date, "PPPP", options);
  if (modifiers.today)
    label = `Today, ${label}`;
...
function labelWeekday(date, options, dateLib2 = dateLib) {
  return dateLib2.format(date, "cccc", options);
}
...
var NrOfDaysWithFixedWeeks = 42;
function getDates(displayMonths, maxDate, props, dateLib2) {
  const firstMonth = displayMonths[0];
  const lastMonth = displayMonths[displayMonths.length - 1];
  const { ISOWeek, fixedWeeks, locale, weekStartsOn } = props ?? {};
  const { startOfWeek: startOfWeek2, endOfWeek: endOfWeek2, startOfISOWeek: startOfISOWeek2, endOfISOWeek: endOfISOWeek2, addDays: addDays2, differenceInCalendarDays: differenceInCalendarDays2, differenceInCalendarMonths: differenceInCalendarMonths2, isAfter: isAfter2, endOfMonth: endOfMonth2, Date: Date2 } = dateLib2;
  const startWeekFirstDate = ISOWeek ? startOfISOWeek2(firstMonth) : startOfWeek2(firstMonth, {
    weekStartsOn,
    locale
  });
  const endWeekLastDate = ISOWeek ? endOfISOWeek2(endOfMonth2(lastMonth)) : endOfWeek2(endOfMonth2(lastMonth), {
    weekStartsOn,
    locale
  });
...
function getInitialMonth(props, dateLib2) {
  const { month, defaultMonth, today = new dateLib2.Date(), numberOfMonths = 1, endMonth, startMonth } = props;
...
var CalendarDay = class {
  constructor(date, displayMonth, dateLib2 = dateLib) {
    this.date = date;
...
function getMonths(displayMonths, dates, props, dateLib2) {
  const { startOfWeek: startOfWeek2, endOfWeek: endOfWeek2, startOfISOWeek: startOfISOWeek2, endOfISOWeek: endOfISOWeek2, endOfMonth: endOfMonth2, addDays: addDays2, getWeek: getWeek2, getISOWeek: getISOWeek2 } = dateLib2;
  const dayPickerMonths = displayMonths.reduce((months, month) => {
    const firstDateOfFirstWeek = props.ISOWeek ? startOfISOWeek2(month) : startOfWeek2(month, {
      locale: props.locale,
      weekStartsOn: props.weekStartsOn
    });
    const lastDateOfLastWeek = props.ISOWeek ? endOfISOWeek2(endOfMonth2(month)) : endOfWeek2(endOfMonth2(month), {
      locale: props.locale,
      weekStartsOn: props.weekStartsOn
    });
    ...
    if (props.fixedWeeks && monthDates.length < 42) {
      const extraDates = dates.filter((date) => {
        return date > lastDateOfLastWeek && date <= addDays2(lastDateOfLastWeek, 7);
      });
...
function getNavMonths(props, dateLib2) {
  ...
  const { startOfYear: startOfYear2, startOfDay: startOfDay2, startOfMonth: startOfMonth2, endOfMonth: endOfMonth2, addYears: addYears2, endOfYear: endOfYear2, Date: Date2 } = dateLib2;
  const { fromYear, toYear, fromMonth, toMonth } = props;
  if (!startMonth && fromMonth) {
    startMonth = fromMonth;
  }
  if (!startMonth && fromYear) {
    startMonth = new Date2(fromYear, 0, 1);
  }
  if (!endMonth && toMonth) {
    endMonth = toMonth;
  }
  if (!endMonth && toYear) {
    endMonth = new Date2(toYear, 11, 31);
  }
  ...
  if (startMonth) {
    ...
    startMonth = startOfYear2(addYears2(props.today ?? new Date2(), -100));
  }
  if (endMonth) {
    ...
    endMonth = endOfYear2(props.today ?? new Date2());
  }
  return [
...
function rangeIncludesDate(range, date, excludeEnds = false, dateLib2 = dateLib) {
  let { from, to } = range;
...
var isDateInRange = (range, date) => rangeIncludesDate(range, date, false, dateLib);
...
function dateMatchModifiers(date, matchers, dateLib2 = dateLib) {
...
function getFocusableDate(moveBy, moveDir, refDate, navStart, navEnd, props, dateLib2) {
  ...
  const { addDays: addDays2, addMonths: addMonths2, addYears: addYears2, addWeeks: addWeeks2, startOfISOWeek: startOfISOWeek2, endOfISOWeek: endOfISOWeek2, startOfWeek: startOfWeek2, endOfWeek: endOfWeek2, max: max2, min: min2 } = dateLib2;
  const moveFns = {
    day: addDays2,
    week: addWeeks2,
    month: addMonths2,
    year: addYears2,
    startOfWeek: (date) => ISOWeek ? startOfISOWeek2(date) : startOfWeek2(date, { locale, weekStartsOn }),
    endOfWeek: (date) => ISOWeek ? endOfISOWeek2(date) : endOfWeek2(date, { locale, weekStartsOn })
  };
...
function useFocus(props, calendar, getModifiers, isSelected, dateLib2) {
  ...
  const [lastFocused, setLastFocused] = (0, import_react29.useState)();
  const focusTarget = calculateFocusTarget(calendar.days, getModifiers, isSelected || (() => false), lastFocused);
  const [focusedDay, setFocused] = (0, import_react29.useState)(autoFocus ? focusTarget : void 0);
  const blur = () => {
...
function useGetModifiers(days, props, dateLib2) {
  ...
  const { isSameDay: isSameDay2, isSameMonth: isSameMonth2, Date: Date2 } = dateLib2;
  ...
  for (const day of days) {
    ...
    const isHidden = Boolean(hidden && dateMatchModifiers(date, hidden, dateLib2)) || !showOutsideDays && isOutside;
    const isToday = isSameDay2(date, today ?? new Date2());
    if (isOutside)
  ...
  return (day) => {
    ...
    for (const name in selectionModifiersMap) {
      const days2 = selectionModifiersMap[name];
      selectionStates[name] = days2.some((d) => d === day);
    }
...
function useMulti(props, dateLib2) {
  ...
  const [selected, setSelected] = useControlledValue(initiallySelected, onSelect ? initiallySelected : void 0);
...
function addToRange(date, initialRange, min2 = 0, max2 = 0, required = false, dateLib2 = dateLib) {
...
function useRange(props, dateLib2) {
  ...
  const select = (triggerDate, modifiers, e) => {
    ...
    if ((newRange == null ? void 0 : newRange.from) && newRange.to) {
      let newDate = newRange.from;
      while (dateLib2.differenceInCalendarDays(newRange.to, newDate) > 0) {
        newDate = dateLib2.addDays(newDate, 1);
        if (excludeDisabled && disabled && dateMatchModifiers(newDate, disabled, dateLib2)) {
...
function DayPicker(props) {
  const { components, formatters: formatters2, labels, dateLib: dateLib2, locale, classNames } = (0, import_react30.useMemo)(() => ({
  ...
  const weekdays = (0, import_react30.useMemo)(() => getWeekdays(locale, props.weekStartsOn, props.ISOWeek, dateLib2), [dateLib2, locale, props.ISOWeek, props.weekStartsOn]);
  const isInteractive = mode !== void 0 || onDayClick !== void 0;
  const handlePreviousClick = (0, import_react30.useCallback)(() => {
    if (!previousMonth)
      return;
    goToMonth(previousMonth);
    onPrevClick == null ? void 0 : onPrevClick(previousMonth);
  }, [previousMonth, goToMonth, onPrevClick]);
  const handleNextClick = (0, import_react30.useCallback)(() => {
    if (!nextMonth)
      return;
    goToMonth(nextMonth);
    onNextClick == null ? void 0 : onNextClick(nextMonth);
  }, [goToMonth, nextMonth, onNextClick]);
  const handleDayClick = (0, import_react30.useCallback)((day, m) => (e) => {
    e.preventDefault();
    e.stopPropagation();
    setFocused(day);
  ...
  const handleDayFocus = (0, import_react30.useCallback)((day, m) => (e) => {
    setFocused(day);
    onDayFocus == null ? void 0 : onDayFocus(day.date, m, e);
  }, [onDayFocus, setFocused]);
  const handleDayBlur = (0, import_react30.useCallback)((day, m) => (e) => {
    blur();
    onDayBlur == null ? void 0 : onDayBlur(day.date, m, e);
  }, [blur, onDayBlur]);
  const handleDayKeyDown = (0, import_react30.useCallback)((day, modifiers) => (e) => {
    const keyMap = {
  ...
  const handleDayMouseEnter = (0, import_react30.useCallback)((day, modifiers) => (e) => {
    onDayMouseEnter == null ? void 0 : onDayMouseEnter(day.date, modifiers, e);
  }, [onDayMouseEnter]);
  const handleDayMouseLeave = (0, import_react30.useCallback)((day, modifiers) => (e) => {
    onDayMouseLeave == null ? void 0 : onDayMouseLeave(day.date, modifiers, e);
  }, [onDayMouseLeave]);
  const { className, style } = (0, import_react30.useMemo)(() => ({
  ...
  return import_react30.default.createElement(
    ...
    import_react30.default.createElement(
      ...
      import_react30.default.createElement(
        ...
        !props.hideNavigation && import_react30.default.createElement(components.Nav, { role: "navigation", className: classNames[UI.Nav], style: styles == null ? void 0 : styles[UI.Nav], "aria-label": labelNav2(), onPreviousClick: handlePreviousClick, onNextClick: handleNextClick, previousMonth, nextMonth }),
        months.map((calendarMonth, displayIndex) => {
          ...
          const dropdownMonths = getMonthOptions(calendarMonth.date, navStart, navEnd, formatters2, locale, dateLib2);
          const dropdownYears = getYearOptions(months[0].date, navStart, navEnd, formatters2, dateLib2);
          return import_react30.default.createElement(
            components.Month,
            { className: classNames[UI.Month], style: styles == null ? void 0 : styles[UI.Month], key: displayIndex, displayIndex, calendarMonth },
            import_react30.default.createElement(components.MonthCaption, { className: classNames[UI.MonthCaption], style: styles == null ? void 0 : styles[UI.MonthCaption], calendarMonth, displayIndex }, (captionLayout == null ? void 0 : captionLayout.startsWith("dropdown")) ? import_react30.default.createElement(
              components.DropdownNav,
              { className: classNames[UI.Dropdowns], style: styles == null ? void 0 : styles[UI.Dropdowns] },
              captionLayout === "dropdown" || captionLayout === "dropdown-months" ? import_react30.default.createElement(components.MonthsDropdown, { className: classNames[UI.MonthsDropdown], "aria-label": labelMonthDropdown2(), classNames, components, disabled: Boolean(props.disableNavigation), onChange: handleMonthChange, options: dropdownMonths, style: styles == null ? void 0 : styles[UI.Dropdown], value: calendarMonth.date.getMonth() }) : import_react30.default.createElement("span", { role: "status", "aria-live": "polite" }, formatMonthDropdown2(calendarMonth.date.getMonth())),
              captionLayout === "dropdown" || captionLayout === "dropdown-years" ? import_react30.default.createElement(components.YearsDropdown, { className: classNames[UI.YearsDropdown], "aria-label": labelYearDropdown2(labelOptions), classNames, components, disabled: Boolean(props.disableNavigation), onChange: handleYearChange, options: dropdownYears, style: styles == null ? void 0 : styles[UI.Dropdown], value: calendarMonth.date.getFullYear() }) : import_react30.default.createElement("span", { role: "status", "aria-live": "polite" }, formatYearDropdown2(calendarMonth.date.getFullYear()))
            ) : import_react30.default.createElement(components.CaptionLabel, { className: classNames[UI.CaptionLabel], role: "status", "aria-live": "polite" }, formatCaption2(calendarMonth.date, formatOptions, dateLib2))),
            import_react30.default.createElement(
              components.MonthGrid,
              { role: "grid", "aria-multiselectable": mode === "multiple" || mode === "range", "aria-label": labelGrid2(calendarMonth.date, labelOptions, dateLib2) || void 0, className: classNames[UI.MonthGrid], style: styles == null ? void 0 : styles[UI.MonthGrid] },
              !props.hideWeekdays && import_react30.default.createElement(
                components.Weekdays,
                { className: classNames[UI.Weekdays], role: "row", style: styles == null ? void 0 : styles[UI.Weekdays] },
                showWeekNumber && import_react30.default.createElement(components.WeekNumberHeader, { "aria-label": labelWeekNumberHeader2(labelOptions), className: classNames[UI.WeekNumberHeader], role: "columnheader", style: styles == null ? void 0 : styles[UI.WeekNumberHeader] }, formatWeekNumberHeader2()),
                weekdays.map((weekday, i) => import_react30.default.createElement(components.Weekday, { "aria-label": labelWeekday2(weekday, labelOptions, dateLib2), className: classNames[UI.Weekday], key: i, role: "columnheader", style: styles == null ? void 0 : styles[UI.Weekday] }, formatWeekdayName2(weekday, formatOptions, dateLib2)))
              ),
              import_react30.default.createElement(components.Weeks, { className: classNames[UI.Weeks], role: "rowgroup", style: styles == null ? void 0 : styles[UI.Weeks] }, calendarMonth.weeks.map((week, weekIndex) => {
                return import_react30.default.createElement(
                  components.Week,
                  { className: classNames[UI.Week], key: week.weekNumber, role: "row", style: styles == null ? void 0 : styles[UI.Week], week },
                  showWeekNumber && import_react30.default.createElement(components.WeekNumber, { week, role: "rowheader", style: styles == null ? void 0 : styles[UI.WeekNumber], "aria-label": labelWeekNumber2(week.weekNumber, {
                    locale
                  }), className: classNames[UI.WeekNumber] }, formatWeekNumber2(week.weekNumber)),
                  week.days.map((day) => {
                    const { date } = day;
                    const modifiers = getModifiers(day);
                    ...
                    const ariaLabel = !isInteractive ? labelGridcell2(date, modifiers, labelOptions, dateLib2) : void 0;
                    return import_react30.default.createElement(components.Day, { key: `${dateLib2.format(date, "yyyy-MM-dd")}_${dateLib2.format(day.displayMonth, "yyyy-MM")}`, day, modifiers, role: "gridcell", className: className2.join(" "), style: style2, "aria-hidden": modifiers.hidden || void 0, "aria-selected": modifiers.selected || void 0, "aria-label": ariaLabel, "data-day": dateLib2.format(date, "yyyy-MM-dd"), "data-month": day.outside ? dateLib2.format(date, "yyyy-MM") : void 0, "data-selected": modifiers.selected || void 0, "data-disabled": modifiers.disabled || void 0, "data-hidden": modifiers.hidden || void 0, "data-outside": day.outside || void 0, "data-focused": modifiers.focused || void 0, "data-today": modifiers.today || void 0 }, isInteractive ? import_react30.default.createElement(components.DayButton, { className: classNames[UI.DayButton], style: styles == null ? void 0 : styles[UI.DayButton], day, modifiers, disabled: modifiers.disabled || void 0, tabIndex: isFocusTarget(day) ? 0 : -1, "aria-label": labelDayButton2(date, modifiers, labelOptions, dateLib2), onClick: handleDayClick(day, modifiers), onBlur: handleDayBlur(day, modifiers), onFocus: handleDayFocus(day, modifiers), onKeyDown: handleDayKeyDown(day, modifiers), onMouseEnter: handleDayMouseEnter(day, modifiers), onMouseLeave: handleDayMouseLeave(day, modifiers) }, formatDay2(date, formatOptions, dateLib2)) : formatDay2(day.date, formatOptions, dateLib2));
                  })
                );
              }))
            )
      ...
      props.footer && import_react30.default.createElement(components.Footer, { className: classNames[UI.Footer], style: styles == null ? void 0 : styles[UI.Footer], role: "status", "aria-live": "polite" }, props.footer)
    )
  );
}
