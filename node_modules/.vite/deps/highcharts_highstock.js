...
var require_highstock = __commonJS({
    ...
    */
    function(t, e) {
      ...
      function i(e2, i2, s, o) {
        !e2.hasOwnProperty(i2) && (e2[i2] = o.apply(null, s), t && "function" == typeof CustomEvent && t.dispatchEvent(new CustomEvent("HighchartsModuleLoaded", { detail: { path: i2, module: e2[i2] } })));
      }
 ...
 - ${i4}: ${e4}`, l2 && (h2 += encodeURI(i4) + "=" + encodeURI(e4));
        ...
        function g(t3, e3, i3) {
          ...
          return n(e3) ? r2(i3, e3) : k(e3, r2), s2;
        }
        function f(t3) {
          return l(t3) ? t3 : [t3];
        }
        ...
        return o.jQuery && (o.jQuery.fn.highcharts = function() {
          ...
          if (this[0]) return e3[0] ? (new t2[n(e3[0]) ? e3.shift() : "Chart"](this[0], e3[0], e3[1]), this) : i2[g(this[0], "data-highcharts-chart")];
          ...
          k(t3, function(s2, o2) {
            s2 !== e3 && (s2 == null ? void 0 : s2.destroy) && s2.destroy(), ((s2 == null ? void 0 : s2.destroy) || !i3) && delete t3[o2];
          });
          ...
          return function t4(e4, o3, r2, a2) {
            ...
            k(e4, function(i4, d2) {
              if (!a2 && s2 && s2.indexOf(d2) > -1 && o3[d2]) {
                i4 = f(i4), r2[d2] = [];
                for (let e5 = 0; e5 < Math.max(i4.length, o3[d2].length); e5++) o3[d2][e5] && (void 0 === i4[e5] ? r2[d2][e5] = o3[d2][e5] : (r2[d2][e5] = {}, t4(i4[e5], o3[d2][e5], r2[d2][e5], a2 + 1)));
              } else h(i4, true) && !i4.nodeType ? (r2[d2] = l(i4) ? [] : {}, t4(i4, o3[d2] || {}, r2[d2], a2 + 1), 0 !== Object.keys(r2[d2]).length || "colorAxis" === d2 && 0 === a2 || delete r2[d2]) : (e4[d2] !== o3[d2] || d2 in e4 && !(d2 in o3)) && "__proto__" !== d2 && "constructor" !== d2 && (r2[d2] = n2[d2]);
            });
          }(t3, e3, o2, 0), o2;
          ...
          return t3.forEach((t4) => {
            if (t4.length > 1) for (r2 = s2 = t4.length - 1; r2 > 0; r2--) (o2 = t4[r2] - t4[r2 - 1]) < 0 && !a2 ? (e3 == null ? void 0 : e3(), e3 = void 0) : o2 && (void 0 === i3 || o2 < i3) && (i3 = o2);
          }), i3;
        ...
        }, removeEvent: M, replaceNested: function(t3, ...e3) {
          let i3, s2;
          do
        ...
        class m {
          ...
          dateFormat(e3, i3, o2) {
            ...
            return h(r({ a: y ? y[p2] : x[p2].substr(0, 3), A: x[p2], d: d(u2), e: d(u2, 2, " "), w: p2, b: m2.shortMonths[g2], B: m2.months[g2], m: d(g2 + 1), o: g2 + 1, y: f2.toString().substr(2, 2), Y: f2, H: d(l2), k: l2, I: d(l2 % 12 || 12), l: l2 % 12 || 12, M: d(this.get("Minutes", n2)), p: l2 < 12 ? "AM" : "PM", P: l2 < 12 ? "am" : "pm", S: d(this.get("Seconds", n2)), L: d(Math.floor(i3 % 1e3), 3) }, t2.dateFormats), function(t3, s2) {
              for (; -1 !== e3.indexOf("%" + s2); ) e3 = e3.replace("%" + s2, "function" == typeof t3 ? t3.call(a2, i3) : t3);
          ...
          getTimeTicks(t3, e3, i3, o2) {
            ...
            if (o2 = c(o2, 1), s(e3)) {
              ...
              let p3 = m2.getTime();
              for (a2 = 1; p3 < i3; ) g2.push(p3), x === u.year ? p3 = d2.makeTime(n2 + a2 * y, 0) : x === u.month ? p3 = d2.makeTime(n2, t4 + a2 * y) : l2 && (x === u.day || x === u.week) ? p3 = d2.makeTime(n2, t4, r2 + a2 * y * (x === u.day ? 1 : 7)) : l2 && x === u.hour && y > 1 ? p3 = d2.makeTime(n2, t4, r2, c2 + a2 * y) : p3 += x * y, a2++;
        ...
        return { defaultOptions: l, defaultTime: h, getOptions: function() {
          ...
          return a(e2, "setOptions", { options: t3 }), n(true, l, t3), (t3.time || t3.global) && (e2.time ? e2.time.update(n(l.global, l.time, t3.global, t3.time)) : e2.time = h), l;
        } };
        ...
        class r {
          ...
          constructor(e3) {
            ...
            if ("object" == typeof e3 && void 0 !== e3.stops) this.stops = e3.stops.map((t3) => new r(t3[1]));
              ...
              if (!s2) for (o2 = r.parsers.length; o2-- && !s2; ) (i3 = (a = r.parsers[o2]).regex.exec(e3)) && (s2 = a.parse(i3));
            }
            s2 && (this.rgba = s2);
          }
          get(t3) {
        ...
        return r.names = { white: "#ffffff", black: "#000000" }, r.parsers = [{ regex: /rgba\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d?(?:\.\d+)?)\s*\)/, parse: function(t3) {
        ...
        class n {
          ...
          run(t3, e3, i3) {
            let s2 = this, r2 = s2.options, a2 = function(t4) {
              ...
              for (let t4 = 0; t4 < n.timers.length; t4++) n.timers[t4]() || n.timers.splice(t4--, 1);
              n.timers.length && l(h);
            };
          ...
          initPath(t3, e3, i3) {
            let s2 = t3.startX, o2 = t3.endX, a2 = i3.slice(), n2 = t3.isArea, l = n2 ? 2 : 1, h = e3 && i3.length > e3.length && i3.hasStackedCliffs, d, c, p, u, g = e3 && e3.slice();
            if (!g || h) return [a2, a2];
            function f(t4, e4) {
              for (; t4.length < c; ) {
            ...
            return g.length && r(d) && (c = a2.length + d * l, u ? (f(g, a2), m(a2)) : (f(a2, g), m(g))), [g, a2];
          }
          fillSetter() {
            ...
            return function e4(s2, r2) {
              ...
              return c(s2).forEach(function(s3) {
                ...
                if (c2) {
                  ...
                  } else n(33, false, void 0, { "Invalid tagName in config": c2 });
                }
        ...
        function p(t3 = "", e3, o2) {
          let a2 = /\{([\w\:\.\,;\-\/<>%@"'’= #\(\)]+)\}/g, n2 = /\(([\w\:\.\,;\-\/<>%@"'= ]+)\)/g, l2 = [], d2 = /f$/, g = /\.(\d)/, f = i2.lang, m = o2 && o2.time || s, x = o2 && o2.numberFormatter || u, y = (t4 = "") => {
            let i3;
          ...
          return l2.forEach((i3) => {
            let s2, r2;
            let { body: a3, elseBody: n3, expression: l3, fn: u2 } = i3;
            if (u2) {
              let t4 = [i3], h2 = l3.split(" ");
              for (r2 = c[u2].length; r2--; ) t4.unshift(y(h2[r2 + 1]));
              s2 = c[u2].apply(e3, t4), i3.isBlock && "boolean" == typeof s2 && (s2 = p(s2 ? a3 : n3, e3, o2));
            } else {
              let t4 = l3.split(":");
        ...
        return (e2 || (e2 = {})).distribute = function t3(e3, a, n) {
          let l = e3, h = l.reducedLen || a, d = (t4, e4) => t4.target - e4.target, c = [], p = e3.length, u = [], g = c.push, f, m, x, y = true, b, v, S = 0, k;
          for (f = p; f--; ) S += e3[f].size;
          if (S > h) {
            for (r(e3, (t4, e4) => (e4.rank || 0) - (t4.rank || 0)), x = (k = e3[0].rank === e3[e3.length - 1].rank) ? p / 2 : -1, m = k ? x : p - 1; x && S > h; ) b = e3[f = Math.floor(m)], o(u, f) && (S -= b.size), m += x, k && m >= e3.length && (x /= 2, m = x);
          ...
          for (r(e3, d), e3 = e3.map((t4) => ({ size: t4.size, targets: [t4.target], align: s(t4.align, 0.5) })); y; ) {
            for (f = e3.length; f--; ) b = e3[f], v = (Math.min.apply(0, b.targets) + Math.max.apply(0, b.targets)) / 2, b.pos = i2(v - b.size * b.align, 0, a - b.size);
            for (f = e3.length, y = false; f--; ) f > 0 && e3[f - 1].pos + e3[f - 1].size > e3[f].pos && (e3[f - 1].size += e3[f].size, e3[f - 1].targets = e3[f - 1].targets.concat(e3[f].targets), e3[f - 1].align = 0.5, e3[f - 1].pos + e3[f - 1].size > a && (e3[f - 1].pos = a - e3[f - 1].size), e3.splice(f, 1), y = true);
          }
        ...
        let { animate: o, animObject: r, stop: a } = t2, { deg2rad: n, doc: l, svg: h, SVG_NS: d, win: c } = i2, { addEvent: p, attr: u, createElement: g, crisp: f, css: m, defined: x, erase: y, extend: b, fireEvent: v, isArray: S, isFunction: k, isObject: M, isString: C, merge: A, objectEach: w, pick: T, pInt: P, pushUnique: O, replaceNested: L, syncTimeout: D, uniqueKey: E } = s;
        class B {
          _defaultGetter(t3) {
          ...
          align(t3, e3, i3, s2 = true) {
            ...
            return o2 = (u2.x || 0) + (t3.x || 0), r2 = (u2.y || 0) + (t3.y || 0), "right" === g2 ? a2 = 1 : "center" === g2 && (a2 = 2), a2 && (o2 += ((u2.width || 0) - (t3.width || 0)) / a2), l2[e3 ? "translateX" : "x"] = Math.round(o2), "bottom" === f2 ? n2 = 1 : "middle" === f2 && (n2 = 2), n2 && (r2 += ((u2.height || 0) - (t3.height || 0)) / n2), l2[e3 ? "translateY" : "y"] = Math.round(r2), s2 && (this[this.placed ? "animate" : "attr"](l2), this.placed = true), this.alignAttr = l2, this;
          }
          alignSetter(t3) {
          ...
          animate(t3, e3, i3) {
            let s2 = r(T(e3, this.renderer.globalAnimation, true)), a2 = s2.defer;
            return l.hidden && (s2.duration = 0), 0 !== s2.duration ? (i3 && (s2.complete = i3), D(() => {
          ...
          attr(t3, e3, i3, s2) {
            let { element: o2 } = this, r2 = B.symbolCustomAttribs, n2, l2, h2 = this, d2;
            return "string" == typeof t3 && void 0 !== e3 && (n2 = t3, (t3 = {})[n2] = e3), "string" == typeof t3 ? h2 = (this[t3 + "Getter"] || this._defaultGetter).call(this, t3, o2) : (w(t3, function(e4, i4) {
          ...
          crisp(t3, e3) {
            ...
            let i3 = t3.x || this.x || 0, s2 = t3.y || this.y || 0, o2 = (t3.width || this.width || 0) + i3, r2 = (t3.height || this.height || 0) + s2, a2 = f(i3, e3), n2 = f(s2, e3);
            return b(t3, { x: a2, y: n2, width: f(o2, e3) - a2, height: f(r2, e3) - n2 }), x(t3.strokeWidth) && (t3.strokeWidth = e3), t3;
          }
          complexColor(t3, i3, s2) {
            let o2 = this.renderer, r2, a2, n2, l2, h2, d2, c2, p2, u2, g2, f2 = [], m2;
            v(this.renderer, "complexColor", { args: arguments }, function() {
              if (t3.radialGradient ? a2 = "radialGradient" : t3.linearGradient && (a2 = "linearGradient"), a2) {
                if (n2 = t3[a2], h2 = o2.gradients, d2 = t3.stops, u2 = s2.radialReference, S(n2) && (t3[a2] = n2 = { x1: n2[0], y1: n2[1], x2: n2[2], y2: n2[3], gradientUnits: "userSpaceOnUse" }), "radialGradient" === a2 && u2 && !x(n2.gradientUnits) && (l2 = n2, n2 = A(n2, o2.getRadialAttr(u2, l2), { gradientUnits: "userSpaceOnUse" })), w(n2, function(t4, e3) {
                  "id" !== e3 && f2.push(e3, t4);
                }), w(d2, function(t4) {
                  f2.push(t4);
          ...
          destroy() {
            ...
            if (t3.connector = (_a = t3.connector) == null ? void 0 : _a.destroy(), t3.stops) {
              for (n2 = 0; n2 < t3.stops.length; n2++) t3.stops[n2].destroy();
            ...
            t3.alignOptions && y(i3.alignedObjects, t3), w(t3, function(e4, i4) {
          ...
          getBBox(t3, e3) {
            let i3, s2, o2, r2;
            let { alignValue: a2, element: n2, renderer: l2, styles: h2, textStr: d2 } = this, { cache: c2, cacheKeys: p2 } = l2, u2 = n2.namespaceURI === this.SVG_NS, g2 = T(e3, this.rotation, 0), f2 = l2.styledMode ? n2 && B.prototype.getStyle.call(n2, "font-size") : h2.fontSize;
            if (x(d2) && (-1 === (r2 = d2.toString()).indexOf("<") && (r2 = r2.replace(/\d/g, "0")), r2 += ["", l2.rootFontSize, f2, g2, this.textWidth, a2, h2.textOverflow, h2.fontWeight].join(",")), r2 && !t3 && (i3 = c2[r2]), !i3 || i3.polygon) {
              if (u2 || l2.forExport) {
                try {
                  o2 = this.fakeTS && function(t5) {
                    let e4 = n2.querySelector(".highcharts-text-outline");
                    e4 && m(e4, { display: t5 });
                  }, k(o2) && o2("none"), i3 = n2.getBBox ? b({}, n2.getBBox()) : { width: n2.offsetWidth, height: n2.offsetHeight, x: 0, y: 0 }, k(o2) && o2("");
                } catch (t5) {
                }
          ...
          getRotatedBox(t3, e3) {
            let { x: i3, y: s2, width: o2, height: r2 } = t3, { alignValue: a2, translateY: l2, rotationOriginX: h2 = 0, rotationOriginY: d2 = 0 } = this, c2 = { right: 1, center: 0.5 }[a2 || 0] || 0, p2 = Number(this.element.getAttribute("y") || 0) - (l2 ? 0 : s2), u2 = e3 * n, g2 = (e3 - 90) * n, f2 = Math.cos(u2), m2 = Math.sin(u2), x2 = o2 * f2, y2 = o2 * m2, b2 = Math.cos(g2), v2 = Math.sin(g2), [[S2, k2], [M2, C2]] = [h2, d2].map((t4) => [t4 - t4 * f2, t4 * m2]), A2 = i3 + c2 * (o2 - x2) + S2 + C2 + p2 * b2, w2 = A2 + x2, T2 = w2 - r2 * b2, P2 = T2 - x2, O2 = s2 + p2 - c2 * y2 - k2 + M2 + p2 * v2, L2 = O2 + y2, D2 = L2 - r2 * v2, E2 = D2 - y2, B2 = Math.min(A2, w2, T2, P2), j = Math.min(O2, L2, D2, E2), R = Math.max(A2, w2, T2, P2) - B2, I = Math.max(O2, L2, D2, E2) - j;
            return { x: B2, y: j, width: R, height: I, polygon: [[A2, O2], [w2, L2], [T2, D2], [P2, E2]] };
          }
          getStyle(t3) {
          ...
          shadow(t3) {
            var _a;
            let { renderer: e3 } = this, i3 = A(((_a = this.parentGroup) == null ? void 0 : _a.rotation) === 90 ? { offsetX: -1, offsetY: -1 } : {}, M(t3) ? t3 : {}), s2 = e3.shadowDefinition(i3);
          ...
          strokeWidth() {
            ...
            return /px$/.test(t3) ? e3 = P(t3) : "" !== t3 && (u(i3 = l.createElementNS(d, "rect"), { width: t3, "stroke-width": 0 }), this.element.parentNode.appendChild(i3), e3 = i3.getBBox().width, i3.parentNode.removeChild(i3)), e3;
          }
          symbolAttr(t3) {
            let e3 = this;
          ...
          updateTransform(t3 = "transform") {
            ...
            x(i3) && d2.push("matrix(" + i3.join(",") + ")"), s2 && (d2.push("rotate(" + s2 + " " + T(o2, e3.getAttribute("x"), 0) + " " + T(r2, e3.getAttribute("y") || 0) + ")"), ((_a = this.text) == null ? void 0 : _a.element.tagName) === "SPAN" && this.text.attr({ rotation: s2, rotationOriginX: (o2 || 0) - this.padding, rotationOriginY: (r2 || 0) - this.padding })), (x(a2) || x(n2)) && d2.push("scale(" + T(a2, 1) + " " + T(n2, 1) + ")"), d2.length && !(this.text || this).textPath && e3.setAttribute(t3, d2.join(" "));
          }
          ...
          zIndexSetter(t3, e3) {
            ...
            if (x(t3) ? (r2.setAttribute("data-z-index", t3), t3 = +t3, this[e3] === t3 && (p2 = false)) : x(this[e3]) && r2.removeAttribute("data-z-index"), this[e3] = t3, p2) {
              for ((t3 = this.zIndex) && s2 && (s2.handleZ = true), u2 = (n2 = o2.childNodes).length - 1; u2 >= 0 && !d2; u2--) c2 = !x(h2 = (l2 = n2[u2]).getAttribute("data-z-index")), l2 !== r2 && (t3 < 0 && c2 && !a2 && !u2 ? (o2.insertBefore(r2, n2[u2]), d2 = true) : (P(h2) <= t3 || c2 && (!x(t3) || t3 >= 0)) && (o2.insertBefore(r2, n2[u2 + 1]), d2 = true));
        ...
        function o(t3, i3, o2, r2, a2) {
          let n = [];
          if (a2) {
            let l = a2.start || 0, h = s(a2.r, o2), d = s(a2.r, r2 || o2), c = 2e-4 / (a2.borderRadius ? 1 : Math.max(h, 1)), p = Math.abs((a2.end || 0) - l - 2 * Math.PI) < c, u = (a2.end || 0) - (p ? c : 0), g = a2.innerR, f = s(a2.open, p), m = Math.cos(l), x = Math.sin(l), y = Math.cos(u), b = Math.sin(u), v = s(a2.longArc, u - l - Math.PI < c ? 0 : 1), S = ["A", h, d, 0, v, s(a2.clockwise, 1), t3 + h * y, i3 + d * b];
            S.params = { start: l, end: u, cx: t3, cy: i3 }, n.push(["M", t3 + h * m, i3 + d * x], S), e2(g) && ((S = ["A", g, g, 0, v, e2(a2.clockwise) ? 1 - a2.clockwise : 0, t3 + g * m, i3 + g * x]).params = { start: u, end: l, cx: t3, cy: i3 }, n.push(f ? ["M", t3 + g * y, i3 + g * b] : ["L", t3 + g * y, i3 + g * b], S)), f || n.push(["Z"]);
          }
          return n;
        }
        ...
        return { arc: o, callout: function(t3, e3, s2, o2, r2) {
          ...
          if (t3 + h > s2 - l) {
            if (d > e3 + l && d < e3 + o2 - l) c.splice(3, 1, ["L", t3 + s2, d - 6], ["L", t3 + s2 + 6, d], ["L", t3 + s2, d + 6], ["L", t3 + s2, e3 + o2 - n]);
            else if (h < s2) {
              let i3 = d < e3 + l, r3 = i3 ? e3 : e3 + o2;
              c.splice(i3 ? 2 : 5, 0, ["L", h, d], ["L", t3 + s2 - n, r3]);
            } else c.splice(3, 1, ["L", t3 + s2, o2 / 2], ["L", h, d], ["L", t3 + s2, o2 / 2], ["L", t3 + s2, e3 + o2 - n]);
          } else if (t3 + h < l) {
            if (d > e3 + l && d < e3 + o2 - l) c.splice(7, 1, ["L", t3, d + 6], ["L", t3 - 6, d], ["L", t3, d - 6], ["L", t3, e3 + n]);
            else if (h > 0) {
              let i3 = d < e3 + l, s3 = i3 ? e3 : e3 + o2;
              c.splice(i3 ? 1 : 6, 0, ["L", h, d], ["L", t3 + n, s3]);
            } else c.splice(7, 1, ["L", t3, o2 / 2], ["L", h, d], ["L", t3, o2 / 2], ["L", t3, e3 + n]);
          } else d > o2 && h < s2 - l ? c.splice(5, 1, ["L", h + 6, e3 + o2], ["L", h, e3 + o2 + 6], ["L", h - 6, e3 + o2], ["L", t3 + n, e3 + o2]) : d < 0 && h > l && c.splice(1, 1, ["L", h - 6, e3], ["L", h, e3 - 6], ["L", h + 6, e3], ["L", s2 - n, e3]);
          return c;
        ...
        return class {
          ...
          modifyDOM() {
            ...
            let l2 = (t4, r2) => {
              ...
              if (this.ellipsis) l3 && this.truncate(t4, l3, void 0, 0, Math.max(0, n2 - 0.8 * c2), (t5, e4) => t5.substring(0, e4) + "…");
              else if (d2) {
                let l4 = [], d3 = [];
                for (; r2.firstChild && r2.firstChild !== t4; ) d3.push(r2.firstChild), r2.removeChild(r2.firstChild);
                for (; h3.length; ) h3.length && !this.noWrap && p > 0 && (l4.push(t4.textContent || ""), t4.textContent = h3.join(" ").replace(/- /g, "-")), this.truncate(t4, void 0, h3, 0 === p && u || 0, n2, (t5, e4) => h3.slice(0, e4).join(" ").replace(/- /g, "-")), u = e3.actualWidth, p++;
                d3.forEach((e4) => {
          ...
          modifyTree(t3) {
            let e3 = (i3, s2) => {
              ...
              } else "a" === l2 && r2 && r2.some((t4) => "#text" === t4.tagName) && (i3.children = [{ children: r2, tagName: "tspan" }]);
          ...
          truncate(t3, e3, i3, s2, o2, r2) {
            ...
            let l2 = this.svgElement, { rotation: h2 } = l2, d2 = [], c2 = i3 ? 1 : 0, p = (e3 || i3 || "").length, u = p, g = function(e4, o3) {
              ...
              if (a3 && void 0 === d2[r3] && a3.getSubStringLength) try {
            ...
            if (l2.rotation = 0, s2 + (n2 = g(t3.textContent.length)) > o2) {
              for (; c2 <= p; ) u = Math.ceil((c2 + p) / 2), i3 && (a2 = r2(i3, u)), n2 = g(u, a2 && a2.length - 1), c2 === p ? c2 = p + 1 : n2 > o2 ? p = u - 1 : c2 = u;
      ...
      }), i(e, "Core/Renderer/SVG/SVGRenderer.js", [e["Core/Renderer/HTML/AST.js"], e["Core/Defaults.js"], e["Core/Color/Color.js"], e["Core/Globals.js"], e["Core/Renderer/RendererRegistry.js"], e["Core/Renderer/SVG/SVGElement.js"], e["Core/Renderer/SVG/SVGLabel.js"], e["Core/Renderer/SVG/Symbols.js"], e["Core/Renderer/SVG/TextBuilder.js"], e["Core/Utilities.js"]], function(t2, e2, i2, s, o, r, a, n, l, h) {
        let d;
        let { defaultOptions: c } = e2, { charts: p, deg2rad: u, doc: g, isFirefox: f, isMS: m, isWebKit: x, noop: y, SVG_NS: b, symbolSizes: v, win: S } = s, { addEvent: k, attr: M, createElement: C, crisp: A, css: w, defined: T, destroyObjectProperties: P, extend: O, isArray: L, isNumber: D, isObject: E, isString: B, merge: j, pick: R, pInt: I, replaceNested: z, uniqueKey: G } = h;
        class N {
          constructor(t3, e3, i3, s2, o2, r2, a2) {
            let n2, l2;
            let h2 = this.createElement("svg").attr({ version: "1.1", class: "highcharts-root" }), d2 = h2.element;
            a2 || h2.css(this.getStyle(s2 || {})), t3.appendChild(d2), M(t3, "dir", "ltr"), -1 === t3.innerHTML.indexOf("xmlns") && M(d2, "xmlns", this.SVG_NS), this.box = d2, this.boxWrapper = h2, this.alignedObjects = [], this.url = this.getReferenceURL(), this.createElement("desc").add().element.appendChild(g.createTextNode("Created with Highcharts 11.4.8")), this.defs = this.createElement("defs").add(), this.allowHTML = r2, this.forExport = o2, this.styledMode = a2, this.gradients = {}, this.cache = {}, this.cacheKeys = [], this.imgCount = 0, this.rootFontSize = h2.getStyle("font-size"), this.setSize(e3, i3, false), f && t3.getBoundingClientRect && ((n2 = function() {
              w(t3, { left: 0, top: 0 }), l2 = t3.getBoundingClientRect(), w(t3, { left: Math.ceil(l2.left) - l2.left + "px", top: Math.ceil(l2.top) - l2.top + "px" });
            })(), this.unSubPixelFix = k(S, "resize", n2));
          }
          definition(e3) {
          ...
          button(e3, i3, s2, o2, r2 = {}, a2, n2, l2, h2, d2) {
            ...
            r2 = j(c.global.buttonTheme, r2), u2 && (delete r2.fill, delete r2.stroke, delete r2["stroke-width"]);
            ...
            }, p2.attr(b2[0]), !u2 && (p2.css(O({ cursor: "default" }, y2)), d2 && p2.text.css({ pointerEvents: "none" })), p2.on("touchstart", (t3) => t3.stopPropagation()).on("click", function(t3) {
              3 !== f2 && o2.call(p2, t3);
            });
          }
          crispLine(t3, e3) {
            let [i3, s2] = t3;
            return T(i3[1]) && i3[1] === s2[1] && (i3[1] = s2[1] = A(i3[1], e3)), T(i3[2]) && i3[2] === s2[2] && (i3[2] = s2[2] = A(i3[2], e3)), t3;
          }
          path(t3) {
            let e3 = this.styledMode ? {} : { fill: "none" };
            return L(t3) ? e3.d = t3 : E(t3) && O(e3, t3), this.createElement("path").attr(e3);
          }
          circle(t3, e3, i3) {
            let s2 = E(t3) ? t3 : void 0 === t3 ? {} : { x: t3, y: e3, r: i3 }, o2 = this.createElement("circle");
          ...
          arc(t3, e3, i3, s2, o2, r2) {
            let a2;
            E(t3) ? (e3 = (a2 = t3).y, i3 = a2.r, s2 = a2.innerR, o2 = a2.start, r2 = a2.end, t3 = a2.x) : a2 = { innerR: s2, start: o2, end: r2 };
            let n2 = this.symbol("arc", t3, e3, i3, i3, a2);
            return n2.r = i3, n2;
          }
          rect(t3, e3, i3, s2, o2, r2) {
            let a2 = E(t3) ? t3 : void 0 === t3 ? {} : { x: t3, y: e3, r: o2, width: Math.max(i3 || 0, 0), height: Math.max(s2 || 0, 0) }, n2 = this.createElement("rect");
            return this.styledMode || (void 0 !== r2 && (a2["stroke-width"] = r2, O(a2, n2.crisp(a2))), a2.fill = "none"), n2.rSetter = function(t4, e4, i4) {
              n2.r = t4, M(i4, { rx: t4, ry: t4 });
            }, n2.rGetter = function() {
              return n2.r || 0;
            }, n2.attr(a2);
          }
          ...
          image(t3, e3, i3, s2, o2, r2) {
            ...
            D(e3) && (a2.x = e3), D(i3) && (a2.y = i3), D(s2) && (a2.width = s2), D(o2) && (a2.height = o2);
          ...
          symbol(t3, e3, i3, s2, o2, r2) {
            ...
            if (m2) "number" == typeof e3 && (n2 = m2.call(this.symbols, e3 || 0, i3 || 0, s2 || 0, o2 || 0, r2)), a2 = this.path(n2), d2.styledMode || a2.attr("fill", "none"), O(a2, { symbolName: f2 || void 0, x: e3, y: i3, width: s2, height: o2 }), r2 && O(a2, r2);
            else if (u2) {
              l2 = t3.match(c2)[1];
              let s3 = a2 = this.image(l2);
              s3.imgwidth = R(r2 && r2.width, v[l2] && v[l2].width), s3.imgheight = R(r2 && r2.height, v[l2] && v[l2].height), h2 = (t4) => t4.attr({ width: t4.width, height: t4.height }), ["width", "height"].forEach((t4) => {
                s3[`${t4}Setter`] = function(t5, e4) {
                  this[e4] = t5;
                  let { alignByTranslate: i4, element: s4, width: o3, height: a3, imgwidth: n3, imgheight: l3 } = this, h3 = "width" === e4 ? n3 : l3, d3 = 1;
                  r2 && "within" === r2.backgroundSize && o3 && a3 && n3 && l3 ? (d3 = Math.min(o3 / n3, a3 / l3), M(s4, { width: Math.round(n3 * d3), height: Math.round(l3 * d3) })) : s4 && h3 && s4.setAttribute(e4, h3), !i4 && n3 && l3 && this.translate(((o3 || 0) - n3 * d3) / 2, ((a3 || 0) - l3 * d3) / 2);
                };
              }), T(e3) && s3.attr({ x: e3, y: i3 }), s3.isImg = true, s3.symbolUrl = t3, T(s3.imgwidth) && T(s3.imgheight) ? h2(s3) : (s3.attr({ width: 0, height: 0 }), C("img", { onload: function() {
                let t4 = p[d2.chartIndex];
                0 === this.width && (w(this, { position: "absolute", top: "-999em" }), g.body.appendChild(this)), v[l2] = { width: this.width, height: this.height }, s3.imgwidth = this.width, s3.imgheight = this.height, s3.element && h2(s3), this.parentNode && this.parentNode.removeChild(this), d2.imgCount--, d2.imgCount || !t4 || t4.hasLoaded || t4.onload();
          ...
          pathToSegments(t3) {
            ...
            for (let o2 = 0; o2 < t3.length; o2++) B(i3[0]) && D(t3[o2]) && i3.length === s2[i3[0].toUpperCase()] && t3.splice(o2, 0, i3[0].replace("M", "L").replace("m", "l")), "string" == typeof t3[o2] && (i3.length && e3.push(i3.slice(0)), i3.length = 0), i3.push(t3[o2]);
            return e3.push(i3.slice(0)), e3;
          }
          label(t3, e3, i3, s2, o2, r2, n2, l2, h2) {
            return new a(this, t3, e3, i3, s2, o2, r2, n2, l2, h2);
          }
          alignElements() {
            this.alignedObjects.forEach((t3) => t3.align());
          }
        }
        return O(N.prototype, { Element: r, SVG_NS: b, escapes: { "&": "&amp;", "<": "&lt;", ">": "&gt;", "'": "&#39;", '"': "&quot;" }, symbols: n, draw: y }), o.registerRendererType("svg", N, true), N;
        ...
        function p(t3, e3, s2) {
          var _a;
          let o2 = ((_a = this.div) == null ? void 0 : _a.style) || s2.style;
          i2.prototype[`${e3}Setter`].call(this, t3, e3, s2), o2 && (o2[e3] = t3);
        }
        let u = (t3, e3) => {
          var _a;
          if (!t3.div) {
            let s2 = r(t3.element, "class"), o2 = t3.css, a2 = n("div", s2 ? { className: s2 } : void 0, { position: "absolute", left: `${t3.translateX || 0}px`, top: `${t3.translateY || 0}px`, ...t3.styles, display: t3.display, opacity: t3.opacity, visibility: t3.visibility }, ((_a = t3.parentGroup) == null ? void 0 : _a.div) || e3);
        ...
        class g extends i2 {
          ...
          css(t3) {
            ...
            return s2 && (delete t3.width, this.textWidth = d(o2) || void 0, e3 = true), (t3 == null ? void 0 : t3.textOverflow) === "ellipsis" && (t3.whiteSpace = "nowrap", t3.overflow = "hidden"), h(this.styles, t3), a(i3, t3), e3 && this.updateTransform(), this;
          }
          htmlGetBBox() {
            let { element: t3 } = this;
          ...
          updateTransform() {
            ...
            let { element: t3, renderer: e3, rotation: i3, rotationOriginX: s2, rotationOriginY: o2, styles: r2, textAlign: n2 = "left", textWidth: h2, translateX: d2 = 0, translateY: c2 = 0, x: p2 = 0, y: u2 = 0 } = this, g2 = { left: 0, center: 0.5, right: 1 }[n2], f2 = r2.whiteSpace;
            if (a(t3, { marginLeft: `${d2}px`, marginTop: `${c2}px` }), "SPAN" === t3.tagName) {
              let r3 = [i3, n2, t3.innerHTML, h2, this.textAlign].join(","), d3 = -(((_a = this.parentGroup) == null ? void 0 : _a.padding) * 1) || 0, c3, m = false;
              if (h2 !== this.oldTextWidth) {
                let e4 = this.textPxLength ? this.textPxLength : (a(t3, { width: "", whiteSpace: f2 || "nowrap" }), t3.offsetWidth), s3 = h2 || 0;
                (s3 > this.oldTextWidth || e4 > s3) && (/[ \-]/.test(t3.textContent || t3.innerText) || "ellipsis" === t3.style.textOverflow) && (a(t3, { width: e4 > s3 || i3 ? h2 + "px" : "auto", display: "block", whiteSpace: f2 || "normal" }), this.oldTextWidth = h2, m = true);
              }
              this.hasBoxWidthChanged = m, r3 !== this.cTT && (c3 = e3.fontMetrics(t3).b, l(i3) && (i3 !== (this.oldRotation || 0) || n2 !== this.oldAlign) && this.setSpanRotation(i3, d3, d3), this.getSpanCorrection(!l(i3) && this.textPxLength || t3.offsetWidth, c3, g2));
              let { xCorr: x = 0, yCorr: y = 0 } = this, b = (s2 ?? p2) - x - p2 - d3, v = (o2 ?? u2) - y - u2 - d3;
              a(t3, { left: `${p2 + x}px`, top: `${u2 + y}px`, transformOrigin: `${b}px ${v}px` }), this.cTT = r3, this.oldRotation = i3, this.oldAlign = n2;
            }
          }
        ...
        return class {
          ...
          addLabel() {
            let e3 = this, i3 = e3.axis, s2 = i3.options, o2 = i3.chart, n2 = i3.categories, c2 = i3.logarithmic, p2 = i3.names, g = e3.pos, f = u(e3.options && e3.options.labels, s2.labels), m = i3.tickPositions, x = g === m[0], y = g === m[m.length - 1], b = (!f.step || 1 === f.step) && 1 === i3.tickInterval, v = m.info, S = e3.label, k, M, C, A = this.parameters.category || (n2 ? u(n2[g], p2[g], g) : g);
            c2 && d(A) && (A = r(c2.lin2log(A))), i3.dateTime && (v ? k = (M = o2.time.resolveDTLFormat(s2.dateTimeLabelFormats[!s2.grid && v.higherRanks[g] || v.unitName])).main : d(A) && (k = i3.dateTime.getXDateFormat(A, s2.dateTimeLabelFormats || {}))), e3.isFirst = x, e3.isLast = y;
            let w = { axis: i3, chart: o2, dateTimeLabelFormat: k, isFirst: x, isLast: y, pos: g, tick: e3, tickPositionInfo: v, value: A };
            h(this, "labelFormat", w);
            let T = (e4) => f.formatter ? f.formatter.call(e4, e4) : f.format ? (e4.text = i3.defaultLabelFormatter.call(e4), t2.format(f.format, e4, o2)) : i3.defaultLabelFormatter.call(e4), P = T.call(w, w), O = M && M.list;
            O ? e3.shortenLabel = function() {
              for (C = 0; C < O.length; C++) if (l(w, { dateTimeLabelFormat: O[C] }), S.attr({ text: T.call(w, w) }), S.getBBox().width < i3.getSlotWidth(e3) - 2 * (f.padding || 0)) return;
              S.attr({ text: "" });
          ...
          createLabel(t3, e3, i3) {
            let s2 = this.axis, o2 = s2.chart, r2 = a(t3) && e3.enabled ? o2.renderer.text(t3, i3 == null ? void 0 : i3.x, i3 == null ? void 0 : i3.y, e3.useHTML).add(s2.labelGroup) : void 0;
          ...
          getPosition(t3, e3, i3, s2) {
            ...
            return d2.y = o(d2.y, -1e9, 1e9), h(this, "afterGetPosition", { pos: d2 }), d2;
          }
          getLabelPosition(t3, e3, i3, o2, r2, n2, l2, d2) {
            ...
            return c2 = 0 === g.side ? i3.rotation ? -v : -i3.getBBox().height : 2 === g.side ? y.y + v : Math.cos(i3.rotation * s) * (y.y - i3.getBBox(false, 0).height / 2), a(r2.y) && (c2 = 0 === g.side && g.horiz ? r2.y + c2 : r2.y), t3 = t3 + u(r2.x, [0, 1, 0, -1][g.side] * v) + b + y.x - (n2 && o2 ? n2 * f * (m ? -1 : 1) : 0), e3 = e3 + c2 - (n2 && !o2 ? n2 * f * (m ? 1 : -1) : 0), x && (p2 = l2 / (d2 || 1) % x, g.opposite && (p2 = x - p2 - 1), e3 += p2 * (g.labelOffset / x)), S.x = t3, S.y = Math.round(e3), h(this, "afterGetLabelPosition", { pos: S, tickmarkOffset: n2, index: l2 }), S;
          }
          getLabelSize() {
          ...
          render(t3, e3, i3) {
            let s2 = this.axis, o2 = s2.horiz, a2 = this.pos, n2 = u(this.tickmarkOffset, s2.tickmarkOffset), l2 = this.getPosition(o2, a2, n2, e3), d2 = l2.x, c2 = l2.y, p2 = s2.pos, g = p2 + s2.len, f = o2 ? d2 : c2;
          ...
          renderGridLine(t3, e3) {
            let i3 = this.axis, s2 = i3.options, o2 = {}, r2 = this.pos, a2 = this.type, n2 = u(this.tickmarkOffset, i3.tickmarkOffset), l2 = i3.chart.renderer, h2 = this.gridLine, d2, c2 = s2.gridLineWidth, p2 = s2.gridLineColor, g = s2.gridLineDashStyle;
            "minor" === this.type && (c2 = s2.minorGridLineWidth, p2 = s2.minorGridLineColor, g = s2.minorGridLineDashStyle), h2 || (i3.chart.styledMode || (o2.stroke = p2, o2["stroke-width"] = c2 || 0, o2.dashstyle = g), a2 || (o2.zIndex = 1), t3 && (e3 = 0), this.gridLine = h2 = l2.path().attr(o2).addClass("highcharts-" + (a2 ? a2 + "-" : "") + "grid-line").add(i3.gridGroup)), h2 && (d2 = i3.getPlotLinePath({ value: r2 + n2, lineWidth: h2.strokeWidth(), force: "pass", old: t3, acrossPanes: false })) && h2[t3 || this.isNew ? "attr" : "animate"]({ d: d2, opacity: e3 });
          }
          renderMark(t3, e3) {
            let i3 = this.axis, s2 = i3.options, o2 = i3.chart.renderer, r2 = this.type, a2 = i3.tickSize(r2 ? r2 + "Tick" : "tick"), n2 = t3.x, l2 = t3.y, h2 = u(s2["minor" !== r2 ? "tickWidth" : "minorTickWidth"], !r2 && i3.isXAxis ? 1 : 0), d2 = s2["minor" !== r2 ? "tickColor" : "minorTickColor"], c2 = this.mark, p2 = !c2;
            a2 && (i3.opposite && (a2[0] = -a2[0]), c2 || (this.mark = c2 = o2.path().addClass("highcharts-" + (r2 ? r2 + "-" : "") + "tick").add(i3.axisGroup), i3.chart.styledMode || c2.attr({ stroke: d2, "stroke-width": h2 })), c2[p2 ? "attr" : "animate"]({ d: this.getMarkPath(n2, l2, a2[0], c2.strokeWidth(), i3.horiz, o2), opacity: e3 }));
          }
        ...
        let { animObject: l } = t2, { xAxis: h, yAxis: d } = e2, { defaultOptions: c } = s, { registerEventOptions: p } = o, { deg2rad: u } = r, { arrayMax: g, arrayMin: f, clamp: m, correctFloat: x, defined: y, destroyObjectProperties: b, erase: v, error: S, extend: k, fireEvent: M, getClosestDistance: C, insertItem: A, isArray: w, isNumber: T, isString: P, merge: O, normalizeTickInterval: L, objectEach: D, pick: E, relativeLength: B, removeEvent: j, splat: R, syncTimeout: I } = n, z = (t3, e3) => L(e3, void 0, void 0, E(t3.options.allowDecimals, e3 < 0.5 || void 0 !== t3.tickAmount), !!t3.tickAmount);
        ...
        class G {
          ...
          defaultLabelFormatter() {
            ...
            else if (d2 && n2 && h2 >= 1e3) for (; d2-- && void 0 === u2; ) h2 >= (p2 = Math.pow(l2, d2 + 1)) && 10 * i3 % p2 == 0 && null !== n2[d2] && 0 !== i3 && (u2 = e3(i3 / p2, -1) + n2[d2]);
            ...
            M(this, "getSeriesExtremes", null, function() {
              e3.hasVisibleSeries = false, e3.dataMin = e3.dataMax = e3.threshold = void 0, e3.softThreshold = !e3.isXAxis, e3.series.forEach((i3) => {
                if (i3.reserveSpace()) {
                  ...
                  if (e3.hasVisibleSeries = true, e3.positiveValuesOnly && 0 >= (r2 || 0) && (r2 = void 0), e3.isXAxis) (o2 = i3.xData) && o2.length && (o2 = e3.logarithmic ? o2.filter((t4) => t4 > 0) : o2, a2 = (t3 = i3.getXExtremes(o2)).min, n2 = t3.max, T(a2) || a2 instanceof Date || (o2 = o2.filter(T), a2 = (t3 = i3.getXExtremes(o2)).min, n2 = t3.max), o2.length && (e3.dataMin = Math.min(E(e3.dataMin, a2), a2), e3.dataMax = Math.max(E(e3.dataMax, n2), n2)));
                  else {
          ...
          translate(t3, e3, i3, s2, o2, r2) {
            ...
            if (!T(n2)) return NaN;
            let l2 = a2.minPixelPadding, h2 = (a2.isOrdinal || ((_a = a2.brokenAxis) == null ? void 0 : _a.hasBreaks) || a2.logarithmic && o2) && a2.lin2val, d2 = 1, c2 = 0, p2 = s2 && a2.old ? a2.old.transA : a2.transA, u2 = 0;
            return p2 || (p2 = a2.transA), i3 && (d2 *= -1, c2 = a2.len), a2.reversed && (d2 *= -1, c2 -= d2 * (a2.sector || a2.len)), e3 ? (u2 = (t3 = t3 * d2 + c2 - l2) / p2 + n2, h2 && (u2 = a2.lin2val(u2))) : (h2 && (t3 = a2.val2lin(t3)), u2 = d2 * (t3 - n2) * p2 + c2 + d2 * l2 + (T(r2) ? p2 * r2 : 0), a2.isRadial || (u2 = x(u2))), u2;
          }
          toPixels(t3, e3) {
          ...
          getPlotLinePath(t3) {
            ...
            return M(this, "getPlotLinePath", v2, function(t4) {
              u2 = f2 = (c2 = m(c2 = E(c2, e3.translate(a2, void 0, void 0, r2)), -1e9, 1e9)) + d2, g2 = x2 = l2 - c2 - d2, T(c2) ? e3.horiz ? (g2 = o2, x2 = l2 - e3.bottom + (e3.options.isInternal ? 0 : i3.scrollablePixelsY || 0), u2 = f2 = b2(u2, s2, s2 + e3.width)) : (u2 = s2, f2 = h2 - e3.right + (i3.scrollablePixelsX || 0), g2 = x2 = b2(g2, o2, o2 + e3.height)) : (y2 = true, p2 = false), t4.path = y2 && !p2 ? void 0 : i3.renderer.crispLine([["M", u2, g2], ["L", f2, x2]], n2 || 1);
            }), v2.path;
          }
          getLinearTickPositions(t3, e3, i3) {
            let s2, o2, r2;
            let a2 = x(Math.floor(e3 / t3) * t3), n2 = x(Math.ceil(i3 / t3) * t3), l2 = [];
            if (x(a2 + t3) === a2 && (r2 = 20), this.single) return [e3];
            for (s2 = a2; s2 <= n2 && (l2.push(s2), (s2 = x(s2 + t3, r2)) !== o2); ) o2 = s2;
            return l2;
          }
          ...
          getMinorTickPositions() {
            ...
            if (a2 && a2 / i3 < this.len / 3) {
              ...
              else if (this.dateTime && "auto" === this.getMinorTickInterval()) n2 = n2.concat(this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(i3), o2, r2, t3.startOfWeek));
              else for (l2 = o2 + (e3[0] - o2) % i3; l2 <= r2 && l2 !== n2[0]; l2 += i3) n2.push(l2);
            }
          ...
          nameToX(t3) {
            ...
            return t3.series.requireSorting = false, y(s2) || (s2 = this.uniqueNames && i3 ? e3 ? i3.indexOf(t3.name) : E(i3.keys[t3.name], -1) : t3.series.autoIncrement()), -1 === s2 ? !e3 && i3 && (o2 = i3.length) : o2 = s2, void 0 !== o2 ? (this.names[o2] = t3.name, this.names.keys[t3.name] = o2) : t3.x && (o2 = t3.x), o2;
          }
          updateNames() {
            ...
            e3.length > 0 && (Object.keys(e3.keys).forEach(function(t4) {
              ...
              e4.xIncrement = null, (!e4.points || e4.isDirtyData) && (t3.max = Math.max(t3.max, e4.xData.length - 1), e4.processData(), e4.generatePoints()), e4.data.forEach(function(i3, s2) {
                let o2;
                (i3 == null ? void 0 : i3.options) && void 0 !== i3.name && void 0 !== (o2 = t3.nameToX(i3)) && o2 !== i3.x && (i3.x = o2, e4.xData[s2] = o2);
              });
            }));
          }
          setAxisTranslation() {
          ...
          setTickInterval(t3) {
            var _a, _b, _c, _d;
            let { categories: e3, chart: i3, dataMax: s2, dataMin: o2, dateTime: r2, isXAxis: a2, logarithmic: n2, options: l2, softThreshold: h2 } = this, d2 = T(this.threshold) ? this.threshold : void 0, c2 = this.minRange || 0, { ceiling: p2, floor: u2, linkedTo: g2, softMax: f2, softMin: m2 } = l2, b2 = T(g2) && ((_a = i3[this.coll]) == null ? void 0 : _a[g2]), v2 = l2.tickPixelInterval, k2 = l2.maxPadding, C2 = l2.minPadding, A2 = 0, w2, P2 = T(l2.tickInterval) && l2.tickInterval >= 0 ? l2.tickInterval : void 0, O2, L2, D2, B2;
            if (r2 || e3 || b2 || this.getTickAmount(), D2 = E(this.userMin, l2.min), B2 = E(this.userMax, l2.max), b2 ? (this.linkedParent = b2, w2 = b2.getExtremes(), this.min = E(w2.min, w2.dataMin), this.max = E(w2.max, w2.dataMax), this.type !== b2.type && S(11, true, i3)) : (h2 && y(d2) && T(s2) && T(o2) && (o2 >= d2 ? (O2 = d2, C2 = 0) : s2 <= d2 && (L2 = d2, k2 = 0)), this.min = E(D2, O2, o2), this.max = E(B2, L2, s2)), T(this.max) && T(this.min) && (n2 && (this.positiveValuesOnly && !t3 && 0 >= Math.min(this.min, E(o2, this.min)) && S(10, true, i3), this.min = x(n2.log2lin(this.min), 16), this.max = x(n2.log2lin(this.max), 16)), this.range && T(o2) && (this.userMin = this.min = D2 = Math.max(o2, this.minFromRange() || 0), this.userMax = B2 = this.max, this.range = void 0)), M(this, "foundExtremes"), this.adjustForMinRange(), T(this.min) && T(this.max)) {
              if (!T(this.userMin) && T(m2) && m2 < this.min && (this.min = D2 = m2), !T(this.userMax) && T(f2) && f2 > this.max && (this.max = B2 = f2), e3 || this.axisPointRange || ((_b = this.stacking) == null ? void 0 : _b.usePercentage) || b2 || !(A2 = this.max - this.min) || (!y(D2) && C2 && (this.min -= A2 * C2), y(B2) || !k2 || (this.max += A2 * k2)), !T(this.userMin) && T(u2) && (this.min = Math.max(this.min, u2)), !T(this.userMax) && T(p2) && (this.max = Math.min(this.max, p2)), h2 && T(o2) && T(s2)) {
                let t4 = d2 || 0;
            ...
            if (this.min !== this.max && T(this.min) && T(this.max) ? b2 && !P2 && v2 === b2.options.tickPixelInterval ? this.tickInterval = P2 = b2.tickInterval : this.tickInterval = E(P2, this.tickAmount ? A2 / Math.max(this.tickAmount - 1, 1) : void 0, e3 ? 1 : A2 * v2 / Math.max(this.len, v2)) : this.tickInterval = 1, a2 && !t3) {
              ...
              }), M(this, "postProcessData", { hasExtremesChanged: t4 });
            }
            this.setAxisTranslation(), M(this, "initialAxisTranslation"), this.pointRange && !P2 && (this.tickInterval = Math.max(this.pointRange, this.tickInterval));
          ...
          setTickPositions() {
            ...
            if (this.tickmarkOffset = this.categories && "between" === t3.tickmarkPlacement && 1 === this.tickInterval ? 0.5 : 0, this.single = this.min === this.max && y(this.min) && !this.tickAmount && (this.min % 1 == 0 || false !== t3.allowDecimals), e3) n2 = e3.slice();
            else if (T(this.min) && T(this.max)) {
              if (!((_a = this.ordinal) == null ? void 0 : _a.positions) && (this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200)) n2 = [this.min, this.max], S(19, false, this.chart);
              else if (this.dateTime) n2 = this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(this.tickInterval, t3.units), this.min, this.max, t3.startOfWeek, (_b = this.ordinal) == null ? void 0 : _b.positions, this.closestPointRange, true);
                ...
                for (; e4 <= 2 * t4; ) if (n2 = this.getLinearTickPositions(this.tickInterval, this.min, this.max), this.tickAmount && n2.length > this.tickAmount) this.tickInterval = z(this, e4 *= 1.1);
                else break;
              }
            ...
            this.tickPositions = n2, this.minorTickInterval = "auto" === s2 && this.tickInterval ? this.tickInterval / t3.minorTicksPerMajor : s2, this.paddedTicks = n2.slice(0), this.trimTicks(n2, r2, a2), !this.isLinked && T(this.min) && T(this.max) && (this.single && n2.length < 2 && !this.categories && !this.series.some((t4) => t4.is("heatmap") && "between" === t4.options.pointPlacement) && (this.min -= 0.5, this.max += 0.5), e3 || l2 || this.adjustTickAmount()), M(this, "afterSetTickPositions");
          }
          trimTicks(t3, e3, i3) {
          ...
          adjustTickAmount() {
            let t3 = this, { finalTickAmt: e3, max: i3, min: s2, options: o2, tickPositions: r2, tickAmount: a2, thresholdAlignment: n2 } = t3, l2 = r2 == null ? void 0 : r2.length, h2 = E(t3.threshold, t3.softThreshold ? 0 : null), d2, c2, p2 = t3.tickInterval, u2, g2 = () => r2.push(x(r2[r2.length - 1] + p2)), f2 = () => r2.unshift(x(r2[0] - p2));
            if (T(n2) && (u2 = n2 < 0.5 ? Math.ceil(n2 * (a2 - 1)) : Math.floor(n2 * (a2 - 1)), o2.reversed && (u2 = a2 - 1 - u2)), t3.hasData() && T(s2) && T(i3)) {
              ...
              if (T(u2) && T(t3.threshold)) {
                for (; r2[u2] !== h2 || r2.length !== a2 || r2[0] > s2 || r2[r2.length - 1] < i3; ) {
                  for (r2.length = 0, r2.push(t3.threshold); r2.length < a2; ) void 0 === r2[u2] || r2[u2] > t3.threshold ? f2() : g2();
                  if (p2 > 8 * t3.tickInterval) break;
                  p2 *= 2;
                }
                n3();
              } else if (l2 < a2) {
                for (; r2.length < a2; ) r2.length % 2 || s2 === h2 ? g2() : f2();
                n3();
              }
              if (y(e3)) {
          ...
          setScale() {
            ...
            o2 || i3 || s2 || this.isLinked || this.forceRedraw || this.userMin !== (this.old && this.old.userMin) || this.userMax !== (this.old && this.old.userMax) || this.alignToOthers() ? (e3 && "yAxis" === t3 && e3.buildStacks(), this.forceRedraw = false, this.userMinRange || (this.minRange = void 0), this.getSeriesExtremes(), this.setTickInterval(), e3 && "xAxis" === t3 && e3.buildStacks(), this.isDirty || (this.isDirty = o2 || this.min !== ((_a = this.old) == null ? void 0 : _a.min) || this.max !== ((_b = this.old) == null ? void 0 : _b.max))) : e3 && e3.cleanStacks(), i3 && delete this.allExtremes, M(this, "afterSetScale");
          }
          setExtremes(t3, e3, i3 = true, s2, o2) {
            this.series.forEach((t4) => {
              delete t4.kdTree;
            }), M(this, "setExtremes", o2 = k(o2, { min: t3, max: e3 }), (t4) => {
          ...
          autoLabelAlign(t3) {
            ...
            return M(this, "autoLabelAlign", i3, function(t4) {
          ...
          tickSize(t3) {
            ...
            let r2 = { tickSize: o2 };
            return M(this, "afterTickSize", r2), r2.tickSize;
          }
          labelMetrics() {
          ...
          unsquish() {
            let t3 = this.options.labels, e3 = t3.padding || 0, i3 = this.horiz, s2 = this.tickInterval, o2 = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / s2), r2 = t3.rotation, a2 = x(0.8 * this.labelMetrics().h), n2 = Math.max(this.max - this.min, 0), l2 = function(t4) {
              let i4 = (t4 + 2 * e3) / (o2 || 1);
              return (i4 = i4 > 1 ? Math.ceil(i4) : 1) * s2 > n2 && t4 !== 1 / 0 && o2 !== 1 / 0 && n2 && (i4 = Math.ceil(n2 / s2)), x(i4 * s2);
            }, h2 = s2, d2, c2 = Number.MAX_VALUE, p2;
            if (i3) {
              if (!t3.staggerLines && (T(r2) ? p2 = [r2] : o2 < t3.autoRotationLimit && (p2 = t3.autoRotation)), p2) {
                let t4, e4;
                for (let i4 of p2) (i4 === r2 || i4 && i4 >= -90 && i4 <= 90) && (e4 = (t4 = l2(Math.abs(a2 / Math.sin(u * i4)))) + Math.abs(i4 / 360)) < c2 && (c2 = e4, d2 = i4, h2 = t4);
              }
            } else h2 = l2(0.75 * a2);
            return this.autoRotation = p2, this.labelRotation = E(d2, T(r2) ? r2 : 0), t3.step ? s2 : h2;
          }
          getSlotWidth(t3) {
          ...
          renderUnsquish() {
            let t3 = this.chart, e3 = t3.renderer, i3 = this.tickPositions, s2 = this.ticks, o2 = this.options.labels, r2 = o2.style, a2 = this.horiz, n2 = this.getSlotWidth(), l2 = Math.max(1, Math.round(n2 - (a2 ? 2 * (o2.padding || 0) : o2.distance || 0))), h2 = {}, d2 = this.labelMetrics(), c2 = r2.textOverflow, p2, u2, g2 = 0, f2, m2;
            ...
            else if (n2 && (p2 = l2, !c2)) for (u2 = "clip", m2 = i3.length; !a2 && m2--; ) (f2 = s2[i3[m2]].label) && ("ellipsis" === f2.styles.textOverflow ? f2.css({ textOverflow: "clip" }) : f2.textPxLength > n2 && f2.css({ width: n2 + "px" }), f2.getBBox().height > this.len / i3.length - (d2.h - d2.f) && (f2.specificTextOverflow = "ellipsis"));
          ...
          addTitle(t3) {
            ...
            this.axisTitle || ((e3 = r2.textAlign) || (e3 = (s2 ? { low: "left", middle: "center", high: "right" } : { low: o2 ? "right" : "left", middle: "center", high: o2 ? "left" : "right" })[r2.align]), this.axisTitle = i3.text(r2.text || "", 0, 0, r2.useHTML).attr({ zIndex: 7, rotation: r2.rotation || 0, align: e3 }).addClass("highcharts-axis-title"), a2 || this.axisTitle.css(O(r2.style)), this.axisTitle.add(this.axisGroup), this.axisTitle.isNew = true), a2 || r2.style.width || this.isRadial || this.axisTitle.css({ width: this.len + "px" }), this.axisTitle[t3 ? "show" : "hide"](t3);
          }
          generateTick(t3) {
            let e3 = this.ticks;
          ...
          getOffset() {
            let t3 = this, { chart: e3, horiz: i3, options: s2, side: o2, ticks: r2, tickPositions: a2, coll: n2 } = t3, l2 = e3.inverted && !t3.isZAxis ? [1, 0, 3, 2][o2] : o2, h2 = t3.hasData(), d2 = s2.title, c2 = s2.labels, p2 = T(s2.crossing), u2 = e3.axisOffset, g2 = e3.clipOffset, f2 = [-1, 1, 1, -1][o2], m2, x2 = 0, b2, v2 = 0, S2 = 0, k2, C2;
          ...
          getTitlePosition(t3) {
            ...
            return M(this, "afterGetTitlePosition", { titlePosition: f2 }), f2;
          }
          ...
          render() {
            ...
            }), v2 && (v2[v2.isPlaced ? "animate" : "attr"]({ d: this.getLinePath(v2.strokeWidth()) }), v2.isPlaced = true, v2[S2 ? "show" : "hide"](S2)), p2 && S2 && (p2[p2.isNew ? "attr" : "animate"](i3.getTitlePosition(p2)), p2.isNew = false), m2 && m2.enabled && i3.stacking && i3.stacking.renderStackTotals(), i3.old = { len: i3.len, max: i3.max, min: i3.min, transA: i3.transA, userMax: i3.userMax, userMin: i3.userMin }, i3.isDirty = false, M(this, "afterRender");
          }
          redraw() {
          ...
          destroy(t3) {
            ...
            if (M(this, "destroy", { keepEvents: t3 }), t3 || j(e3), [e3.ticks, e3.minorTicks, e3.alternateBands].forEach(function(t4) {
              b(t4);
            }), i3) {
              let t4 = i3.length;
          ...
          drawCrosshair(t3, e3) {
            ...
            M(this, "afterDrawCrosshair", { e: t3, point: e3 });
          }
          hideCrosshair() {
          ...
          update(t3, e3) {
            let i3 = this.chart;
            t3 = O(this.userOptions, t3), this.destroy(true), this.init(i3, t3), i3.isDirtyBox = true, E(e3, true) && i3.redraw();
          }
          remove(t3) {
        ...
        return G.keepProps = ["coll", "extKey", "hcEvents", "len", "names", "series", "userMax", "userMin"], G;
        ...
        return function(t3) {
          ...
          t3.compose = function(t4) {
            return t4.keepProps.includes("dateTime") || (t4.keepProps.push("dateTime"), t4.prototype.getTimeTicks = e3, i2(t4, "afterSetType", a)), t4;
          };
          class n {
            constructor(t4) {
              this.axis = t4;
        ...
        return function(t3) {
          ...
          t3.compose = function(t4) {
            return t4.keepProps.includes("logarithmic") || (t4.keepProps.push("logarithmic"), i2(t4, "afterSetType", e3), i2(t4, "afterInit", r)), t4;
          };
          class a {
            constructor(t4) {
              this.axis = t4;
            ...
            getLogTickPositions(t4, e4, i3, r2) {
              ...
              if (r2 || (this.minorAutoInterval = void 0), t4 >= 0.5) t4 = Math.round(t4), h = a2.getLinearTickPositions(t4, e4, i3);
              else if (t4 >= 0.08) {
                let s2, o2, a3, n2, l2, d, c;
                let p = Math.floor(e4);
                for (s2 = t4 > 0.3 ? [1, 2, 4] : t4 > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9], o2 = p; o2 < i3 + 1 && !c; o2++) for (a3 = 0, n2 = s2.length; a3 < n2 && !c; a3++) (l2 = this.log2lin(this.lin2log(o2) * s2[a3])) > e4 && (!r2 || d <= i3) && void 0 !== d && h.push(d), d > i3 && (c = true), d = l2;
              } else {
        ...
        return function(t3) {
          ...
          function l(t4, e4, i3) {
            ...
            if (l2 && s2) for (n2 && (c2 = l2.toString() === s2.toString(), d2 = 0), h2 = 0; h2 < l2.length; h2 += 2) {
        ...
        let { addEvent: i2, arrayMax: s, arrayMin: o, defined: r, destroyObjectProperties: a, erase: n, fireEvent: l, merge: h, objectEach: d, pick: c } = e2;
        class p {
          ...
          render() {
            l(this, "render");
            let { axis: t3, options: e3 } = this, { horiz: i3, logarithmic: s2 } = t3, { color: o2, events: a2, zIndex: n2 = 0 } = e3, p2 = {}, u = t3.chart.renderer, g = e3.to, f = e3.from, m = e3.value, x = e3.borderWidth, y = e3.label, { label: b, svgElem: v } = this, S = [], k, M = r(f) && r(g), C = r(m), A = !v, w = { class: "highcharts-plot-" + (M ? "band " : "line ") + (e3.className || "") }, T = M ? "bands" : "lines";
            if (!t3.chart.styledMode && (C ? (w.stroke = o2 || "#999999", w["stroke-width"] = c(e3.width, 1), e3.dashStyle && (w.dashstyle = e3.dashStyle)) : M && (w.fill = o2 || "#e6e9ff", x && (w.stroke = e3.borderColor, w["stroke-width"] = x))), p2.zIndex = n2, T += "-" + n2, (k = t3.plotLinesAndBandsGroups[T]) || (t3.plotLinesAndBandsGroups[T] = k = u.g("plot-" + T).attr(p2).add()), v || (this.svgElem = v = u.path().attr(w).add(k)), r(m)) S = t3.getPlotLinePath({ value: (s2 == null ? void 0 : s2.log2lin(m)) ?? m, lineWidth: v.strokeWidth(), acrossPanes: e3.acrossPanes });
            else {
              if (!(r(f) && r(g))) return;
              S = t3.getPlotBandPath((s2 == null ? void 0 : s2.log2lin(f)) ?? f, (s2 == null ? void 0 : s2.log2lin(g)) ?? g, e3);
            }
            return !this.eventsAdded && a2 && (d(a2, (t4, e4) => {
              v == null ? void 0 : v.on(e4, (t5) => {
                a2[e4].apply(this, [t5]);
              });
            }), this.eventsAdded = true), (A || !v.d) && (S == null ? void 0 : S.length) ? v.attr({ d: S }) : v && (S ? (v.show(), v.animate({ d: S })) : v.d && (v.hide(), b && (this.label = b = b.destroy()))), y && (r(y.text) || r(y.formatter)) && (S == null ? void 0 : S.length) && t3.width > 0 && t3.height > 0 && !S.isFlat ? (y = h({ align: i3 && M ? "center" : void 0, x: i3 ? !M && 4 : 10, verticalAlign: !i3 && M ? "middle" : void 0, y: i3 ? M ? 16 : 10 : M ? 6 : -4, rotation: i3 && !M ? 90 : 0, ...M ? { inside: true } : {} }, y), this.renderLabel(y, S, M, n2)) : b && b.hide(), this;
          }
          renderLabel(t3, e3, i3, a2) {
            var _a;
            let n2 = this.axis, l2 = n2.chart.renderer, d2 = t3.inside, c2 = this.label;
            c2 || (this.label = c2 = l2.text(this.getLabelText(t3), 0, 0, t3.useHTML).attr({ align: t3.textAlign || t3.align, rotation: t3.rotation, class: "highcharts-plot-" + (i3 ? "band" : "line") + "-label " + (t3.className || ""), zIndex: a2 }), n2.chart.styledMode || c2.css(h({ fontSize: "0.8em", textOverflow: i3 && !d2 ? "" : "ellipsis" }, t3.style)), c2.add());
            let p2 = e3.xBounds || [e3[0][1], e3[1][1], i3 ? e3[2][1] : e3[0][1]], u = e3.yBounds || [e3[0][2], e3[1][2], i3 ? e3[2][2] : e3[0][2]], g = o(p2), f = o(u), m = s(p2) - g;
            c2.align(t3, false, { x: g, y: f, width: m, height: s(u) - f }), (!c2.alignValue || "left" === c2.alignValue || r(d2)) && c2.css({ width: (((_a = t3.style) == null ? void 0 : _a.width) || (i3 && d2 ? m : 90 === c2.rotation ? n2.height - (c2.alignAttr.y - n2.top) : (t3.clip ? n2.width : n2.chart.chartWidth) - (c2.alignAttr.x - n2.left))) + "px" }), c2.show(true);
          }
          getLabelText(t3) {
        ...
        var a;
        let { animObject: n } = t2, { format: l } = e2, { composed: h, doc: d, isSafari: c } = i2, { distribute: p } = s, { addEvent: u, clamp: g, css: f, discardElement: m, extend: x, fireEvent: y, isArray: b, isNumber: v, isString: S, merge: k, pick: M, pushUnique: C, splat: A, syncTimeout: w } = r;
        class T {
          constructor(t3, e3, i3) {
          ...
          getAnchor(t3, e3) {
            ...
            if ((t3 = A(t3))[0].series && t3[0].series.yAxis && !t3[0].series.yAxis.options.reversedStacks && (t3 = t3.slice().reverse()), this.followPointer && e3) void 0 === e3.chartX && (e3 = o2.normalize(e3)), i3 = [e3.chartX - n2, e3.chartY - a2];
          ...
          getClassName(t3, e3, i3) {
            ...
            return [s2.className, "highcharts-label", i3 && "highcharts-tooltip-header", e3 ? "highcharts-tooltip-box" : "highcharts-tooltip", !i3 && "highcharts-color-" + M(t3.colorIndex, o2.colorIndex), r2 && r2.className].filter(S).join(" ");
          }
          getLabel({ anchorX: t3, anchorY: e3 } = { anchorX: 0, anchorY: 0 }) {
            let s2 = this, r2 = this.chart.styledMode, a2 = this.options, n2 = this.split && this.allowShared, l2 = this.container, h2 = this.chart.renderer;
            if (this.label) {
              let t4 = !this.label.hasClass("highcharts-label");
              (!n2 && t4 || n2 && !t4) && this.destroy();
            }
            if (!this.label) {
              if (this.outside) {
                let t4 = this.chart.options.chart.style, e4 = o.getRendererType();
                this.container = l2 = i2.doc.createElement("div"), l2.className = "highcharts-tooltip-container", f(l2, { position: "absolute", top: "1px", pointerEvents: "none", zIndex: Math.max(this.options.style.zIndex || 0, (t4 && t4.zIndex || 0) + 3) }), this.renderer = h2 = new e4(l2, 0, 0, t4, void 0, void 0, h2.styledMode);
              }
              if (n2 ? this.label = h2.g("tooltip") : (this.label = h2.label("", t3, e3, a2.shape, void 0, void 0, a2.useHTML, void 0, "tooltip").attr({ padding: a2.padding, r: a2.borderRadius }), r2 || this.label.attr({ fill: a2.backgroundColor, "stroke-width": a2.borderWidth || 0 }).css(a2.style).css({ pointerEvents: a2.style.pointerEvents || (this.shouldStickOnContact() ? "auto" : "none") })), s2.outside) {
                let t4 = this.label;
                [t4.xSetter, t4.ySetter].forEach((e4, i3) => {
                  t4[i3 ? "ySetter" : "xSetter"] = (o2) => {
                    e4.call(t4, s2.distance), t4[i3 ? "y" : "x"] = o2, l2 && (l2.style[i3 ? "top" : "left"] = `${o2}px`);
                  };
                });
              }
              this.label.attr({ zIndex: 8 }).shadow(a2.shadow).add();
            }
            return l2 && !l2.parentElement && i2.doc.body.appendChild(l2), this.label;
          }
          getPlayingField() {
            let { body: t3, documentElement: e3 } = d, { chart: i3, distance: s2, outside: o2 } = this;
          ...
          getPosition(t3, e3, i3) {
            ...
            }, S2 = v2("y"), k2 = v2("x"), C2, A2 = !!i3.negative;
            !d2 && ((_b = (_a = o2.hoverSeries) == null ? void 0 : _a.yAxis) == null ? void 0 : _b.reversed) && (A2 = !A2);
            let w2 = !this.followPointer && M(i3.ttBelow, !d2 && !n2 === A2), T2 = function(t4, e4, i4, o3, a3, n3, l3) {
              let h3 = r2 ? "y" === t4 ? b2(s2) : y2(s2) : s2, d3 = (i4 - o3) / 2, c3 = o3 < a3 - s2, p3 = a3 + s2 + o3 < e4, f3 = a3 - h3 - i4 + d3, m3 = a3 + h3 - d3;
              if (w2 && p3) u2[t4] = m3;
              else if (!w2 && c3) u2[t4] = f3;
              ...
              false !== T2.apply(0, S2) ? false !== P.apply(0, k2) || C2 || (O(true), L()) : C2 ? u2.x = u2.y = 0 : (O(true), L());
            };
            return (n2 && !d2 || this.len > 1) && O(), L(), u2;
          }
          hide(t3) {
            let e3 = this;
            r.clearTimeout(this.hideTimer), t3 = M(t3, this.options.hideDelay), this.isHidden || (this.hideTimer = w(function() {
              let i3 = e3.getLabel();
          ...
          init(t3, e3) {
            this.chart = t3, this.options = e3, this.crosshairs = [], this.isHidden = true, this.split = e3.split && !t3.inverted && !t3.polar, this.shared = e3.shared || this.split, this.outside = M(e3.outside, !!(t3.scrollablePixelsX || t3.scrollablePixelsY));
          }
          ...
          move(t3, e3, i3, s2) {
            let o2 = this, r2 = n(!o2.isHidden && o2.options.animation), a2 = o2.followPointer || (o2.len || 0) > 1, l2 = { x: t3, y: e3 };
            a2 || (l2.anchorX = i3, l2.anchorY = s2), r2.step = () => o2.drawTracker(), o2.getLabel().animate(l2, r2);
          }
          refresh(t3, e3) {
            let { chart: i3, options: s2, pointer: o2, shared: a2 } = this, n2 = A(t3), h2 = n2[0], d2 = [], c2 = s2.format, p2 = s2.formatter || this.defaultFormatter, u2 = i3.styledMode, f2 = {}, m2 = this.allowShared;
            if (!s2.enabled || !h2.series) return;
            r.clearTimeout(this.hideTimer), this.allowShared = !(!b(t3) && t3.series && t3.series.noSharedTooltip), m2 = m2 && !this.allowShared, this.followPointer = !this.split && h2.series.tooltipOptions.followPointer;
            let x2 = this.getAnchor(t3, e3), v2 = x2[0], k2 = x2[1];
            a2 && this.allowShared ? (o2.applyInactiveState(n2), n2.forEach(function(t4) {
              t4.setState("hover"), d2.push(t4.getLabelConfig());
            }), (f2 = h2.getLabelConfig()).points = d2) : f2 = h2.getLabelConfig(), this.len = d2.length;
            let C2 = S(c2) ? l(c2, f2, i3) : p2.call(f2, this), w2 = h2.series;
            if (this.distance = M(w2.tooltipOptions.distance, 16), false === C2) this.hide();
            else {
              if (this.split && this.allowShared) this.renderSplit(C2, n2);
              else {
                let t4 = v2, r2 = k2;
                if (e3 && o2.isDirectTouch && (t4 = e3.chartX - i3.plotLeft, r2 = e3.chartY - i3.plotTop), i3.polar || false === w2.options.clip || n2.some((e4) => o2.isDirectTouch || e4.series.shouldShowTooltip(t4, r2))) {
                  let t5 = this.getLabel(m2 && this.tt || {});
                  (!s2.style.width || u2) && t5.css({ width: (this.outside ? this.getPlayingField() : i3.spacingBox).width + "px" }), t5.attr({ class: this.getClassName(h2), text: C2 && C2.join ? C2.join("") : C2 }), this.outside && t5.attr({ x: g(t5.x || 0, 0, this.getPlayingField().width - (t5.width || 0)) }), u2 || t5.attr({ stroke: s2.borderColor || h2.color || w2.color || "#666666" }), this.updatePosition({ plotX: v2, plotY: k2, negative: h2.negative, ttBelow: h2.ttBelow, h: x2[2] || 0 });
                } else {
                  this.hide();
                  return;
                }
          ...
          renderSplit(t3, e3) {
            var _a;
            let i3 = this, { chart: s2, chart: { chartWidth: o2, chartHeight: r2, plotHeight: a2, plotLeft: n2, plotTop: l2, scrollablePixelsY: h2 = 0, scrollablePixelsX: u2, styledMode: f2 }, distance: m2, options: y2, options: { positioner: b2 }, pointer: v2 } = i3, { scrollLeft: k2 = 0, scrollTop: C2 = 0 } = ((_a = s2.scrollablePlotArea) == null ? void 0 : _a.scrollingContainer) || {}, A2 = i3.outside && "number" != typeof u2 ? d.documentElement.getBoundingClientRect() : { left: k2, right: k2 + o2, top: C2, bottom: C2 + r2 }, w2 = i3.getLabel(), T2 = this.renderer || s2.renderer, P = !!(s2.xAxis[0] && s2.xAxis[0].opposite), { left: O, top: L } = v2.getChartPosition(), D = l2 + C2, E = 0, B = a2 - h2;
            function j(t4, e4, s3, o3, r3 = true) {
              let a3, n3;
              return s3 ? (a3 = P ? 0 : B, n3 = g(t4 - o3 / 2, A2.left, A2.right - o3 - (i3.outside ? O : 0))) : (a3 = e4 - D, n3 = g(n3 = r3 ? t4 - o3 - m2 : t4 + m2, r3 ? n3 : A2.left, A2.right)), { x: n3, y: a3 };
            }
            S(t3) && (t3 = [false, t3]);
            let R = t3.slice(0, e3.length + 1).reduce(function(t4, s3, o3) {
              if (false !== s3 && "" !== s3) {
                let r3 = e3[o3 - 1] || { isHeader: true, plotX: e3[0].plotX, plotY: a2, series: {} }, h3 = r3.isHeader, d2 = h3 ? i3 : r3.series, c2 = d2.tt = function(t5, e4, s4) {
                  let o4 = t5, { isHeader: r4, series: a3 } = e4;
                  if (!o4) {
                    let t6 = { padding: y2.padding, r: y2.borderRadius };
                    f2 || (t6.fill = y2.backgroundColor, t6["stroke-width"] = y2.borderWidth ?? 1), o4 = T2.label("", 0, 0, y2[r4 ? "headerShape" : "shape"], void 0, void 0, y2.useHTML).addClass(i3.getClassName(e4, true, r4)).attr(t6).add(w2);
                  }
                  return o4.isActive = true, o4.attr({ text: s4 }), f2 || o4.css(y2.style).attr({ stroke: y2.borderColor || e4.color || a3.color || "#333333" }), o4;
                }(d2.tt, r3, s3.toString()), p2 = c2.getBBox(), u3 = p2.width + c2.strokeWidth();
                h3 && (E = p2.height, B += E, P && (D -= E));
                let { anchorX: x2, anchorY: v3 } = function(t5) {
                  let e4, i4;
                  let { isHeader: s4, plotX: o4 = 0, plotY: r4 = 0, series: h4 } = t5;
                  if (s4) e4 = Math.max(n2 + o4, n2), i4 = l2 + a2 / 2;
                  else {
                    let { xAxis: t6, yAxis: s5 } = h4;
                    e4 = t6.pos + g(o4, -m2, t6.len + m2), h4.shouldShowTooltip(0, s5.pos - l2 + r4, { ignoreX: true }) && (i4 = s5.pos + r4);
                  }
                  return { anchorX: e4 = g(e4, A2.left - m2, A2.right + m2), anchorY: i4 };
                }(r3);
                if ("number" == typeof v3) {
                  let e4 = p2.height + 1, s4 = b2 ? b2.call(i3, u3, e4, r3) : j(x2, v3, h3, u3);
                  t4.push({ align: b2 ? 0 : void 0, anchorX: x2, anchorY: v3, boxWidth: u3, point: r3, rank: M(s4.rank, h3 ? 1 : 0), size: e4, target: s4.y, tt: c2, x: s4.x });
                } else c2.isActive = false;
              }
              return t4;
            }, []);
            !b2 && R.some((t4) => {
              let { outside: e4 } = i3, s3 = (e4 ? O : 0) + t4.anchorX;
              return s3 < A2.left && s3 + t4.boxWidth < A2.right || s3 < O - A2.left + t4.boxWidth && A2.right - s3 > s3;
            }) && (R = R.map((t4) => {
            ...
            R.forEach(function(t4) {
              ...
              !o3 && (i3.outside && O + e4 < I.left && (I.left = O + e4), !o3 && i3.outside && I.left + s3 > I.right && (I.right = O + e4));
            }), R.forEach(function(t4) {
              ...
              if (i3.outside && e4 < s3) {
                let t5 = O - I.left;
                t5 > 0 && (a3 || (n3.x = e4 + t5, n3.anchorX = s3 + t5), a3 && (n3.x = (I.right - I.left) / 2, n3.anchorX = s3 + t5));
              }
              t4.tt.attr(n3);
            });
            let { container: z, outside: G, renderer: N } = i3;
            if (G && z && N) {
              let { width: t4, height: e4, x: i4, y: s3 } = w2.getBBox();
              N.setSize(t4 + i4, e4 + s3, false), z.style.left = I.left + "px", z.style.top = L + "px";
            }
            c && w2.attr({ opacity: 1 === w2.opacity ? 0.999 : 1 });
          }
          drawTracker() {
          ...
          tooltipFooterHeaderFormatter(t3, e3) {
            let i3 = t3.series, s2 = i3.tooltipOptions, o2 = i3.xAxis, r2 = o2 && o2.dateTime, a2 = { isFooter: e3, labelConfig: t3 }, n2 = s2.xDateFormat, h2 = s2[e3 ? "footerFormat" : "headerFormat"];
            return y(this, "headerFormatter", a2, function(e4) {
              r2 && !n2 && v(t3.key) && (n2 = r2.getXDateFormat(t3.key, s2.dateTimeLabelFormats)), r2 && n2 && (t3.point && t3.point.tooltipDateKeys || ["key"]).forEach(function(t4) {
                h2 = h2.replace("{point." + t4 + "}", "{point." + t4 + ":" + n2 + "}");
              }), i3.chart.styledMode && (h2 = this.styledModeFormat(h2)), e4.text = l(h2, { point: t3, series: i3 }, this.chart);
            }), a2.text;
          }
          update(t3) {
          ...
          updatePosition(t3) {
            let { chart: e3, container: i3, distance: s2, options: o2, pointer: r2, renderer: a2 } = this, { height: n2 = 0, width: l2 = 0 } = this.getLabel(), { left: h2, top: d2, scaleX: c2, scaleY: p2 } = r2.getChartPosition(), u2 = (o2.positioner || this.getPosition).call(this, l2, n2, t3), g2 = (t3.plotX || 0) + e3.plotLeft, m2 = (t3.plotY || 0) + e3.plotTop, x2;
            a2 && i3 && (o2.positioner && (u2.x += h2 - s2, u2.y += d2 - s2), x2 = (o2.borderWidth || 0) + 2 * s2 + 2, a2.setSize(l2 + x2, n2 + x2, false), (1 !== c2 || 1 !== p2) && (f(i3, { transform: `scale(${c2}, ${p2})` }), g2 *= c2, m2 *= p2), g2 += h2 - u2.x, m2 += d2 - u2.y), this.move(Math.round(u2.x), Math.round(u2.y || 0), g2, m2);
          }
        }
        return (a = T || (T = {})).compose = function(t3) {
          C(h, "Core.Tooltip") && u(t3, "afterInit", function() {
            let t4 = this.chart;
            t4.options.tooltip && (t4.tooltip = new a(t4, t4.options.tooltip, this));
          });
        }, T;
        ...
        let { animObject: r } = e2, { defaultOptions: a } = i2, { format: n } = s, { addEvent: l, crisp: h, erase: d, extend: c, fireEvent: p, getNestedProperty: u, isArray: g, isFunction: f, isNumber: m, isObject: x, merge: y, pick: b, syncTimeout: v, removeEvent: S, uniqueKey: k } = o;
        class M {
          ...
          applyOptions(t3, e3) {
            ...
            return c(this, t3 = M.prototype.optionsToObject.call(this, t3)), this.options = this.options ? c(this.options, t3) : t3, t3.group && delete this.group, t3.dataLabels && delete this.dataLabels, s2 && (this.y = M.prototype.getNestedProperty.call(this, s2)), this.selected && (this.state = "select"), "name" in this && void 0 === e3 && i3.xAxis && i3.xAxis.hasNames && (this.x = i3.xAxis.nameToX(this)), void 0 === this.x && i3 ? this.x = e3 ?? i3.autoIncrement() : m(t3.x) && i3.options.relativeXValue && (this.x = i3.autoIncrement(t3.x)), this.isNull = this.isValid && !this.isValid(), this.formatPrefix = this.isNull ? "null" : "point", this;
          }
          destroy() {
            if (!this.destroyed) {
              ...
              t3.legendItem && i3.legend.destroyItem(t3), o2 && (t3.setState(), d(o2, t3), o2.length || (i3.hoverPoints = null)), t3 === i3.hoverPoint && t3.onMouseOut(), s2 && s2.enabled ? (this.animateBeforeDestroy(), v(n2, a2.duration)) : n2(), i3.pointCount--;
            }
            this.destroyed = true;
          }
          destroyElements(t3) {
          ...
          getGraphicalProps(t3) {
            ...
            for ((t3 = t3 || { graphic: 1, dataLabel: 1 }).graphic && o2.push("graphic", "connector"), t3.dataLabel && o2.push("dataLabel", "dataLabelPath", "dataLabelUpper"), i3 = o2.length; i3--; ) s2[e3 = o2[i3]] && r2.singular.push(e3);
          ...
          optionsToObject(t3) {
            ...
            else if (g(t3)) for (!i3 && t3.length > o2 && ("string" == (a2 = typeof t3[0]) ? r2.name = t3[0] : "number" === a2 && (r2.x = t3[0]), n2++); l2 < o2; ) i3 && void 0 === t3[n2] || (s2[l2].indexOf(".") > 0 ? M.prototype.setNestedProperty(r2, t3[n2], s2[l2]) : r2[s2[l2]] = t3[n2]), n2++, l2++;
          ...
          update(t3, e3, i3, s2) {
            ...
            function d2() {
              ...
              n2 && d3 && (r2.graphic = n2.destroy(), delete r2.hasMockGraphic), x(t3, true) && (n2 && n2.element && t3 && t3.marker && void 0 !== t3.marker.symbol && (r2.graphic = n2.destroy()), (t3 == null ? void 0 : t3.dataLabels) && r2.dataLabel && (r2.dataLabel = r2.dataLabel.destroy())), o2 = r2.index, a2.updateParallelArrays(r2, o2), h2.data[o2] = x(h2.data[o2], true) || x(t3, true) ? r2.options : b(t3, h2.data[o2]), a2.isDirty = a2.isDirtyData = true, !a2.fixedBox && a2.hasCartesianSeries && (l2.isDirtyBox = true), "point" === h2.legendType && (l2.isDirtyLegend = true), e3 && l2.redraw(i3);
            }
            e3 = b(e3, true), false === s2 ? d2() : r2.firePointEvent("update", { options: t3 }, d2);
          }
          remove(t3, e3) {
          ...
          manageEvent(t3) {
            ...
            f(i3) && (!((_b = this.hcEvents) == null ? void 0 : _b[t3]) || ((_d = (_c = this.hcEvents) == null ? void 0 : _c[t3]) == null ? void 0 : _d.map((t4) => t4.fn).indexOf(i3)) === -1) ? ((_e = this.importedUserEvent) == null ? void 0 : _e.call(this), this.importedUserEvent = l(this, t3, i3)) : this.importedUserEvent && !i3 && ((_f = this.hcEvents) == null ? void 0 : _f[t3]) && (S(this, t3), delete this.hcEvents[t3], Object.keys(this.hcEvents) || delete this.importedUserEvent);
          }
          setState(e3, i3) {
            var _a;
            let s2 = this.series, o2 = this.state, r2 = s2.options.states[e3 || "normal"] || {}, n2 = a.plotOptions[s2.type].marker && s2.options.marker, l2 = n2 && false === n2.enabled, h2 = n2 && n2.states && n2.states[e3 || "normal"] || {}, d2 = false === h2.enabled, u2 = this.marker || {}, g2 = s2.chart, f2 = n2 && s2.markerAttribs, x2 = s2.halo, y2, v2, S2, k2 = s2.stateMarkerGraphic, M2;
            ...
            if (this.state = e3, f2 && (y2 = s2.markerAttribs(this, e3)), this.graphic && !this.hasMockGraphic) {
              if (o2 && this.graphic.removeClass("highcharts-point-" + o2), e3 && this.graphic.addClass("highcharts-point-" + e3), !g2.styledMode) {
                v2 = s2.pointAttribs(this, e3), S2 = b(g2.options.chart.animation, r2.animation);
                let t3 = v2.opacity;
              ...
              y2 && this.graphic.animate(y2, b(g2.options.chart.animation, h2.animation, n2.animation)), k2 && k2.hide();
            } else e3 && h2 && (M2 = u2.symbol || s2.symbol, k2 && k2.currentSymbol !== M2 && (k2 = k2.destroy()), y2 && (k2 ? k2[i3 ? "animate" : "attr"]({ x: y2.x, y: y2.y }) : M2 && (s2.stateMarkerGraphic = k2 = g2.renderer.symbol(M2, y2.x, y2.y, y2.width, y2.height).add(s2.markerGroup), k2.currentSymbol = M2)), !g2.styledMode && k2 && "inactive" !== this.state && k2.attr(s2.pointAttribs(this, e3))), k2 && (k2[e3 && this.isInside ? "show" : "hide"](), k2.element.point = this, k2.addClass(this.getClassName(), true));
            let C = r2.halo, A = this.graphic || k2, w = A && A.visibility || "inherit";
            C && C.size && A && "hidden" !== w && !this.isCluster ? (x2 || (s2.halo = x2 = g2.renderer.path().add(A.parentGroup)), x2.show()[i3 ? "animate" : "attr"]({ d: this.haloPath(C.size) }), x2.attr({ class: "highcharts-halo highcharts-color-" + b(this.colorIndex, s2.colorIndex) + (this.className ? " " + this.className : ""), visibility: w, zIndex: -1 }), x2.point = this, g2.styledMode || x2.attr(c({ fill: this.color || s2.color, "fill-opacity": C.opacity }, t2.filterUserAttributes(C.attributes || {})))) : ((_a = x2 == null ? void 0 : x2.point) == null ? void 0 : _a.haloPath) && !x2.point.destroyed && x2.animate({ d: x2.point.haloPath(0) }, null, x2.hide), p(this, "afterSetState", { state: e3 });
          }
          haloPath(t3) {
            let e3 = this.pos();
        ...
        var s;
        let { parse: o } = t2, { charts: r, composed: a, isTouchDevice: n } = e2, { addEvent: l, attr: h, css: d, extend: c, find: p, fireEvent: u, isNumber: g, isObject: f, objectEach: m, offset: x, pick: y, pushUnique: b, splat: v } = i2;
        class S {
          ...
          drag(t3) {
            let { chart: e3 } = this, { mouseDownX: i3 = 0, mouseDownY: s2 = 0 } = e3, { panning: r2, panKey: a2, selectionMarkerFill: n2 } = e3.options.chart, l2 = e3.plotLeft, h2 = e3.plotTop, d2 = e3.plotWidth, c2 = e3.plotHeight, p2 = f(r2) ? r2.enabled : r2, u2 = a2 && t3[`${a2}Key`], g2 = t3.chartX, m2 = t3.chartY, x2, y2 = this.selectionMarker;
          ...
          findNearestKDPoint(t3, e3, i3) {
            ...
            return t3.forEach(function(t4) {
              ...
              f(r2, true) && r2.series && (!f(s2, true) || function(t5, i4) {
                var _a, _b;
                let s3 = t5.distX - i4.distX, o3 = t5.dist - i4.dist, r3 = ((_a = i4.series.group) == null ? void 0 : _a.zIndex) - ((_b = t5.series.group) == null ? void 0 : _b.zIndex);
          ...
          getChartCoordinatesFromPoint(t3, e3) {
            ...
            if (i3 && s2) {
              ...
              return t3.isNode && o2 && g(o2.x) && g(o2.y) && (r2 = o2.x, a2 = o2.y), e3 ? { chartX: s2.len + s2.pos - a2, chartY: i3.len + i3.pos - r2 } : { chartX: r2 + i3.pos, chartY: a2 + s2.pos };
            }
            if (o2 && o2.x && o2.y) return { chartX: o2.x, chartY: o2.y };
          }
          getChartPosition() {
          ...
          getHoverData(t3, e3, i3, s2, o2, r2) {
            ...
            u(this, "beforeGetHoverData", d2), h2 = l2 && !l2.stickyTracking ? [l2] : i3.filter((t4) => t4.stickyTracking && (d2.filter || n2)(t4));
            ...
            }) : a2.push(c2)), u(this, "afterGetHoverData", d2 = { hoverPoint: c2 }), { hoverPoint: d2.hoverPoint, hoverSeries: l2, hoverPoints: a2 };
          }
          ...
          normalize(t3, e3) {
            ...
            return c(t3, { chartX: Math.round(o2 /= e3.scaleX), chartY: Math.round(r2 /= e3.scaleY) });
          }
          onContainerClick(t3) {
            let e3 = this.chart, i3 = e3.hoverPoint, s2 = this.normalize(t3), o2 = e3.plotLeft, r2 = e3.plotTop;
            !e3.cancelClick && (i3 && this.inClass(s2.target, "highcharts-tracker") ? (u(i3.series, "click", c(s2, { point: i3 })), e3.hoverPoint && i3.firePointEvent("click", s2)) : (c(s2, this.getCoordinates(s2)), e3.isInsidePlot(s2.chartX - o2, s2.chartY - r2, { visiblePlotOnly: true }) && u(e3, "click", s2)));
          }
          ...
          onContainerMouseLeave(t3) {
            let { pointer: e3 } = r[y(S.hoverChartIndex, -1)] || {};
          ...
          onDocumentMouseMove(t3) {
            ...
            !s2 || e3.isInsidePlot(o2.chartX - e3.plotLeft, o2.chartY - e3.plotTop, { visiblePlotOnly: true }) || i3 && i3.shouldStickOnContact(o2) || o2.target !== e3.container.ownerDocument && this.inClass(o2.target, "highcharts-tracker") || this.reset();
          }
          onDocumentMouseUp(t3) {
            var _a, _b;
            (_b = (_a = r[y(S.hoverChartIndex, -1)]) == null ? void 0 : _a.pointer) == null ? void 0 : _b.drop(t3);
          }
          pinch(t3) {
            let e3 = this, { chart: i3, hasZoom: s2, lastTouches: o2 } = e3, r2 = [].map.call(t3.touches || [], (t4) => e3.normalize(t4)), a2 = r2.length, n2 = 1 === a2 && (e3.inClass(t3.target, "highcharts-tracker") && i3.runTrackerClick || e3.runChartClick), l2 = i3.tooltip, h2 = 1 === a2 && y(l2 == null ? void 0 : l2.options.followTouchMove, true);
            a2 > 1 ? e3.initiated = true : h2 && (e3.initiated = false), s2 && e3.initiated && !n2 && false !== t3.cancelable && t3.preventDefault(), "touchstart" === t3.type ? (e3.pinchDown = r2, e3.res = true, i3.mouseDownX = t3.chartX) : h2 ? this.runPointActions(e3.normalize(t3)) : o2 && (u(i3, "touchpan", { originalEvent: t3, touches: r2 }, () => {
              let e4 = (t4) => {
          ...
          reset(t3, e3) {
            ...
            }), t3 ? a2 && n2 && v(n2).length && (a2.refresh(n2), a2.shared && r2 ? r2.forEach(function(t4) {
          ...
          runPointActions(t3, e3, i3) {
            let s2 = this.chart, o2 = s2.series, a2 = s2.tooltip && s2.tooltip.options.enabled ? s2.tooltip : void 0, n2 = !!a2 && a2.shared, h2 = e3 || s2.hoverPoint, d2 = h2 && h2.series || s2.hoverSeries, c2 = (!t3 || "touchmove" !== t3.type) && (!!e3 || d2 && d2.directTouch && this.isDirectTouch), u2 = this.getHoverData(h2, d2, o2, c2, n2, t3);
            ...
            this.unDocMouseMove || (this.unDocMouseMove = l(s2.container.ownerDocument, "mousemove", (t4) => {
              var _a, _b;
              return (_b = (_a = r[S.hoverChartIndex ?? -1]) == null ? void 0 : _a.pointer) == null ? void 0 : _b.onDocumentMouseMove(t4);
          ...
          setDOMEvents() {
            ...
            t3.onmousedown = this.onContainerMouseDown.bind(this), t3.onmousemove = this.onContainerMouseMove.bind(this), t3.onclick = this.onContainerClick.bind(this), this.eventsToUnbind.push(l(t3, "mouseenter", this.onContainerMouseEnter.bind(this)), l(t3, "mouseleave", this.onContainerMouseLeave.bind(this))), S.unbindDocumentMouseUp || (S.unbindDocumentMouseUp = []), S.unbindDocumentMouseUp.push(l(e3, "mouseup", this.onDocumentMouseUp.bind(this)));
            let i3 = this.chart.renderTo.parentElement;
            for (; i3 && "BODY" !== i3.tagName; ) this.eventsToUnbind.push(l(i3, "scroll", () => {
              delete this.chartPosition;
            })), i3 = i3.parentElement;
            this.eventsToUnbind.push(l(t3, "touchstart", this.onContainerTouchStart.bind(this), { passive: false }), l(t3, "touchmove", this.onContainerTouchMove.bind(this), { passive: false })), S.unbindDocumentTouchEnd || (S.unbindDocumentTouchEnd = l(e3, "touchend", this.onDocumentTouchEnd.bind(this), { passive: false })), this.setPointerCapture(), l(this.chart, "redraw", this.setPointerCapture.bind(this));
          }
          setPointerCapture() {
            var _a, _b;
            if (!n) return;
          ...
          touch(t3, e3) {
            ...
            this.setHoverChartIndex(), 1 === (t3 = this.normalize(t3)).touches.length ? s2.isInsidePlot(t3.chartX - s2.plotLeft, t3.chartY - s2.plotTop, { visiblePlotOnly: true }) && !s2.openMenu ? (e3 && this.runPointActions(t3), "touchmove" === t3.type && (i3 = !!o2[0] && Math.pow(o2[0].chartX - t3.chartX, 2) + Math.pow(o2[0].chartY - t3.chartY, 2) >= 16), y(i3, true) && this.pinch(t3)) : e3 && this.reset() : 2 === t3.touches.length && this.pinch(t3);
          }
          touchSelect(t3) {
        ...
        return (s = S || (S = {})).compose = function(t3) {
          b(a, "Core.Pointer") && l(t3, "beforeRender", function() {
        ...
        return function(t3) {
          function e3(t4, e4, r) {
            var _a, _b;
            let a = this.legendItem = this.legendItem || {}, { chart: n, options: l } = this, { baseline: h = 0, symbolWidth: d, symbolHeight: c } = t4, p = this.symbol || "circle", u = c / 2, g = n.renderer, f = a.group, m = h - Math.round((((_a = t4.fontMetrics) == null ? void 0 : _a.b) || c) * (r ? 0.4 : 0.3)), x = {}, y, b = l.marker, v = 0;
            if (n.styledMode || (x["stroke-width"] = Math.min(l.lineWidth || 0, 24), l.dashStyle ? x.dashstyle = l.dashStyle : "square" === l.linecap || (x["stroke-linecap"] = "round")), a.line = g.path().addClass("highcharts-graph").attr(x).add(f), r && (a.area = g.path().addClass("highcharts-area").add(f)), x["stroke-linecap"] && (v = Math.min(a.line.strokeWidth(), d) / 2), d) {
              ...
              a.line.attr({ d: t5 }), (_b = a.area) == null ? void 0 : _b.attr({ d: [...t5, ["L", d - v, h], ["L", v, h]] });
            }
        ...
        let { animObject: d, setAnimation: c } = t2, { defaultOptions: p } = e2, { registerEventOptions: u } = i2, { svg: g, win: f } = s, { seriesTypes: m } = n, { arrayMax: x, arrayMin: y, clamp: b, correctFloat: v, crisp: S, defined: k, destroyObjectProperties: M, diffObjects: C, erase: A, error: w, extend: T, find: P, fireEvent: O, getClosestDistance: L, getNestedProperty: D, insertItem: E, isArray: B, isNumber: j, isString: R, merge: I, objectEach: z, pick: G, removeEvent: N, splat: W, syncTimeout: H } = h;
        class X {
          constructor() {
            this.zoneAxis = "y";
          }
          init(t3, e3) {
            ...
            s2.linkedSeries = [], s2.bindAxes(), T(s2, { name: r2.name, state: "", visible: a2, selected: true === r2.selected }), u(this, r2);
            let n2 = r2.events;
            ...
            }), s2.isCartesian && (t3.hasCartesianSeries = true), o2.length && (i3 = o2[o2.length - 1]), s2._i = G(i3 && i3._i, -1) + 1, s2.opacity = s2.options.opacity, t3.orderItems("series", E(this, o2)), r2.dataSorting && r2.dataSorting.enabled ? s2.setDataSortingOptions() : s2.points || s2.data || s2.setData(r2.data, false), O(this, "afterInit");
          }
          is(t3) {
            ...
            O(this, "bindAxes", null, function() {
              (e3.axisTypes || []).forEach(function(o2) {
                (s2[o2] || []).forEach(function(s3) {
                  t3 = s3.options, (G(i3[o2], 0) === s3.index || void 0 !== i3[o2] && i3[o2] === t3.id) && (E(e3, s3.series), e3[o2] = s3, s3.isDirty = true);
                }), e3[o2] || e3.optionalAxis === o2 || w(18, true, s2);
              });
            }), O(this, "afterBindAxes");
          }
          updateParallelArrays(t3, e3, i3) {
            let s2 = t3.series, o2 = j(e3) ? function(i4) {
          ...
          setOptions(t3) {
            ...
            this.tooltipOptions = I(p.tooltip, (_a = p.plotOptions.series) == null ? void 0 : _a.tooltip, c2 == null ? void 0 : c2.tooltip, i3.userOptions.tooltip, (_b = h2.series) == null ? void 0 : _b.tooltip, u2.tooltip, r2.tooltip), this.stickyTracking = G(r2.stickyTracking, u2.stickyTracking, d2.stickyTracking, !!this.tooltipOptions.shared && !this.noSharedTooltip || g2.stickyTracking), null === l2.marker && delete g2.marker, this.zoneAxis = g2.zoneAxis || "y";
          ...
          getCyclic(t3, e3, i3) {
            let s2, o2;
            let r2 = this.chart, a2 = `${t3}Index`, n2 = `${t3}Counter`, l2 = (i3 == null ? void 0 : i3.length) || r2.options.chart.colorCount;
            !e3 && (k(o2 = G("color" === t3 ? this.options.colorIndex : void 0, this[a2])) ? s2 = o2 : (r2.series.length || (r2[n2] = 0), s2 = r2[n2] % l2, r2[n2] += 1), i3 && (e3 = i3[s2])), void 0 !== s2 && (this[a2] = s2), this[t3] = e3;
          }
          getColor() {
          ...
          findPointIndex(t3, e3) {
            ...
            return i3 && void 0 !== (o2 = i3 && i3.index) && (s2 = true), void 0 === o2 && j(n2) && (o2 = this.xData.indexOf(n2, e3)), -1 !== o2 && void 0 !== o2 && this.cropped && (o2 = o2 >= this.cropStart ? o2 - this.cropStart : o2), !s2 && j(o2) && l2[o2] && l2[o2].touched && (o2 = void 0), o2;
          }
          updateData(t3, e3) {
            ...
            if (this.xIncrement = null, t3.forEach(function(t4, e4) {
              let h3;
              let d3 = k(t4) && this.pointClass.prototype.optionsToObject.call({ series: this }, t4) || {}, p3 = d3.x;
              d3.id || j(p3) ? (-1 === (h3 = this.findPointIndex(d3, c2)) || void 0 === h3 ? r2.push(t4) : o2[h3] && t4 !== i3.data[h3] ? (o2[h3].update(t4, false, null, false), o2[h3].touched = true, a2 && (c2 = h3 + 1)) : o2[h3] && (o2[h3].touched = true), (!n2 || e4 !== h3 || s2 && s2.enabled || this.hasDerivedData) && (l2 = true)) : r2.push(t4);
            }, this), l2) for (h2 = o2.length; h2--; ) (d2 = o2[h2]) && !d2.touched && d2.remove && d2.remove(false, e3);
            else !n2 || s2 && s2.enabled ? p2 = false : (t3.forEach(function(t4, e4) {
          ...
          setData(t3, e3 = true, i3, s2) {
            var _a;
            let o2 = this, r2 = o2.points, a2 = r2 && r2.length || 0, n2 = o2.options, l2 = o2.chart, h2 = n2.dataSorting, d2 = o2.xAxis, c2 = n2.turboThreshold, p2 = this.xData, u2 = this.yData, g2 = o2.pointArrayMap, f2 = g2 && g2.length, m2 = n2.keys, x2, y2, b2, v2 = 0, S2 = 1, k2;
            ...
            let M2 = (t3 = k2 || t3 || []).length;
            if (h2 && h2.enabled && (t3 = this.sortData(t3)), l2.options.chart.allowMutatingData && false !== s2 && M2 && a2 && !o2.cropped && !o2.hasGroupedData && o2.visible && !o2.boosted && (b2 = this.updateData(t3, i3)), !b2) {
              o2.xIncrement = null, o2.colorCounter = 0, this.parallelArrays.forEach(function(t4) {
                o2[t4 + "Data"].length = 0;
              });
              let e4 = c2 && M2 > c2;
              if (e4) {
                let i4 = o2.getFirstValidPoint(t3), s3 = o2.getFirstValidPoint(t3, M2 - 1, -1), r3 = (t4) => !!(B(t4) && (m2 || j(t4[0])));
                if (j(i4) && j(s3)) for (x2 = 0; x2 < M2; x2++) p2[x2] = this.autoIncrement(), u2[x2] = t3[x2];
                else if (r3(i4) && r3(s3)) {
                  if (f2) {
                    if (i4.length === f2) for (x2 = 0; x2 < M2; x2++) p2[x2] = this.autoIncrement(), u2[x2] = t3[x2];
                    else for (x2 = 0; x2 < M2; x2++) y2 = t3[x2], p2[x2] = y2[0], u2[x2] = y2.slice(1, f2 + 1);
                  } else if (m2 && (v2 = m2.indexOf("x"), S2 = m2.indexOf("y"), v2 = v2 >= 0 ? v2 : 0, S2 = S2 >= 0 ? S2 : 1), 1 === i4.length && (S2 = 0), v2 === S2) for (x2 = 0; x2 < M2; x2++) p2[x2] = this.autoIncrement(), u2[x2] = t3[x2][S2];
                  else for (x2 = 0; x2 < M2; x2++) y2 = t3[x2], p2[x2] = y2[v2], u2[x2] = y2[S2];
                } else e4 = false;
              }
              if (!e4) for (x2 = 0; x2 < M2; x2++) y2 = { series: o2 }, o2.pointClass.prototype.applyOptions.apply(y2, [t3[x2]]), o2.updateParallelArrays(y2, x2);
              for (u2 && R(u2[0]) && w(14, true, l2), o2.data = [], o2.options.data = o2.userOptions.data = t3, x2 = a2; x2--; ) (_a = r2[x2]) == null ? void 0 : _a.destroy();
          ...
          sortData(t3) {
            let e3 = this, i3 = e3.options.dataSorting.sortKey || "y", s2 = function(t4, e4) {
              return k(e4) && t4.pointClass.prototype.optionsToObject.call({ series: t4 }, e4) || {};
            };
            return t3.forEach(function(i4, o2) {
              t3[o2] = s2(e3, i4), t3[o2].index = o2;
            }, this), t3.concat().sort((t4, e4) => {
              let s3 = D(i3, t4), o2 = D(i3, e4);
          ...
          getProcessedData(t3) {
            let e3 = this, i3 = e3.xAxis, s2 = e3.options.cropThreshold, o2 = i3 == null ? void 0 : i3.logarithmic, r2 = e3.isCartesian, a2, n2, l2 = 0, h2, d2, c2, p2 = e3.xData, u2 = e3.yData, g2 = false, f2 = p2.length;
            i3 && (d2 = (h2 = i3.getExtremes()).min, c2 = h2.max, g2 = !!(i3.categories && !i3.names.length)), r2 && e3.sorted && !t3 && (!s2 || f2 > s2 || e3.forceCrop) && (p2[f2 - 1] < d2 || p2[0] > c2 ? (p2 = [], u2 = []) : e3.yData && (p2[0] < d2 || p2[f2 - 1] > c2) && (p2 = (a2 = this.cropData(e3.xData, e3.yData, d2, c2)).xData, u2 = a2.yData, l2 = a2.start, n2 = true));
            let m2 = L([o2 ? p2.map(o2.log2lin) : p2], () => e3.requireSorting && !g2 && w(15, false, e3.chart));
            return { xData: p2, yData: u2, cropped: n2, cropStart: l2, closestPointRange: m2 };
          }
          processData(t3) {
            let e3 = this.xAxis;
          ...
          cropData(t3, e3, i3, s2) {
            ...
            for (a2 = r2; a2 < o2; a2++) if (t3[a2] > s2) {
              l2 = a2 + 1;
              break;
            }
          ...
          generatePoints() {
            ...
            for (l2 && n2 && (this.options.keys = false), g2 = 0; g2 < r2; g2++) p2 = a2 + g2, n2 ? ((u2 = new o2(this, [i3[g2]].concat(W(s2[g2])))).dataGroup = this.groupMap[d2 + g2], u2.dataGroup.options && (u2.options = u2.dataGroup.options, T(u2, u2.dataGroup.options), delete u2.dataLabels)) : (u2 = f2[p2]) || void 0 === e3[p2] || (f2[p2] = u2 = new o2(this, e3[p2], i3[g2])), u2 && (u2.index = n2 ? d2 + g2 : p2, h2[g2] = u2);
            if (this.options.keys = l2, f2 && (r2 !== (c2 = f2.length) || n2)) for (g2 = 0; g2 < c2; g2++) g2 !== a2 || n2 || (g2 += r2), f2[g2] && (f2[g2].destroyElements(), f2[g2].plotX = void 0);
          ...
          getExtremes(t3, e3) {
            let i3 = this.xAxis, s2 = this.yAxis, o2 = [], r2 = this.requireSorting && !this.is("column") ? 1 : 0, a2 = !!s2 && s2.positiveValuesOnly, n2 = e3 || this.getExtremesFromAll || this.options.getExtremesFromAll, { processedXData: l2, processedYData: h2 } = this, d2, c2, p2, u2, g2, f2, m2, b2 = 0, v2 = 0, S2 = 0;
            if (this.cropped && n2) {
              let t4 = this.getProcessedData(true);
              l2 = t4.xData, h2 = t4.yData;
            }
            let k2 = (t3 = t3 || this.stackedYData || h2 || []).length, M2 = l2 || this.xData;
            for (i3 && (b2 = (d2 = i3.getExtremes()).min, v2 = d2.max), f2 = 0; f2 < k2; f2++) if (u2 = M2[f2], c2 = (j(g2 = t3[f2]) || B(g2)) && ((j(g2) ? g2 > 0 : g2.length) || !a2), p2 = e3 || this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || !i3 || (M2[f2 + r2] || u2) >= b2 && (M2[f2 - r2] || u2) <= v2, c2 && p2) {
              if (m2 = g2.length) for (; m2--; ) j(g2[m2]) && (o2[S2++] = g2[m2]);
              else o2[S2++] = g2;
            }
            let C2 = { activeYData: o2, dataMin: y(o2), dataMax: x(o2) };
            return O(this, "afterGetExtremes", { dataExtremes: C2 }), C2;
          }
          applyExtremes() {
          ...
          translate() {
            ...
            for (p2 = 0; p2 < n2; p2++) {
              let t4;
              let n3 = a2[p2], y2 = n3.x, b2, S2, M2 = n3.y, C2 = n3.low, A2 = e3 && ((_a = r2.stacking) == null ? void 0 : _a.stacks[(this.negStacks && M2 < (c2 ? 0 : d2) ? "-" : "") + this.stackKey]);
              u2 = i3.translate(y2, false, false, false, true, l2), n3.plotX = j(u2) ? v(x2(u2)) : void 0, e3 && this.visible && A2 && A2[y2] && (f2 = this.getStackIndicator(f2, y2, this.index), !n3.isNull && f2.key && (S2 = (b2 = A2[y2]).points[f2.key]), b2 && B(S2) && (C2 = S2[0], M2 = S2[1], C2 === c2 && f2.key === A2[y2].base && (C2 = G(j(d2) ? d2 : r2.min)), r2.positiveValuesOnly && k(C2) && C2 <= 0 && (C2 = void 0), n3.total = n3.stackTotal = G(b2.total), n3.percentage = k(n3.y) && b2.total ? n3.y / b2.total * 100 : void 0, n3.stackY = M2, this.irregularWidths || b2.setOffset(this.pointXOffset || 0, this.barW || 0, void 0, void 0, void 0, this.xAxis))), n3.yBottom = k(C2) ? x2(r2.translate(C2, false, true, false, true)) : void 0, this.dataModify && (M2 = this.dataModify.modifyValue(M2, p2)), j(M2) && void 0 !== n3.plotX && (t4 = j(t4 = r2.translate(M2, false, true, false, true)) ? x2(t4) : void 0), n3.plotY = t4, n3.isInside = this.isPointInside(n3), n3.clientX = h2 ? v(i3.translate(y2, false, false, false, true, l2)) : u2, n3.negative = (n3.y || 0) < (d2 || 0), n3.category = G(s2 && s2[n3.x], n3.x), n3.isNull || false === n3.visible || (void 0 !== g2 && (m2 = Math.min(m2, Math.abs(u2 - g2))), g2 = u2), n3.zone = this.zones.length ? n3.getZone() : void 0, !n3.graphic && this.group && o2 && (n3.isNew = true);
            }
          ...
          getValidPoints(t3, e3, i3) {
            ...
            return (t3 || this.points || []).filter(function(t4) {
              ...
              return !!((i3 || !t4.isNull && j(r2)) && (!e3 || s2.isInsidePlot(o2, r2, { inverted: s2.inverted }))) && false !== t4.visible;
            });
          }
          getClipBox() {
          ...
          animate(t3) {
            ...
            if (t3 && i3) {
              ...
              i3.clip(n2), s2 == null ? void 0 : s2.clip(l2);
            } else if (n2 && !n2.hasClass("highcharts-animating")) {
              let t4 = this.getClipBox(), i4 = r2.step;
              ((s2 == null ? void 0 : s2.element.childNodes.length) || e3.series.length > 1) && (r2.step = function(t5, e4) {
                i4 && i4.apply(e4, arguments), "width" === e4.prop && (l2 == null ? void 0 : l2.element) && l2.attr(o2 ? "height" : "width", t5 + 99);
          ...
          drawPoints(t3 = this.points) {
            ...
            let l2 = this.chart, h2 = l2.styledMode, { colorAxis: d2, options: c2 } = this, p2 = c2.marker, u2 = this[this.specialGroup || "markerGroup"], g2 = this.xAxis, f2 = G(p2.enabled, !g2 || !!g2.isRadial || null, this.closestPointRangePx >= p2.enabledThreshold * p2.radius);
            if (false !== p2.enabled || this._hasPointMarkers) for (e3 = 0; e3 < t3.length; e3++) if (o2 = (s2 = (i3 = t3[e3]).graphic) ? "animate" : "attr", r2 = i3.marker || {}, a2 = !!i3.marker, (f2 && void 0 === r2.enabled || r2.enabled) && !i3.isNull && false !== i3.visible) {
              let t4 = G(r2.symbol, this.symbol, "rect");
          ...
          markerAttribs(t3, e3) {
            let i3 = this.options, s2 = i3.marker, o2 = t3.marker || {}, r2 = o2.symbol || s2.symbol, a2 = {}, n2, l2, h2 = G(o2.radius, s2 && s2.radius);
            e3 && (n2 = s2.states[e3], h2 = G((l2 = o2.states && o2.states[e3]) && l2.radius, n2 && n2.radius, h2 && h2 + (n2 && n2.radiusPlus || 0))), t3.hasImage = r2 && 0 === r2.indexOf("url"), t3.hasImage && (h2 = 0);
            let d2 = t3.pos();
            return j(h2) && d2 && (i3.crisp && (d2[0] = S(d2[0], t3.hasImage ? 0 : "rect" === r2 ? (s2 == null ? void 0 : s2.lineWidth) || 0 : 1)), a2.x = d2[0] - h2, a2.y = d2[1] - h2), h2 && (a2.width = a2.height = 2 * h2), a2;
          }
          pointAttribs(t3, e3) {
            let i3 = this.options.marker, s2 = t3 && t3.options, o2 = s2 && s2.marker || {}, r2 = s2 && s2.color, a2 = t3 && t3.color, n2 = t3 && t3.zone && t3.zone.color, l2, h2, d2 = this.color, c2, p2, u2 = G(o2.lineWidth, i3.lineWidth), g2 = 1;
            return d2 = r2 || n2 || a2 || d2, c2 = o2.fillColor || i3.fillColor || d2, p2 = o2.lineColor || i3.lineColor || d2, e3 = e3 || "normal", l2 = i3.states[e3] || {}, u2 = G((h2 = o2.states && o2.states[e3] || {}).lineWidth, l2.lineWidth, u2 + G(h2.lineWidthPlus, l2.lineWidthPlus, 0)), c2 = h2.fillColor || l2.fillColor || c2, { stroke: p2 = h2.lineColor || l2.lineColor || p2, "stroke-width": u2, fill: c2, opacity: g2 = G(h2.opacity, l2.opacity, g2) };
          }
          destroy(t3) {
            let e3, i3, s2;
            let o2 = this, r2 = o2.chart, a2 = /AppleWebKit\/533/.test(f.navigator.userAgent), n2 = o2.data || [];
            for (O(o2, "destroy", { keepEventsForUpdate: t3 }), this.removeEvents(t3), (o2.axisTypes || []).forEach(function(t4) {
              (s2 = o2[t4]) && s2.series && (A(s2.series, o2), s2.isDirty = s2.forceRedraw = true);
            }), o2.legendItem && o2.chart.legend.destroyItem(o2), e3 = n2.length; e3--; ) (i3 = n2[e3]) && i3.destroy && i3.destroy();
            for (let t4 of o2.zones) M(t4, void 0, true);
            h.clearTimeout(o2.animationTimeout), z(o2, function(t4, e4) {
              t4 instanceof l && !t4.survive && t4[a2 && "group" === e4 ? "hide" : "destroy"]();
            }), r2.hoverSeries === o2 && (r2.hoverSeries = void 0), A(r2.series, o2), r2.orderItems("series"), z(o2, function(e4, i4) {
              t3 && "hcEvents" === i4 || delete o2[i4];
            });
          }
          applyZones() {
            let { area: t3, chart: e3, graph: i3, zones: s2, points: o2, xAxis: r2, yAxis: a2, zoneAxis: n2 } = this, { inverted: l2, renderer: h2 } = e3, d2 = this[`${n2}Axis`], { isXAxis: c2, len: p2 = 0 } = d2 || {}, u2 = ((i3 == null ? void 0 : i3.strokeWidth()) || 0) / 2 + 1, g2 = (t4, e4 = 0, i4 = 0) => {
              l2 && (i4 = p2 - i4);
              let { translated: s3 = 0, lineClip: o3 } = t4, r3 = i4 - s3;
              o3 == null ? void 0 : o3.push(["L", e4, Math.abs(r3) < u2 ? i4 - u2 * (r3 <= 0 ? -1 : 1) : s3]);
            };
            if (s2.length && (i3 || t3) && d2 && j(d2.min)) {
              ...
              if (s2.forEach((t4) => {
                t4.lineClip = [], t4.translated = b(d2.toPixels(G(t4.value, e4), true) || 0, 0, p2);
              }), i3 && !this.showLine && i3.hide(), t3 && t3.hide(), "y" === n2 && o2.length < r2.len) for (let t4 of o2) {
              ...
              s2.forEach((e5) => {
                ...
                f2 = s3.reverse(), m2 = o3, l2 && (u3(v2), t3 && u3(b2)), n3 ? (n3.animate({ d: v2 }), d3 == null ? void 0 : d3.animate({ d: b2 })) : (n3 = e5.clip = h2.path(v2), t3 && (d3 = e5.simpleClip = h2.path(b2))), i3 && ((_a = e5.graph) == null ? void 0 : _a.clip(n3)), t3 && ((_b = e5.area) == null ? void 0 : _b.clip(d3));
              });
            } else this.visible && (i3 && i3.show(), t3 && t3.show());
          }
          plotGroup(t3, e3, i3, s2, o2) {
            let r2 = this[t3], a2 = !r2, n2 = { visibility: i3, zIndex: s2 || 0.1 };
            return k(this.opacity) && !this.chart.styledMode && "inactive" !== this.state && (n2.opacity = this.opacity), r2 || (this[t3] = r2 = this.chart.renderer.g().add(o2)), r2.addClass("highcharts-" + e3 + " highcharts-series-" + this.index + " highcharts-" + this.type + "-series " + (k(this.colorIndex) ? "highcharts-color-" + this.colorIndex + " " : "") + (this.options.className || "") + (r2.hasClass("highcharts-tracker") ? " highcharts-tracker" : ""), true), r2.attr(n2)[a2 ? "attr" : "animate"](this.getPlotBox(e3)), r2;
          }
          getPlotBox(t3) {
          ...
          render() {
            ...
            O(this, "render"), t3.plotGroup("group", "series", r2, a2, n2), t3.markerGroup = t3.plotGroup("markerGroup", "markers", r2, a2, n2), false !== i3.clip && t3.setClip(), l2 && ((_a = t3.animate) == null ? void 0 : _a.call(t3, true)), t3.drawGraph && (t3.drawGraph(), t3.applyZones()), t3.visible && t3.drawPoints(), (_b = t3.drawDataLabels) == null ? void 0 : _b.call(t3), (_c = t3.redrawPoints) == null ? void 0 : _c.call(t3), i3.enableMouseTracking && ((_d = t3.drawTracker) == null ? void 0 : _d.call(t3)), l2 && ((_e = t3.animate) == null ? void 0 : _e.call(t3)), s2 || (l2 && o2.defer && (l2 += o2.defer), t3.animationTimeout = H(() => {
              t3.afterAnimate();
          ...
          buildKDTree(t3) {
            ...
            delete e3.kdTree, H(function() {
              e3.kdTree = function t4(i4, s2, o2) {
                ...
                if (n2) return r2 = e3.kdAxisArray[s2 % o2], i4.sort((t5, e4) => (t5[r2] || 0) - (e4[r2] || 0)), { point: i4[a2 = Math.floor(n2 / 2)], left: t4(i4.slice(0, a2), s2 + 1, o2), right: t4(i4.slice(a2 + 1), s2 + 1, o2) };
          ...
          searchKDTree(t3, e3, i3) {
            ...
            if (this.kdTree || this.buildingKdTree || this.buildKDTree(i3), this.kdTree) return function t4(e4, i4, n3, h2) {
              var _a;
              let d2 = i4.point, c2 = s2.kdAxisArray[n3 % h2], p2, u2, g2 = d2;
              !function(t5, e5) {
                var _a2;
                let i5 = t5[o2], s3 = e5[o2], a3 = k(i5) && k(s3) ? i5 - s3 : null, n4 = t5[r2], h3 = e5[r2], d3 = k(n4) && k(h3) ? n4 - h3 : 0, c3 = l2 && ((_a2 = e5.marker) == null ? void 0 : _a2.radius) || 0;
                e5.dist = Math.sqrt((a3 && a3 * a3 || 0) + d3 * d3) - c3, e5.distX = k(a3) ? Math.abs(a3) - c3 : Number.MAX_VALUE;
              }(e4, d2);
              let f2 = (e4[c2] || 0) - (d2[c2] || 0) + (l2 && ((_a = d2.marker) == null ? void 0 : _a.radius) || 0), m2 = f2 < 0 ? "left" : "right", x2 = f2 < 0 ? "right" : "left";
          ...
          drawTracker() {
            var _a;
            let t3 = this, e3 = t3.options, i3 = e3.trackByArea, s2 = [].concat((i3 ? t3.areaPath : t3.graphPath) || []), o2 = t3.chart, r2 = o2.pointer, a2 = o2.renderer, n2 = ((_a = o2.options.tooltip) == null ? void 0 : _a.snap) || 0, l2 = () => {
          ...
          addPoint(t3, e3, i3, s2, o2) {
            ...
            let f2 = g2.x;
            if (a2 = u2.length, this.requireSorting && f2 < u2[a2 - 1]) for (r2 = true; a2 && u2[a2 - 1] > f2; ) a2--;
            this.updateParallelArrays(g2, "splice", [a2, 0, 0]), this.updateParallelArrays(g2, a2), c2 && g2.name && (c2[f2] = g2.name), p2.splice(a2, 0, t3), (r2 || this.processedData) && (this.data.splice(a2, 0, null), this.processData()), "point" === n2.legendType && this.generatePoints(), i3 && (l2[0] && l2[0].remove ? l2[0].remove(false) : (l2.shift(), this.updateParallelArrays(g2, "shift"), p2.shift())), false !== o2 && O(this, "addPoint", { point: g2 }), this.isDirty = true, this.isDirtyData = true, e3 && h2.redraw(s2);
          }
          removePoint(t3, e3, i3) {
            ...
            c(i3, n2), e3 = G(e3, true), r2 ? r2.firePointEvent("remove", null, l2) : l2();
          }
          remove(t3, e3, i3, s2) {
            let o2 = this, r2 = o2.chart;
            function a2() {
              o2.destroy(s2), r2.isDirtyLegend = r2.isDirtyBox = true, r2.linkSeries(s2), G(t3, true) && r2.redraw(e3);
            }
            false !== i3 ? O(o2, "remove", null, a2) : a2();
          }
          update(t3, e3) {
            var _a, _b, _c;
            O(this, "update", { options: t3 = C(t3, this.userOptions) });
            ...
            u2 = u2 || r2, g2 && (p2.push("data", "isDirtyData", "isDirtyCanvas", "points", "processedData", "processedXData", "processedYData", "xIncrement", "cropped", "_hasPointMarkers", "hasDataLabels", "nodes", "layout", "level", "mapMap", "mapData", "minY", "maxY", "minX", "maxX", "transformGroups"), false !== t3.visible && p2.push("area", "graph"), i3.parallelArrays.forEach(function(t4) {
              p2.push(t4 + "Data");
            }), t3.data && (t3.dataSorting && T(i3.options.dataSorting, t3.dataSorting), this.setData(t3.data, false))), t3 = I(o2, { index: void 0 === o2.index ? i3.index : o2.index, pointStart: ((_a = a2 == null ? void 0 : a2.series) == null ? void 0 : _a.pointStart) ?? o2.pointStart ?? ((_b = i3.xData) == null ? void 0 : _b[0]) }, !g2 && { data: i3.options.data }, t3, l2), g2 && t3.data && (t3.data = i3.options.data), (p2 = ["group", "markerGroup", "dataLabelsGroup", "transformGroup"].concat(p2)).forEach(function(t4) {
            ...
            if (p2.forEach(function(t4) {
              i3[t4] = p2[t4];
            }), i3.init(s2, t3), g2 && this.points) for (let t4 of (false === (d2 = i3.options).visible ? (h2.graphic = 1, h2.dataLabel = 1) : (this.hasMarkerChanged(d2, o2) && (h2.graphic = 1), ((_c = i3.hasDataLabels) == null ? void 0 : _c.call(i3)) || (h2.dataLabel = 1)), this.points)) t4 && t4.series && (t4.resolveColor(), Object.keys(h2).length && t4.destroyElements(h2), false === d2.showInLegend && t4.legendItem && s2.legend.destroyItem(t4));
            i3.initialType = r2, s2.linkSeries(), s2.setSortedData(), f2 && i3.linkedSeries.length && (i3.isDirtyData = true), O(this, "afterUpdate"), G(e3, true) && s2.redraw(!!g2 && void 0);
          }
          setName(t3) {
          ...
          hasOptionChanged(t3) {
            var _a, _b;
            let e3 = this.chart, i3 = this.options[t3], s2 = e3.options.plotOptions, o2 = this.userOptions[t3], r2 = G((_a = s2 == null ? void 0 : s2[this.type]) == null ? void 0 : _a[t3], (_b = s2 == null ? void 0 : s2.series) == null ? void 0 : _b[t3]);
            return o2 && !k(r2) ? i3 !== o2 : i3 !== G(r2, i3);
          }
          onMouseOver() {
          ...
          setState(t3, e3) {
            let i3 = this, s2 = i3.options, o2 = i3.graph, r2 = s2.inactiveOtherPoints, a2 = s2.states, n2 = G(a2[t3 || "normal"] && a2[t3 || "normal"].animation, i3.chart.options.chart.animation), l2 = s2.lineWidth, h2 = s2.opacity;
            if (t3 = t3 || "", i3.state !== t3 && ([i3.group, i3.markerGroup, i3.dataLabelsGroup].forEach(function(e4) {
              ...
              if (t3 && (l2 = a2[t3].lineWidth || l2 + (a2[t3].lineWidthPlus || 0), h2 = G(a2[t3].opacity, h2)), o2 && !o2.dashstyle && j(l2)) for (let t4 of [o2, ...this.zones.map((t5) => t5.graph)]) t4 == null ? void 0 : t4.animate({ "stroke-width": l2 }, n2);
          ...
          setVisible(t3, e3) {
            ...
            }), o2 && (s2.isDirtyBox = true), O(i3, a2), false !== e3 && s2.redraw();
          }
          show() {
          ...
          drawLegendSymbol(t3, e3) {
            var _a;
            (_a = o[this.options.legendSymbol || "rectangle"]) == null ? void 0 : _a.call(this, t3, e3);
          }
        }
        return X.defaultOptions = a, X.types = n.seriesTypes, X.registerType = n.registerSeriesType, T(X.prototype, { axisTypes: ["xAxis", "yAxis"], coll: "series", colorCounter: 0, directTouch: false, invertible: true, isCartesian: true, kdAxisArray: ["clientX", "plotY"], parallelArrays: ["x", "y"], pointClass: r, requireSorting: true, sorted: true }), n.series = X, X;
      }), i(e, "Core/Legend/Legend.js", [e["Core/Animation/AnimationUtilities.js"], e["Core/Foundation.js"], e["Core/Globals.js"], e["Core/Series/Series.js"], e["Core/Series/Point.js"], e["Core/Renderer/RendererUtilities.js"], e["Core/Templating.js"], e["Core/Utilities.js"]], function(t2, e2, i2, s, o, r, a, n) {
        var l;
        let { animObject: h, setAnimation: d } = t2, { registerEventOptions: c } = e2, { composed: p, marginNames: u } = i2, { distribute: g } = r, { format: f } = a, { addEvent: m, createElement: x, css: y, defined: b, discardElement: v, find: S, fireEvent: k, isNumber: M, merge: C, pick: A, pushUnique: w, relativeLength: T, stableSort: P, syncTimeout: O } = n;
        class L {
          constructor(t3, e3) {
          ...
          setOptions(t3) {
            let e3 = A(t3.padding, 8);
            this.options = t3, this.chart.styledMode || (this.itemStyle = t3.itemStyle, this.itemHiddenStyle = C(this.itemStyle, t3.itemHiddenStyle)), this.itemMarginTop = t3.itemMarginTop, this.itemMarginBottom = t3.itemMarginBottom, this.padding = e3, this.initialItemY = e3 - 5, this.symbolWidth = A(t3.symbolWidth, 16), this.pages = [], this.proximate = "proximate" === t3.layout && !this.chart.inverted, this.baseline = void 0;
          }
          update(t3, e3) {
            let i3 = this.chart;
            this.setOptions(C(true, this.options, t3)), "events" in this.options && c(this, this.options), this.destroy(), i3.isDirtyLegend = i3.isDirtyBox = true, A(e3, true) && i3.redraw(), k(this, "afterUpdate", { redraw: e3 });
          }
          colorizeItem(t3, e3) {
            ...
            if (s2 == null ? void 0 : s2[e3 ? "removeClass" : "addClass"]("highcharts-legend-item-hidden"), !this.chart.styledMode) {
              ...
              o2 == null ? void 0 : o2.css(C(e3 ? this.itemStyle : s3)), r2 == null ? void 0 : r2.attr(p2({ stroke: d2 || t3.color })), a2 && a2.attr(p2(c2 && a2.isMarker ? t3.pointAttribs() : { fill: t3.color })), i3 == null ? void 0 : i3.attr(p2({ fill: l2 || t3.color, "fill-opacity": l2 ? 1 : h2 ?? 0.75 }));
            }
            k(this, "afterColorizeItem", { item: t3, visible: e3 });
          }
          positionItems() {
          ...
          positionItem(t3) {
            ...
            if (e3 && e3.element) {
              ...
              e3[b(e3.translateY) ? "animate" : "attr"](o3, void 0, () => {
                k(this, "afterPositionItem", { item: t3 });
              });
            }
            n2 && (n2.x = i3, n2.y = s2);
          }
          ...
          positionCheckboxes() {
            ...
            e3 && (t3 = e3.translateY, this.allItems.forEach(function(o2) {
              let r2;
              let a2 = o2.checkbox;
              a2 && (r2 = t3 + s2 + a2.y + (this.scrollOffset || 0) + 3, y(a2, { left: e3.translateX + o2.checkboxOffset + a2.x - 20 + "px", top: r2 + "px", display: this.proximate || r2 > t3 - 6 && r2 < t3 + i3 - 6 ? "" : "none" }));
            }, this));
          }
          renderTitle() {
          ...
          getAllItems() {
            ...
            return this.chart.series.forEach(function(e3) {
              ...
              e3 && A(i3.showInLegend, !b(i3.linkedTo) && void 0, true) && (t3 = t3.concat((e3.legendItem || {}).labels || ("point" === i3.legendType ? e3.data : e3)));
            }), k(this, "afterGetAllItems", { allItems: t3 }), t3;
          }
          getAlignment() {
            let t3 = this.options;
          ...
          adjustMargins(t3, e3) {
            ...
            o2 && [/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/].forEach(function(r2, a2) {
              r2.test(o2) && !b(t3[a2]) && (i3[u[a2]] = Math.max(i3[u[a2]], i3.legend[(a2 + 1) % 2 ? "legendHeight" : "legendWidth"] + [1, -1, -1, 1][a2] * s2[a2 % 2 ? "x" : "y"] + A(s2.margin, 12) + e3[a2] + (i3.titleOffset[a2] || 0)));
            });
          }
          proximatePositions() {
            let t3;
            ...
            for (let o2 of (this.allItems.forEach(function(t4) {
              ...
              t4.yAxis && (t4.xAxis.options.reversed && (a2 = !a2), t4.points && (o3 = S(a2 ? t4.points : t4.points.slice(0).reverse(), function(t5) {
                return M(t5.plotY);
            ...
            }, this), g(i3, e3.plotHeight))) t3 = o2.item.legendItem || {}, M(o2.pos) && (t3.y = e3.plotTop - e3.spacing[0] + o2.pos);
          }
          render() {
          ...
          handleOverflow(t3) {
            ...
            return "horizontal" !== o2.layout || "middle" === o2.verticalAlign || o2.floating || (b2 /= 2), l2 && (b2 = Math.min(b2, l2)), p2.length = 0, t3 && b2 > 0 && t3 > b2 && false !== h2.enabled ? (this.clipHeight = m2 = Math.max(b2 - 20 - this.titleHeight - n2, 0), this.currentPage = A(this.currentPage, 1), this.fullHeight = t3, u2.forEach((t4, e4) => {
          ...
          scroll(t3, e3) {
            let i3 = this.chart, s2 = this.pages, o2 = s2.length, r2 = this.clipHeight, a2 = this.options.navigation, n2 = this.pager, l2 = this.padding, c2 = this.currentPage + t3;
            c2 > o2 && (c2 = o2), c2 > 0 && (void 0 !== e3 && d(e3, i3), this.nav.attr({ translateX: l2, translateY: r2 + this.padding + 7 + this.titleHeight, visibility: "inherit" }), [this.up, this.upTracker].forEach(function(t4) {
              t4.attr({ class: 1 === c2 ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active" });
            }), n2.attr({ text: c2 + "/" + o2 }), [this.down, this.downTracker].forEach(function(t4) {
              t4.attr({ x: 18 + this.pager.getBBox().width, class: c2 === o2 ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active" });
            }, this), i3.styledMode || (this.up.attr({ fill: 1 === c2 ? a2.inactiveColor : a2.activeColor }), this.upTracker.css({ cursor: 1 === c2 ? "default" : "pointer" }), this.down.attr({ fill: c2 === o2 ? a2.inactiveColor : a2.activeColor }), this.downTracker.css({ cursor: c2 === o2 ? "default" : "pointer" })), this.scrollOffset = -s2[c2 - 1] + this.initialItemY, this.scrollGroup.animate({ translateY: this.scrollOffset }), this.currentPage = c2, this.positionCheckboxes(), O(() => {
              k(this, "afterScroll", { currentPage: c2 });
            }, h(A(e3, i3.renderer.globalAnimation, true)).duration));
          }
          setItemEvents(t3, e3, i3) {
            let r2 = this, a2 = t3.legendItem || {}, n2 = r2.chart.renderer.boxWrapper, l2 = t3 instanceof o, h2 = t3 instanceof s, d2 = "highcharts-legend-" + (l2 ? "point" : "series") + "-active", c2 = r2.chart.styledMode, p2 = i3 ? [e3, a2.symbol] : [a2.group], u2 = (e4) => {
            ...
            for (let i4 of p2) i4 && i4.on("mouseover", function() {
              t3.visible && u2("inactive"), t3.setState("hover"), t3.visible && n2.addClass(d2), c2 || e3.css(r2.options.itemHoverStyle);
            }).on("mouseout", function() {
              r2.chart.styledMode || e3.css(C(t3.visible ? r2.itemStyle : r2.itemHiddenStyle)), u2(""), n2.removeClass(d2), t3.setState();
            }).on("click", function(e4) {
              let i5 = function() {
                t3.setVisible && t3.setVisible(), u2(t3.visible ? "inactive" : "");
              };
              n2.removeClass(d2), k(r2, "itemClick", { browserEvent: e4, legendItem: t3 }, i5), l2 ? t3.firePointEvent("legendItemClick", { browserEvent: e4 }) : h2 && k(t3, "legendItemClick", { browserEvent: e4 });
            });
          }
          createCheckboxForItem(t3) {
            t3.checkbox = x("input", { type: "checkbox", className: "highcharts-legend-checkbox", checked: t3.selected, defaultChecked: t3.selected }, this.options.itemCheckboxStyle, this.chart.container), m(t3.checkbox, "click", function(e3) {
              let i3 = e3.target;
              k(t3.series || t3, "checkboxClick", { checked: i3.checked, item: t3 }, function() {
                t3.select();
              });
            });
          }
        ...
        return (l = L || (L = {})).compose = function(t3) {
          w(p, "Core.Legend") && m(t3, "beforeMargins", function() {
        ...
        class Q {
          ...
          isInsidePlot(t3, e3, i3 = {}) {
            var _a;
            let { inverted: s2, plotBox: o2, plotLeft: r2, plotTop: a2, scrollablePlotBox: n2 } = this, { scrollLeft: l2 = 0, scrollTop: h2 = 0 } = i3.visiblePlotOnly && ((_a = this.scrollablePlotArea) == null ? void 0 : _a.scrollingContainer) || {}, d2 = i3.series, c2 = i3.visiblePlotOnly && n2 || o2, p2 = i3.inverted ? e3 : t3, u2 = i3.inverted ? t3 : e3, g2 = { x: p2, y: u2, isInsidePlot: true, options: i3 };
            if (!i3.ignoreX) {
          ...
          redraw(t3) {
            ...
            for (a2.rootFontSize = a2.boxWrapper.getStyle("font-size"), this.setResponsive && this.setResponsive(false), m(!!this.hasRendered && t3, this), n2 && this.temporaryDisplay(), this.layOutTitles(false), c2 = i3.length; c2--; ) if (((g2 = i3[c2]).options.stacking || g2.options.centerInCategory) && (d2 = true, g2.isDirty)) {
              h2 = true;
              break;
            }
            ...
            i3.forEach(function(t4) {
              ...
              t4.extKey !== e4 && (t4.extKey = e4, l2.push(function() {
                G(t4, "afterSetExtremes", I(t4.eventArgs, t4.getExtremes())), delete t4.eventArgs;
              })), (p2 || d2) && t4.redraw();
          ...
          getAxes() {
            ...
            for (let i3 of (G(this, "getAxes"), ["xAxis", "yAxis"])) for (let s2 of t3[i3] = q(t3[i3] || {})) new e2(this, s2, i3);
            G(this, "afterGetAxes");
          }
          getSelectedPoints() {
          ...
          applyDescription(t3, e3) {
            ...
            }, this.styledMode || o2.css(I("title" === t3 ? { fontSize: this.options.isStock ? "1em" : "1.2em" } : {}, s2.style)), this[t3] = o2);
          }
          layOutTitles(t3 = true) {
            ...
            ["title", "subtitle", "caption"].forEach(function(t4) {
              ...
              if (o3) {
                ...
                o3.align(I({ y: "bottom" === a2 ? t5 : n2 + t5, height: l2 }, r2), false, "spacingBox"), r2.floating || ("top" === a2 ? e3[0] = Math.ceil(e3[0] + l2) : "bottom" === a2 && (e3[2] = Math.ceil(e3[2] + l2)));
              }
          ...
          getContainerBox() {
            ...
            }), e3 = { width: N(this.renderTo, "width", true) || 0, height: N(this.renderTo, "height", true) || 0 };
          ...
          getChartSize() {
            var _a;
            let t3 = this.options.chart, e3 = t3.width, i3 = t3.height, s2 = this.getContainerBox(), o2 = s2.height > 1 && !(!((_a = this.renderTo.parentElement) == null ? void 0 : _a.style.height) && "100%" === this.renderTo.style.height);
            this.chartWidth = Math.max(0, e3 || s2.width || 600), this.chartHeight = Math.max(0, $(i3, this.chartWidth) || (o2 ? s2.height : 400)), this.containerBox = s2;
          }
          temporaryDisplay(t3) {
            ...
            else for (; e3 && e3.style && (k.body.contains(e3) || e3.parentNode || (e3.hcOrigDetached = true, k.body.appendChild(e3)), ("none" === N(e3, "display", false) || e3.hcOricDetached) && (e3.hcOrigStyle = { display: e3.style.display, height: e3.style.height, overflow: e3.style.overflow }, i3 = { display: "block", overflow: "hidden" }, e3 !== this.renderTo && (i3.height = 0), L(e3, i3), e3.offsetWidth || e3.style.setProperty("display", "block", "important")), (e3 = e3.parentNode) !== k.body); ) ;
          }
          setClassName(t3) {
          ...
          getContainer() {
            ...
            r2 || (this.renderTo = r2 = e3.renderTo), F(r2) && (this.renderTo = r2 = k.getElementById(r2)), r2 || R(13, true, this);
            let n2 = _(P(r2, i3));
            ...
            L(r2, { overflow: "hidden" }), this.styledMode || (o2 = I({ position: "relative", overflow: "hidden", width: d2 + "px", height: l2 + "px", textAlign: "left", lineHeight: "normal", zIndex: 0, "-webkit-tap-highlight-color": "rgba(0,0,0,0)", userSelect: "none", "touch-action": "manipulation", outline: "none", padding: "0px" }, e3.style || {}));
            let c2 = O("div", { id: s2 }, o2, r2);
            this.container = c2, this.getChartSize(), d2 === this.chartWidth || (d2 = this.chartWidth, this.styledMode || L(c2, { width: V((_a = e3.style) == null ? void 0 : _a.width, d2 + "px") })), this.containerBox = this.getContainerBox(), this._cursor = c2.style.cursor;
            let u2 = e3.renderer || !C ? a.getRendererType(e3.renderer) : h;
            if (this.renderer = new u2(c2, d2, l2, void 0, e3.forExport, t3.exporting && t3.exporting.allowHTML, this.styledMode), m(void 0, this), this.setClassName(e3.className), this.styledMode) for (let e4 in t3.defs) this.renderer.definition(t3.defs[e4]);
          ...
          getAxisMargins() {
            ...
            t3.hasCartesianSeries ? o2(t3.axes) : i3 && i3.length && o2(i3), M.forEach(function(i4, o3) {
              D(s2[o3]) || (t3[i4] += e3[o3]);
            }), t3.setChartSize();
          }
          getOptions() {
          ...
          setSize(t3, e3, i3) {
            ...
            (s2.isDirtyBox || a2 !== s2.oldChartWidth || n2 !== s2.oldChartHeight) && (s2.styledMode || (r2 ? g : L)(s2.container, { width: `${a2 + l2}px`, height: `${n2 + h2}px` }, r2), s2.setChartSize(true), o2.setSize(a2, n2, r2), s2.axes.forEach(function(t4) {
          ...
          setChartSize(t3) {
            let e3, i3, s2, o2;
            let { chartHeight: r2, chartWidth: a2, inverted: n2, spacing: l2, renderer: h2 } = this, d2 = this.clipOffset, c2 = Math[n2 ? "floor" : "round"];
            this.plotLeft = e3 = Math.round(this.plotLeft), this.plotTop = i3 = Math.round(this.plotTop), this.plotWidth = s2 = Math.max(0, Math.round(a2 - e3 - this.marginRight)), this.plotHeight = o2 = Math.max(0, Math.round(r2 - i3 - this.marginBottom)), this.plotSizeX = n2 ? o2 : s2, this.plotSizeY = n2 ? s2 : o2, this.spacingBox = h2.spacingBox = { x: l2[3], y: l2[0], width: a2 - l2[3] - l2[1], height: r2 - l2[0] - l2[2] }, this.plotBox = h2.plotBox = { x: e3, y: i3, width: s2, height: o2 }, d2 && (this.clipBox = { x: c2(d2[3]), y: c2(d2[0]), width: c2(this.plotSizeX - d2[1] - d2[3]), height: c2(this.plotSizeY - d2[0] - d2[2]) }), t3 || (this.axes.forEach(function(t4) {
              t4.setAxisSize(), t4.setAxisTranslation();
            }), h2.alignElements()), G(this, "afterSetChartSize", { skipAxes: t3 });
          }
          resetMargins() {
            G(this, "resetMargins");
          ...
          drawChartBox() {
            ...
            m2 || (this.chartBackground = m2 = e3.rect().addClass("highcharts-background").add(), k2 = "attr"), o2 ? b2 = v2 = m2.strokeWidth() : (v2 = (b2 = t3.borderWidth || 0) + (t3.shadow ? 8 : 0), S2 = { fill: a2 || "none" }, (b2 || m2["stroke-width"]) && (S2.stroke = t3.borderColor, S2["stroke-width"] = b2), m2.attr(S2).shadow(t3.shadow)), m2[k2]({ x: v2 / 2, y: v2 / 2, width: i3 - v2 - b2 % 2, height: s2 - v2 - b2 % 2, r: t3.borderRadius }), k2 = "animate", x2 || (k2 = "attr", this.plotBackground = x2 = e3.rect().addClass("highcharts-plot-background").add()), x2[k2](u2), !o2 && (x2.attr({ fill: n2 || "none" }).shadow(t3.plotShadow), l2 && (r2 ? (l2 !== r2.attr("href") && r2.attr("href", l2), r2.animate(u2)) : this.plotBGImage = e3.image(l2, h2, d2, c2, p2).add())), g2 ? g2.animate({ width: f2.width, height: f2.height }) : this.clipRect = e3.clipRect(f2), k2 = "animate", y2 || (k2 = "attr", this.plotBorder = y2 = e3.rect().addClass("highcharts-plot-border").attr({ zIndex: 1 }).add()), o2 || y2.attr({ stroke: t3.plotBorderColor, "stroke-width": t3.plotBorderWidth || 0, fill: "none" }), y2[k2](y2.crisp({ x: h2, y: d2, width: c2, height: p2 }, -y2.strokeWidth())), this.isDirtyBox = false, G(this, "afterDrawChartBox");
          }
          propFromSeries() {
            let t3, e3, i3;
            let s2 = this, o2 = s2.options.chart, r2 = s2.options.series;
            ["inverted", "angular", "polar"].forEach(function(a2) {
              for (e3 = w[o2.type], i3 = o2[a2] || e3 && e3.prototype[a2], t3 = r2 && r2.length; !i3 && t3--; ) (e3 = w[r2[t3].type]) && e3.prototype[a2] && (i3 = true);
              s2[a2] = i3;
            });
          }
          linkSeries(t3) {
          ...
          render() {
            ...
            for (let e4 of (this.setTitle(), G(this, "beforeMargins"), (_a = this.getStacks) == null ? void 0 : _a.call(this), this.getMargins(true), this.setChartSize(), t3)) {
            ...
            for (this.plotHeight = Math.max(this.plotHeight - r2, 0); (a2 || n2 || s2 > 1) && l2 < s2; ) {
              ...
              for (let e5 of t3) 0 === l2 ? e5.setScale() : (e5.horiz && a2 || !e5.horiz && n2) && e5.setTickInterval(true);
          ...
          destroy() {
            ...
            for (G(e3, "destroy"), e3.renderer.forExport ? j(S, e3) : S[e3.index] = void 0, r.chartCount--, e3.renderTo.removeAttribute("data-highcharts-chart"), Z(e3), t3 = i3.length; t3--; ) i3[t3] = i3[t3].destroy();
            ...
            }), o2 && (o2.innerHTML = p.emptyHTML, Z(o2), a2 && B(o2)), Y(e3, function(t4, i4) {
              delete e3[i4];
            });
          }
          firstRender() {
            ...
            e3.series = [], i3.forEach(function(e4) {
              t3.initSeries(e4);
            }), t3.linkSeries(), t3.setSortedData(), G(t3, "beforeRender"), t3.render(), (_a = t3.pointer) == null ? void 0 : _a.getChartPosition(), t3.renderer.imgCount || t3.hasLoaded || t3.onload(), t3.temporaryDisplay(true);
          }
          onload() {
          ...
          warnIfA11yModuleNotLoaded() {
            ...
            !t3 || this.accessibility || (this.renderer.boxWrapper.attr({ role: "img", "aria-label": (e3 && e3.element.textContent || "").replace(/</g, "&lt;") }), t3.accessibility && false === t3.accessibility.enabled || R('Highcharts warning: Consider including the "accessibility.js" module to make your chart more usable for people with disabilities. Set the "accessibility.enabled" option to false to remove this warning. See https://www.highcharts.com/docs/accessibility/accessibility-module.', false, this));
          }
          addSeries(t3, e3, i3) {
            let s2;
            let o2 = this;
          ...
          showLoading(t3) {
            ...
            r2 || (e3.loadingDiv = r2 = O("div", { className: "highcharts-loading highcharts-loading-hidden" }, null, e3.container)), a2 || (e3.loadingSpan = a2 = O("span", { className: "highcharts-loading-inner" }, null, r2), T(e3, "redraw", o2)), r2.className = "highcharts-loading", p.setElementHTML(a2, V(t3, i3.lang.loading, "")), e3.styledMode || (L(r2, I(s2.style, { zIndex: 10 })), L(a2, s2.labelStyle), e3.loadingShown || (L(r2, { opacity: 0, display: "" }), g(r2, { opacity: s2.style.opacity || 0.5 }, { duration: s2.showDuration || 0 }))), e3.loadingShown = true, o2();
          }
          hideLoading() {
          ...
          update(t3, e3, i3, s2) {
            ...
            G(n2, "update", { options: t3 }), h2 || n2.setResponsive(false, true), t3 = E(t3, n2.options), n2.userOptions = U(n2.userOptions, t3);
            let p2 = t3.chart;
            p2 && (U(true, n2.options.chart, p2), this.setZoomOptions(), "className" in p2 && n2.setClassName(p2.className), ("inverted" in p2 || "polar" in p2 || "type" in p2) && (n2.propFromSeries(), o2 = true), "alignTicks" in p2 && (o2 = true), "events" in p2 && v(this, p2), Y(p2, function(t4, e4) {
            ...
            }), !n2.styledMode && p2.style && n2.renderer.setStyle(n2.options.chart.style || {})), !n2.styledMode && t3.colors && (this.options.colors = t3.colors), t3.time && (this.time === y && (this.time = new d(t3.time)), U(true, n2.options.time, t3.time)), Y(t3, function(e4, i4) {
              n2[i4] && "function" == typeof n2[i4].update ? n2[i4].update(e4, false) : "function" == typeof n2[l2[i4]] ? n2[l2[i4]](e4) : "colors" !== i4 && -1 === n2.collectionsWithUpdate.indexOf(i4) && U(true, n2.options[i4], t3[i4]), "chart" !== i4 && -1 !== n2.propsRequireUpdateSeries.indexOf(i4) && (r2 = true);
          ...
          pan(t3, e3) {
            ...
            (a2 == null ? void 0 : a2.panning) && (a2.panning = s2), G(this, "pan", { originalEvent: t3 }, () => {
              i3.transform({ axes: r2, event: t3, to: { x: t3.chartX - (i3.mouseDownX || 0), y: t3.chartY - (i3.mouseDownY || 0) }, trigger: "pan" }), L(i3.container, { cursor: "move" });
            });
          }
          transform(t3) {
            var _a;
            let { axes: e3 = this.axes, event: i3, from: s2 = {}, reset: o2, selection: r2, to: a2 = {}, trigger: n2 } = t3, { inverted: l2 } = this, h2 = false, d2, c2;
            for (let t4 of ((_a = this.hoverPoints) == null ? void 0 : _a.forEach((t5) => t5.setState()), e3)) {
              let { horiz: e4, len: p2, minPointOffset: u2 = 0, options: g2, reversed: f2 } = t4, m2 = e4 ? "width" : "height", x2 = e4 ? "x" : "y", y2 = V(a2[m2], t4.len), b2 = V(s2[m2], t4.len), v2 = 10 > Math.abs(y2) ? 1 : y2 / b2, S2 = (s2[x2] || 0) + b2 / 2 - t4.pos, k2 = S2 - ((a2[x2] ?? t4.pos) + y2 / 2 - t4.pos) / v2, M2 = f2 && !l2 || !f2 && l2 ? -1 : 1;
              if (!o2 && (S2 < 0 || S2 > t4.len)) continue;
              let C2 = t4.toValue(k2, true) + (r2 || t4.isOrdinal ? 0 : u2 * M2), A2 = t4.toValue(k2 + p2 / v2, true) - (r2 || t4.isOrdinal ? 0 : u2 * M2 || 0), w2 = t4.allExtremes;
              if (C2 > A2 && ([C2, A2] = [A2, C2]), 1 === v2 && !o2 && "yAxis" === t4.coll && !w2) {
              ...
              let { dataMin: T2, dataMax: P2, min: O2, max: L2 } = I(t4.getExtremes(), w2 || {}), E2 = T2 ?? g2.min, B2 = P2 ?? g2.max, j2 = A2 - C2, R2 = t4.categories ? 0 : Math.min(j2, B2 - E2), z2 = E2 - R2 * (D(g2.min) ? 0 : g2.minPadding), G2 = B2 + R2 * (D(g2.max) ? 0 : g2.maxPadding), N2 = t4.allowZoomOutside || 1 === v2 || "zoom" !== n2 && v2 > 1, W2 = Math.min(g2.min ?? z2, z2, N2 ? O2 : z2), X2 = Math.max(g2.max ?? G2, G2, N2 ? L2 : G2);
              (!t4.isOrdinal || t4.options.overscroll || 1 !== v2 || o2) && (C2 < W2 && (C2 = W2, v2 >= 1 && (A2 = C2 + j2)), A2 > X2 && (A2 = X2, v2 >= 1 && (C2 = A2 - j2)), (o2 || t4.series.length && (C2 !== O2 || A2 !== L2) && C2 >= W2 && A2 <= X2) && (r2 ? r2[t4.coll].push({ axis: t4, min: C2, max: A2 }) : (t4.isPanning = "zoom" !== n2, t4.isPanning && (c2 = true), t4.setExtremes(o2 ? void 0 : C2, o2 ? void 0 : A2, false, false, { move: k2, trigger: n2, scale: v2 }), !o2 && (C2 > W2 || A2 < X2) && "mousewheel" !== n2 && (d2 = true)), h2 = true), i3 && (this[e4 ? "mouseDownX" : "mouseDownY"] = i3[e4 ? "chartX" : "chartY"]));
            }
            return h2 && (r2 ? G(this, "selection", r2, () => {
              delete t3.selection, t3.trigger = "zoom", this.transform(t3);
            }) : (!d2 || c2 || this.resetZoomButton ? !d2 && this.resetZoomButton && (this.resetZoomButton = this.resetZoomButton.destroy()) : this.showResetZoom(), this.redraw("zoom" === n2 && (this.options.chart.animation ?? this.pointCount < 100)))), h2;
          }
        }
        return I(Q.prototype, { callbacks: [], collectionsWithInit: { xAxis: [Q.prototype.addAxis, [true]], yAxis: [Q.prototype.addAxis, [false]], series: [Q.prototype.addSeries] }, collectionsWithUpdate: ["xAxis", "yAxis", "series"], propsRequireDirtyBox: ["backgroundColor", "borderColor", "borderWidth", "borderRadius", "plotBackgroundColor", "plotBackgroundImage", "plotBorderColor", "plotBorderWidth", "plotShadow", "shadow"], propsRequireReflow: ["margin", "marginTop", "marginRight", "marginBottom", "marginLeft", "spacing", "spacingTop", "spacingRight", "spacingBottom", "spacingLeft"], propsRequireUpdateSeries: ["chart.inverted", "chart.polar", "chart.ignoreHiddenSeries", "chart.type", "colors", "plotOptions", "time", "tooltip"] }), Q;
        ...
        class g {
          ...
          static afterSetSize(t3, e3) {
            ...
            if (!p2.forExport && (r2 ? (t3.scrollablePixelsX = i3 = Math.max(0, r2 - t3.chartWidth), i3 && (t3.scrollablePlotBox = d(t3.plotBox), l2.width = t3.plotWidth += i3, n2[c2 ? "height" : "width"] += i3, o2 = true)) : a2 && (t3.scrollablePixelsY = s2 = Math.max(0, a2 - t3.chartHeight), h(s2) && (t3.scrollablePlotBox = d(t3.plotBox), l2.height = t3.plotHeight += s2, n2[c2 ? "width" : "height"] += s2, o2 = false)), h(o2) && !e3.skipAxes)) for (let e4 of t3.axes) e4.horiz === o2 && (e4.setAxisSize(), e4.setAxisTranslation());
          }
          constructor(t3) {
            var _a;
            let e3;
          ...
          applyFixed() {
            ...
            e3.setSize(a2, n2), (i3 ?? true) && (this.isDirty = false, this.moveFixedElements()), o(t3.container), l(d2, { width: `${b}px`, height: `${v}px` }), t3.renderer.boxWrapper.attr({ width: b, height: v, viewBox: [0, 0, b, v].join(" ") }), (_a = t3.chartBackground) == null ? void 0 : _a.attr({ width: b, height: v }), l(s2, { width: `${a2}px`, height: `${n2}px` }), h(i3) || (s2.scrollLeft = f * x, s2.scrollTop = m * y);
            let S = u2 - r2[0] - 1, k = p2 - r2[3] - 1, M = u2 + c2 + r2[2] + 1, C = p2 + g2 + r2[1] + 1, A = p2 + g2 - f, w = u2 + c2 - m, T = [["M", 0, 0]];
            f ? T = [["M", 0, S], ["L", p2 - 1, S], ["L", p2 - 1, M], ["L", 0, M], ["Z"], ["M", A, S], ["L", a2, S], ["L", a2, M], ["L", A, M], ["Z"]] : m && (T = [["M", k, 0], ["L", k, u2 - 1], ["L", C, u2 - 1], ["L", C, 0], ["Z"], ["M", k, w], ["L", k, n2], ["L", C, n2], ["L", C, w], ["Z"]]), "adjustHeight" !== t3.redrawTrigger && this.mask.attr({ d: T });
          }
          moveFixedElements() {
            let t3;
            let { container: e3, inverted: i3, scrollablePixelsX: s2, scrollablePixelsY: o2 } = this.chart, r2 = this.fixedRenderer, a2 = g.fixedSelectors;
            for (let n2 of (s2 && !i3 ? t3 = ".highcharts-yaxis" : s2 && i3 ? t3 = ".highcharts-xaxis" : o2 && !i3 ? t3 = ".highcharts-xaxis" : o2 && i3 && (t3 = ".highcharts-yaxis"), t3 && a2.push(`${t3}:not(.highcharts-radial-axis)`, `${t3}-labels:not(.highcharts-radial-axis-labels)`), a2)) [].forEach.call(e3.querySelectorAll(n2), (t4) => {
        ...
        return class {
          ...
          render(t3) {
            ...
            if (this.label) this.label.attr({ text: r2, visibility: "hidden" });
            else {
          ...
          getStackBox(t3) {
            ...
            return f ? { x: (m ? c : c - g) - i3.plotLeft, y: p.height - u - a2 + p.top - i3.plotTop, width: g, height: a2 } : { x: u + p.transB - i3.plotLeft, y: (m ? c - g : c) - i3.plotTop, width: a2, height: g };
          }
        };
        ...
        function S() {
          ...
          n2 && [s2, "-" + s2].forEach((i4) => {
            ...
            for (; s3--; ) a3 = r2[s3], t3 = e3.getStackIndicator(t3, a3, e3.index, i4), l2 = (_a = o2[i4]) == null ? void 0 : _a[a3], (h2 = l2 == null ? void 0 : l2.points[t3.key || ""]) && n2.call(e3, h2, l2, s3);
          });
        }
        function k(t3, e3, i3) {
        ...
        function C(t3, e3) {
          ...
          let x2 = this.processedXData, y2 = this.processedYData, b2 = [], v2 = y2.length, S2 = this.options, k2 = S2.threshold || 0, M2 = S2.startFromThreshold ? k2 : 0, C2 = S2.stack, A2 = e3 ? `${this.type},${f2}` : this.stackKey || "", w = "-" + A2, T = this.negStacks, P = t3.stacking, O = P.stacks, L = P.oldStacks;
          for (P.stacksTouched += 1, c2 = 0; c2 < v2; c2++) {
            p2 = x2[c2], g2 = y2[c2], l2 = (i3 = this.getStackIndicator(i3, p2, this.index)).key || "", O[n2 = (o2 = T && g2 < (M2 ? 0 : k2)) ? w : A2] || (O[n2] = {}), O[n2][p2] || (((_a = L[n2]) == null ? void 0 : _a[p2]) ? (O[n2][p2] = L[n2][p2], O[n2][p2].total = null) : O[n2][p2] = new s(t3, t3.options.stackLabels, !!o2, p2, C2)), r2 = O[n2][p2], null !== g2 ? (r2.points[l2] = r2.points[this.index] = [m(r2.cumulative, M2)], d(r2.cumulative) || (r2.base = l2), r2.touched = P.stacksTouched, i3.index > 0 && false === this.singleStacks && (r2.points[l2][0] = r2.points[this.index + "," + p2 + ",0"][0])) : (delete r2.points[l2], delete r2.points[this.index]);
            let e4 = r2.total || 0;
            "percent" === f2 ? (a2 = o2 ? A2 : w, e4 = T && ((_b = O[a2]) == null ? void 0 : _b[p2]) ? (a2 = O[a2][p2]).total = Math.max(a2.total || 0, e4) + Math.abs(g2) || 0 : h(e4 + (Math.abs(g2) || 0))) : "group" === f2 ? (u(g2) && (g2 = g2[0]), null !== g2 && e4++) : e4 = h(e4 + (g2 || 0)), "group" === f2 ? r2.cumulative = (e4 || 1) - 1 : r2.cumulative = h(m(r2.cumulative, M2) + (g2 || 0)), r2.total = e4, null !== g2 && (r2.points[l2].push(r2.cumulative), b2[c2] = r2.cumulative, r2.hasValidPoints = true);
          }
        ...
        class A {
          ...
          buildStacks() {
            ...
            for (this.resetStacks(), this.usePercentage = false, e3 = a2; e3--; ) t3 = s2[r2 ? e3 : a2 - e3 - 1], o2 && t3.setGroupedPoints(i3), t3.setStackedPoints(i3);
            if (!o2) for (e3 = 0; e3 < a2; e3++) s2[e3].modifyStacks();
          ...
          renderStackTotals() {
            var _a;
            let t3 = this.axis, e3 = t3.chart, i3 = e3.renderer, s2 = this.stacks, o2 = a(e3, ((_a = t3.options.stackLabels) == null ? void 0 : _a.animation) || false), r2 = this.stackTotalGroup = this.stackTotalGroup || i3.g("stack-labels").attr({ zIndex: 6, opacity: 0 }).add();
        ...
        return (r || (r = {})).compose = function(t3, e3, i3) {
          ...
          s2.getStacks || (l(t3, "init", b), l(t3, "destroy", y), s2.getStacks = x, o2.getStackIndicator = v, o2.modifyStacks = S, o2.percentStacker = k, o2.setGroupedPoints = M, o2.setStackedPoints = C);
        }, r;
        ...
        let { seriesTypes: { line: s } } = e2, { extend: o, merge: r, objectEach: a, pick: n } = i2;
        class l extends s {
          drawGraph() {
          ...
          getGraphPath(t3) {
            let e3, i3, o2;
            let r2 = s.prototype.getGraphPath, a2 = this.options, l2 = a2.stacking, h = this.yAxis, d = [], c = [], p = this.index, u = h.stacking.stacks[this.stackKey], g = a2.threshold, f = Math.round(h.getThreshold(a2.threshold)), m = n(a2.connectNulls, "percent" === l2), x = function(i4, s2, o3) {
              let r3 = t3[i4], a3 = l2 && u[r3.x].points[p], n2 = r3[o3 + "Null"] || 0, m2 = r3[o3 + "Cliff"] || 0, x2, y2, b2 = true;
              m2 || n2 ? (x2 = (n2 ? a3[0] : a3[1]) + m2, y2 = a3[0] + m2, b2 = !!n2) : !l2 && t3[s2] && t3[s2].isNull && (x2 = y2 = g), void 0 !== x2 && (c.push({ plotX: e3, plotY: null === x2 ? f : h.getThreshold(x2), isNull: b2, isCliff: true }), d.push({ plotX: e3, plotY: null === y2 ? f : h.getThreshold(y2), doCurve: false }));
            };
            t3 = t3 || this.points, l2 && (t3 = this.getStackPoints(t3));
            for (let s2 = 0, r3 = t3.length; s2 < r3; ++s2) l2 || (t3[s2].leftCliff = t3[s2].rightCliff = t3[s2].leftNull = t3[s2].rightNull = void 0), i3 = t3[s2].isNull, e3 = n(t3[s2].rectPlotX, t3[s2].plotX), o2 = l2 ? n(t3[s2].yBottom, f) : f, i3 && !m || (m || x(s2, s2 - 1, "left"), i3 && !l2 && m || (c.push(t3[s2]), d.push({ x: s2, plotX: e3, plotY: o2 })), m || x(s2, s2 + 1, "right"));
            ...
            return this.chart.series.length > 1 && l2 && c.some((t4) => t4.isCliff) && (S.hasStackedCliffs = k.hasStackedCliffs = true), S.xMap = y.xMap, this.areaPath = S, k;
          }
          getStackPoints(t3) {
            ...
            if (t3 = t3 || this.points, this.options.stacking) {
              ...
              s2.forEach(function(t4, a2) {
                ...
                if (h[t4] && !h[t4].isNull) i3.push(h[t4]), [-1, 1].forEach(function(i4) {
                  let o3 = 1 === i4 ? "rightNull" : "leftNull", r3 = l2[s2[a2 + i4]], n2 = 0;
                  if (r3) {
                    let i5 = u;
                    for (; i5 >= 0 && i5 < c; ) {
                      let s3 = d[i5].index;
                      !(m = r3.points[s3]) && (s3 === e3.index ? h[t4][o3] = true : g[i5] && (x = l2[t4].points[s3]) && (n2 -= x[1] - x[0])), i5 += p;
                    }
                  }
                  h[t4][1 === i4 ? "rightCliff" : "leftCliff"] = n2;
                });
                else {
                  let e4 = u;
                  for (; e4 >= 0 && e4 < c; ) {
                  ...
                  f = n(f, 0), f = r2.translate(f, 0, 1, 0, 1), i3.push({ isNull: true, plotX: o2.translate(t4, 0, 0, 0, 1), x: t4, plotY: f, yBottom: f });
                }
              });
            }
            return i3;
        ...
        return l.defaultOptions = r(s.defaultOptions, t2), o(l.prototype, { singleStacks: false }), e2.registerSeriesType("area", l), l;
        ...
        let { animObject: n } = t2, { parse: l } = e2, { noop: h } = s, { clamp: d, crisp: c, defined: p, extend: u, fireEvent: g, isArray: f, isNumber: m, merge: x, pick: y, objectEach: b } = a;
        class v extends o {
          animate(t3) {
            let e3, i3;
            let s2 = this, o2 = this.yAxis, r2 = o2.pos, a2 = o2.reversed, l2 = s2.options, { clipOffset: h2, inverted: c2 } = this.chart, p2 = {}, g2 = c2 ? "translateX" : "translateY";
            t3 && h2 ? (p2.scaleY = 1e-3, i3 = d(o2.toPixels(l2.threshold), r2, r2 + o2.len), c2 ? (i3 += a2 ? -Math.floor(h2[0]) : Math.ceil(h2[2]), p2.translateX = i3 - o2.len) : (i3 += a2 ? Math.ceil(h2[0]) : -Math.floor(h2[2]), p2.translateY = i3), s2.clipBox && s2.setClip(), s2.group.attr(p2)) : (e3 = Number(s2.group.attr(g2)), s2.group.animate({ scaleY: 1 }, u(n(s2.options.animation), { step: function(t4, i4) {
          ...
          getColumnMetrics() {
            ...
            let h2 = Math.min(Math.abs(i3.transA) * (!((_a = i3.brokenAxis) == null ? void 0 : _a.hasBreaks) && ((_b = i3.ordinal) == null ? void 0 : _b.slope) || e3.pointRange || i3.closestPointRange || i3.tickInterval || 1), i3.len), d2 = h2 * e3.groupPadding, c2 = (h2 - 2 * d2) / (l2 || 1), p2 = Math.min(e3.maxPointWidth || i3.len, y(e3.pointWidth, c2 * (1 - 2 * e3.pointPadding))), u2 = (t3.columnIndex || 0) + (r2 ? 1 : 0);
          ...
          crispCol(t3, e3, i3, s2) {
            ...
            return s2 = c(e3 + s2, o2, r2) - (e3 = c(e3, o2, r2)), this.options.crisp && (i3 = c(t3 + i3, o2) - (t3 = c(t3, o2))), { x: t3, y: e3, width: i3, height: s2 };
          }
          ...
          translate() {
            let t3 = this, e3 = t3.chart, i3 = t3.options, s2 = t3.dense = t3.closestPointRange * t3.xAxis.transA < 2, r2 = t3.borderWidth = y(i3.borderWidth, s2 ? 0 : 1), a2 = t3.xAxis, n2 = t3.yAxis, l2 = i3.threshold, h2 = y(i3.minPointLength, 5), c2 = t3.getColumnMetrics(), u2 = c2.width, f2 = t3.pointXOffset = c2.offset, x2 = t3.dataMin, b2 = t3.dataMax, v2 = t3.translatedThreshold = n2.getThreshold(l2), S = t3.barW = Math.max(u2, 1 + 2 * r2);
            i3.pointPadding && (S = Math.ceil(S)), o.prototype.translate.apply(t3), t3.points.forEach(function(s3) {
              let o2 = y(s3.yBottom, v2), r3 = 999 + Math.abs(o2), g2 = s3.plotX || 0, k = d(s3.plotY, -r3, n2.len + r3), M, C = Math.min(k, o2), A = Math.max(k, o2) - C, w = u2, T = g2 + f2, P = S;
              h2 && Math.abs(A) < h2 && (A = h2, M = !n2.reversed && !s3.negative || n2.reversed && s3.negative, m(l2) && m(b2) && s3.y === l2 && b2 <= l2 && (n2.min || 0) < l2 && (x2 !== b2 || (n2.max || 0) <= l2) && (M = !M, s3.negative = !s3.negative), C = Math.abs(C - v2) > h2 ? o2 - h2 : v2 - (M ? h2 : 0)), p(s3.options.pointWidth) && (T -= Math.round(((w = P = Math.ceil(s3.options.pointWidth)) - u2) / 2)), i3.centerInCategory && !i3.stacking && (T = t3.adjustForMissingColumns(T, w, s3, c2)), s3.barX = T, s3.pointWidth = w, s3.tooltipPos = e3.inverted ? [d(n2.len + n2.pos - e3.plotLeft - k, n2.pos - e3.plotLeft, n2.len + n2.pos - e3.plotLeft), a2.len + a2.pos - e3.plotTop - T - P / 2, A] : [a2.left - e3.plotLeft + T + P / 2, d(k + n2.pos - e3.plotTop, n2.pos - e3.plotTop, n2.len + n2.pos - e3.plotTop), A], s3.shapeType = t3.pointClass.prototype.shapeType || "roundedRect", s3.shapeArgs = t3.crispCol(T, s3.isNull ? v2 : C, P, s3.isNull ? 0 : A);
          ...
          pointAttribs(t3, e3) {
            let i3 = this.options, s2 = this.pointAttrToOptions || {}, o2 = s2.stroke || "borderColor", r2 = s2["stroke-width"] || "borderWidth", a2, n2, h2, d2 = t3 && t3.color || this.color, c2 = t3 && t3[o2] || i3[o2] || d2, p2 = t3 && t3.options.dashStyle || i3.dashStyle, u2 = t3 && t3[r2] || i3[r2] || this[r2] || 0, g2 = y(t3 && t3.opacity, i3.opacity, 1);
            t3 && this.zones.length && (n2 = t3.getZone(), d2 = t3.options.color || n2 && (n2.color || t3.nonZonedColor) || this.color, n2 && (c2 = n2.borderColor || c2, p2 = n2.dashStyle || p2, u2 = n2.borderWidth || u2)), e3 && t3 && (h2 = (a2 = x(i3.states[e3], t3.options.states && t3.options.states[e3] || {})).brightness, d2 = a2.color || void 0 !== h2 && l(d2).brighten(a2.brightness).get() || d2, c2 = a2[o2] || c2, u2 = a2[r2] || u2, p2 = a2.dashStyle || p2, g2 = y(a2.opacity, g2));
        ...
        return v.defaultOptions = x(o.defaultOptions, i2), u(v.prototype, { directTouch: true, getSymbol: h, negStacks: true, trackerGroups: ["group", "dataLabelsGroup"] }), r.registerSeriesType("column", v), v;
        ...
        return function(t3) {
          ...
          function i3(t4, e4, i4, s3, o2) {
            var _a;
            let { chart: r2, enabledDataSorting: l2 } = this, h2 = this.isCartesian && r2.inverted, d2 = t4.plotX, p2 = t4.plotY, g2 = i4.rotation || 0, f2 = a(d2) && a(p2) && r2.isInsidePlot(d2, Math.round(p2), { inverted: h2, paneCoordinates: true, series: this }), m2 = 0 === g2 && "justify" === u(i4.overflow, l2 ? "none" : "justify"), x2 = this.visible && false !== t4.visible && a(d2) && (t4.series.forceDL || l2 && !m2 || f2 || u(i4.inside, !!this.options.stacking) && s3 && r2.isInsidePlot(d2, h2 ? s3.x + 1 : s3.y + s3.height - 1, { inverted: h2, paneCoordinates: true, series: this })), y2 = t4.pos();
            if (x2 && y2) {
              var b2;
              let a2 = e4.getBBox(), d3 = e4.getBBox(void 0, 0), p3 = { right: 1, center: 0.5 }[i4.align || 0] || 0, v2 = { bottom: 1, middle: 0.5 }[i4.verticalAlign || 0] || 0;
              if (s3 = n({ x: y2[0], y: Math.round(y2[1]), width: 0, height: 0 }, s3 || {}), "plotEdges" === i4.alignTo && this.isCartesian && (s3[h2 ? "x" : "y"] = 0, s3[h2 ? "width" : "height"] = ((_a = this.yAxis) == null ? void 0 : _a.len) || 0), n(i4, { width: a2.width, height: a2.height }), b2 = s3, l2 && this.xAxis && !m2 && this.setDataLabelStartPos(t4, e4, o2, f2, b2), e4.align(c(i4, { width: d3.width, height: d3.height }), false, s3, false), e4.alignAttr.x += p3 * (d3.width - a2.width), e4.alignAttr.y += v2 * (d3.height - a2.height), e4[e4.placed ? "animate" : "attr"]({ x: e4.alignAttr.x + (a2.width - d3.width) / 2, y: e4.alignAttr.y + (a2.height - d3.height) / 2, rotationOriginX: (e4.width || 0) / 2, rotationOriginY: (e4.height || 0) / 2 }), m2 && s3.height >= 0) this.justifyDataLabel(e4, i4, e4.alignAttr, a2, s3, o2);
          ...
          function x(t4) {
            ...
            let e4;
            t4 = t4 || this.points;
            let i4 = this, s3 = i4.chart, n2 = i4.options, h2 = s3.renderer, { backgroundColor: c2, plotBackgroundColor: m2 } = s3.options.chart, x2 = h2.getContrast(d(m2) && m2 || d(c2) && c2 || "#000000"), y2 = v(i4), { animation: S2, defer: k } = y2[0], M = k ? o(s3, S2, i4) : { defer: 0, duration: 0 };
            l(this, "drawDataLabels"), ((_a = i4.hasDataLabels) == null ? void 0 : _a.call(i4)) && (e4 = this.initDataLabels(M), t4.forEach((t5) => {
              var _a2, _b;
              ...
              f(b(y2, t5.dlOptions || ((_a2 = t5.options) == null ? void 0 : _a2.dataLabels))).forEach((c4, f2) => {
                let m3 = c4.enabled && (t5.visible || t5.dataLabelOnHidden) && (!t5.isNull || t5.dataLabelOnNull) && function(t6, e5) {
                  ...
                  return true;
                }(t5, c4), { backgroundColor: y3, borderColor: b2, distance: v2, style: S3 = {} } = c4, k2, M2, C, A, w = {}, T = o2[f2], P = !T, O;
                m3 && (M2 = u(c4[t5.formatPrefix + "Format"], c4.format), k2 = t5.getLabelConfig(), C = a(M2) ? r(M2, k2, s3) : (c4[t5.formatPrefix + "Formatter"] || c4.formatter).call(k2, c4), A = c4.rotation, !s3.styledMode && (S3.color = u(c4.color, S3.color, d(i4.color) ? i4.color : void 0, "#000000"), "contrast" === S3.color ? ("none" !== y3 && (O = y3), t5.contrastColor = h2.getContrast("auto" !== O && O || t5.color || i4.color), S3.color = O || !a(v2) && c4.inside || 0 > g(v2 || 0) || n2.stacking ? t5.contrastColor : x2) : delete t5.contrastColor, n2.cursor && (S3.cursor = n2.cursor)), w = { r: c4.borderRadius || 0, rotation: A, padding: c4.padding, zIndex: 1 }, s3.styledMode || (w.fill = "auto" === y3 ? t5.color : y3, w.stroke = "auto" === b2 ? t5.color : b2, w["stroke-width"] = c4.borderWidth), p(w, (t6, e5) => {
                  void 0 === t6 && delete w[e5];
                })), !T || m3 && a(C) && !!T.div == !!c4.useHTML && (T.rotation && c4.rotation || T.rotation === c4.rotation) || (T = void 0, P = true), m3 && a(C) && (T ? w.text = C : (T = h2.label(C, 0, 0, c4.shape, void 0, void 0, c4.useHTML, void 0, "data-label")).addClass(" highcharts-data-label-color-" + t5.colorIndex + " " + (c4.className || "") + (c4.useHTML ? " highcharts-tracker" : "")), T && (T.options = c4, T.attr(w), s3.styledMode ? S3.width && T.css({ width: S3.width, textOverflow: S3.textOverflow }) : T.css(S3).shadow(c4.shadow), l(T, "beforeAddingDataLabel", { labelOptions: c4, point: t5 }), T.added || T.add(e4), i4.alignDataLabel(t5, T, c4, void 0, P), T.isActive = true, o2[f2] && o2[f2] !== T && o2[f2].destroy(), o2[f2] = T));
              });
              let c3 = o2.length;
              for (; c3--; ) o2[c3] && o2[c3].isActive ? o2[c3].isActive = false : ((_b = o2[c3]) == null ? void 0 : _b.destroy(), o2.splice(c3, 1));
              t5.dataLabel = o2[0], t5.dataLabels = o2;
            })), l(this, "afterDrawDataLabels");
          }
          function y(t4, e4, i4, s3, o2, r2) {
            let a2 = this.chart, n2 = e4.align, l2 = e4.verticalAlign, h2 = t4.box ? 0 : t4.padding || 0, d2 = a2.inverted ? this.yAxis : this.xAxis, c2 = d2 ? d2.left - a2.plotLeft : 0, p2 = a2.inverted ? this.xAxis : this.yAxis, u2 = p2 ? p2.top - a2.plotTop : 0, { x: g2 = 0, y: f2 = 0 } = e4, m2, x2;
            return (m2 = (i4.x || 0) + h2 + c2) < 0 && ("right" === n2 && g2 >= 0 ? (e4.align = "left", e4.inside = true) : g2 -= m2, x2 = true), (m2 = (i4.x || 0) + s3.width - h2 + c2) > a2.plotWidth && ("left" === n2 && g2 <= 0 ? (e4.align = "right", e4.inside = true) : g2 += a2.plotWidth - m2, x2 = true), (m2 = i4.y + h2 + u2) < 0 && ("bottom" === l2 && f2 >= 0 ? (e4.verticalAlign = "top", e4.inside = true) : f2 -= m2, x2 = true), (m2 = (i4.y || 0) + s3.height - h2 + u2) > a2.plotHeight && ("top" === l2 && f2 <= 0 ? (e4.verticalAlign = "bottom", e4.inside = true) : f2 += a2.plotHeight - m2, x2 = true), x2 && (e4.x = g2, e4.y = f2, t4.placed = !r2, t4.align(e4, void 0, o2)), x2;
          }
          function b(t4, e4) {
            let i4 = [], s3;
          ...
          applyJitter() {
            ...
            e3 && this.points.forEach(function(s2, o2) {
              ["x", "y"].forEach(function(r2, a2) {
                if (e3[r2] && !s2.isNull) {
                  let n2 = `plot${r2.toUpperCase()}`, l2 = t3[`${r2}Axis`], h = e3[r2] * l2.transA;
                  if (l2 && !l2.logarithmic) {
                    let t4 = Math.max(0, (s2[n2] || 0) - h), e4 = Math.min(l2.len, (s2[n2] || 0) + h);
        ...
        class d extends e2 {
          getConnectorPath(t3) {
            ...
            return e3 && o2.call(this, { ...e3.computed, alignment: e3.alignment }, e3.connectorPosition, i3) || [];
          }
          getTranslate() {
        ...
        return a(d.prototype, { connectorShapes: { fixedOffset: function(t3, e3, i3) {
          ...
          } else m = a2 + (n2 - f) * Math.tan((this.angle || 0) - Math.PI / 2);
          let x = [["M", g, f]];
        ...
        class m extends r {
          ...
          getX(t3, e3, i3, s2) {
            let o2 = this.center, r2 = this.radii ? this.radii[i3.index] || 0 : o2[2] / 2, a2 = s2.dataLabelPosition, n2 = (a2 == null ? void 0 : a2.distance) || 0, l2 = Math.asin(c((t3 - o2[1]) / (r2 + n2), -1, 1));
        ...
        return function(e3) {
          let i3 = { radialDistributionY: function(t3, e4) {
            ...
            return t3.getX(i4 < ((r3 == null ? void 0 : r3.top) || 0) + 2 || i4 > ((r3 == null ? void 0 : r3.bottom) || 0) - 2 ? s3 : i4, e4.half, e4, o3);
          ...
          function o2() {
            var _a;
            let t3 = this, e4 = t3.points, i4 = t3.chart, s3 = i4.plotWidth, o3 = i4.plotHeight, r3 = i4.plotLeft, a2 = Math.round(i4.chartWidth / 3), n2 = t3.center, c2 = n2[2] / 2, g2 = n2[1], m2 = [[], []], x = [0, 0, 0, 0], y = t3.dataLabelPositioners, b, v, S, k = 0;
            t3.visible && ((_a = t3.hasDataLabels) == null ? void 0 : _a.call(t3)) && (e4.forEach((t4) => {
              ...
              (t4.dataLabels || []).forEach((e5, i5) => {
                var _a2;
                let s4 = n2[2] / 2, o4 = e5.options, r4 = f((o4 == null ? void 0 : o4.distance) || 0, s4);
                0 === i5 && m2[t4.half].push(t4), !p((_a2 = o4 == null ? void 0 : o4.style) == null ? void 0 : _a2.width) && e5.getBBox().width > a2 && (e5.css({ width: Math.round(0.7 * a2) + "px" }), e5.shortened = true), e5.dataLabelPosition = this.getDataLabelPosition(t4, r4), k = Math.max(k, r4);
              });
            }), m2.forEach((e5, a3) => {
              let h2 = e5.length, d2 = [], f2, m3, b2 = 0, M;
              h2 && (t3.sortByAngle(e5, a3 - 0.5), k > 0 && (f2 = Math.max(0, g2 - c2 - k), m3 = Math.min(g2 + c2 + k, i4.plotHeight), e5.forEach((t4) => {
              ...
              }), l(d2, M = m3 + b2 - f2, M / 5)), e5.forEach((i5) => {
                (i5.dataLabels || []).forEach((l2) => {
                  let h3 = l2.options || {}, g3 = i5.distributeBox, f3 = l2.dataLabelPosition, m4 = (f3 == null ? void 0 : f3.natural.y) || 0, b3 = h3.connectorPadding || 0, k2 = l2.lineHeight || 21, M2 = (k2 - l2.getBBox().height) / 2, C = 0, A = m4, w = "inherit";
                  if (f3) {
                    if (d2 && p(g3) && f3.distance > 0 && (void 0 === g3.pos ? w = "hidden" : (S = g3.size, A = y.radialDistributionY(i5, l2))), h3.justify) C = y.justify(i5, l2, c2, n2);
                    else switch (h3.alignTo) {
                      case "connectors":
                        C = y.alignToConnectors(e5, a3, s3, r3);
                        break;
                      case "plotEdges":
                        C = y.alignToPlotEdges(l2, a3, s3, r3);
                        break;
                      default:
                        C = y.radialDistributionX(t3, i5, A - M2, m4, l2);
                    }
                    if (f3.attribs = { visibility: w, align: f3.alignment }, f3.posAttribs = { x: C + (h3.x || 0) + ({ left: b3, right: -b3 }[f3.alignment] || 0), y: A + (h3.y || 0) - k2 / 2 }, f3.computed.x = C, f3.computed.y = A - M2, u(h3.crop, true)) {
                      let t4;
                      C - (v = l2.getBBox().width) < b3 && 1 === a3 ? (t4 = Math.round(v - C + b3), x[3] = Math.max(t4, x[3])) : C + v > s3 - b3 && 0 === a3 && (t4 = Math.round(C + v - s3 + b3), x[1] = Math.max(t4, x[1])), A - S / 2 < 0 ? x[0] = Math.max(Math.round(-A + S / 2), x[0]) : A + S / 2 > o3 && (x[2] = Math.max(Math.round(A + S / 2 - o3), x[2])), f3.sideOverflow = t4;
                    }
                  }
                });
              }));
        ...
        return (e2 = t2 || (t2 = {})).getCenterOfPoints = function(t3) {
          ...
          let s = i2.length, o, r, a = false;
          for (o = 0, r = s - 1; o < s; r = o++) {
            let [s2, n] = i2[o], [l, h] = i2[r];
            n > e3 != h > e3 && t3 < (l - s2) * (e3 - n) / (h - n) + s2 && (a = !a);
          }
          return a;
        }, t2;
      }), i(e, "Extensions/OverlappingDataLabels.js", [e["Core/Geometry/GeometryUtilities.js"], e["Core/Utilities.js"]], function(t2, e2) {
        let { pointInPolygon: i2 } = t2, { addEvent: s, fireEvent: o, objectEach: r, pick: a } = e2;
        function n(t3) {
          let e3 = t3.length, s2 = (t4, e4) => !(e4.x >= t4.x + t4.width || e4.x + e4.width <= t4.x || e4.y >= t4.y + t4.height || e4.y + e4.height <= t4.y), r2 = (t4, e4) => {
            ...
            return false;
          }, a2, n2, h2, d, c, p = false;
          for (let i3 = 0; i3 < e3; i3++) (a2 = t3[i3]) && (a2.oldOpacity = a2.opacity, a2.newOpacity = 1, a2.absoluteBox = function(t4) {
            var _a, _b;
          ...
          for (let i3 = 0; i3 < e3; ++i3) {
            d = (n2 = t3[i3]) && n2.absoluteBox;
            let o2 = d == null ? void 0 : d.polygon;
            for (let a3 = i3 + 1; a3 < e3; ++a3) {
              c = (h2 = t3[a3]) && h2.absoluteBox;
              let e4 = false;
              if (d && c && n2 !== h2 && 0 !== n2.newOpacity && 0 !== h2.newOpacity && "hidden" !== n2.visibility && "hidden" !== h2.visibility) {
                let t4 = c.polygon;
                if (o2 && t4 && o2 !== t4 ? r2(o2, t4) && (e4 = true) : s2(d, c) && (e4 = true), e4) {
                  let t5 = n2.labelrank < h2.labelrank ? n2 : h2, e5 = t5.text;
        ...
        function l(t3, e3) {
          ...
          }, r2 = true, t3[t3.isOld ? "animate" : "attr"]({ opacity: s2 }, void 0, i3), o(e3, "afterHideOverlappingLabel")) : t3.attr({ opacity: s2 })), t3.isOld = true), r2;
        }
        function h() {
          var _a;
          let t3 = this, e3 = [];
          ...
          for (let i3 of t3.series || []) if (i3.visible && ((_a = i3.hasDataLabels) == null ? void 0 : _a.call(i3))) {
            let s2 = (i4) => {
              for (let s3 of i4) s3.visible && (s3.dataLabels || []).forEach((i5) => {
                var _a2;
                let o2 = i5.options || {};
                i5.labelrank = a(o2.labelrank, s3.labelrank, (_a2 = s3.shapeArgs) == null ? void 0 : _a2.height), o2.allowOverlap ?? Number(o2.distance) > 0 ? (i5.oldOpacity = i5.opacity, i5.newOpacity = 1, l(i5, t3)) : e3.push(i5);
              });
            };
        ...
        return { compose: function(t3) {
          let e3 = t3.prototype;
          e3.hideOverlappingLabels || (e3.hideOverlappingLabels = n, s(t3, "render", h));
        } };
        ...
        function u(t3, e3, i3, s2, o2 = {}) {
          ...
          let p2 = d2 - l2, g2 = Math.sin(p2 / 2), f2 = Math.max(Math.min(h(o2.borderRadius || 0, n2 - a2), (n2 - a2) / 2, n2 * g2 / (1 + g2)), 0), m2 = Math.min(f2, p2 / Math.PI * 2 * a2), x2 = r2.length - 1;
          for (; x2--; ) !function(t4, e4, i4) {
            ...
            if ("Z" === n3[0] && (n3 = t4[0]), ("M" === a3[0] || "L" === a3[0]) && "A" === n3[0] ? (s3 = a3, o3 = n3, r3 = true) : "A" === a3[0] && ("M" === n3[0] || "L" === n3[0]) && (s3 = n3, o3 = a3), s3 && o3 && o3.params) {
              let a4 = o3[1], n4 = o3[5], l3 = o3.params, { start: h2, end: d3, cx: c2, cy: p3 } = l3, u2 = n4 ? a4 - i4 : a4 + i4, g3 = u2 ? Math.asin(i4 / u2) : 0, f3 = n4 ? g3 : -g3, m3 = Math.cos(g3) * u2;
        ...
        function g() {
          ...
          if (this.options.borderRadius && !(this.chart.is3d && this.chart.is3d())) {
            let { options: t3, yAxis: e3 } = this, i3 = "percent" === t3.stacking, o2 = (_b = (_a = s.plotOptions) == null ? void 0 : _a[this.type]) == null ? void 0 : _b.borderRadius, r2 = f(t3.borderRadius, n(o2) ? o2 : {}), l2 = e3.options.reversed;
        ...
        function x(t3, e3, i3, s2, o2 = {}) {
          let r2 = p(t3, e3, i3, s2, o2), { r: a2 = 0, brBoxHeight: n2 = s2, brBoxY: l2 = e3 } = o2, h2 = e3 - l2, d2 = l2 + n2 - (e3 + s2), c2 = h2 - a2 > -0.1 ? 0 : a2, u2 = d2 - a2 > -0.1 ? 0 : a2, g2 = Math.max(c2 && h2, 0), f2 = Math.max(u2 && d2, 0), m2 = [t3 + c2, e3], y = [t3 + i3 - c2, e3], b = [t3 + i3, e3 + c2], v = [t3 + i3, e3 + s2 - u2], S = [t3 + i3 - u2, e3 + s2], k = [t3 + u2, e3 + s2], M = [t3, e3 + s2 - u2], C = [t3, e3 + c2], A = (t4, e4) => Math.sqrt(Math.pow(t4, 2) - Math.pow(e4, 2));
          if (g2) {
            let t4 = A(c2, c2 - g2);
            m2[0] -= t4, y[0] += t4, b[1] = C[1] = e3 + c2 - g2;
          }
          if (s2 < c2 - g2) {
            let o3 = A(c2, c2 - g2 - s2);
            b[0] = v[0] = t3 + i3 - c2 + o3, S[0] = Math.min(b[0], S[0]), k[0] = Math.max(v[0], k[0]), M[0] = C[0] = t3 + c2 - o3, b[1] = C[1] = e3 + s2;
          }
          if (f2) {
            let t4 = A(u2, u2 - f2);
            S[0] += t4, k[0] -= t4, v[1] = M[1] = e3 + s2 - u2 + f2;
          }
          if (s2 < u2 - f2) {
            let o3 = A(u2, u2 - f2 - s2);
            b[0] = v[0] = t3 + i3 - u2 + o3, y[0] = Math.min(b[0], y[0]), m2[0] = Math.max(v[0], m2[0]), M[0] = C[0] = t3 + u2 - o3, v[1] = M[1] = e3;
          }
          return r2.length = 0, r2.push(["M", ...m2], ["L", ...y], ["A", c2, c2, 0, 0, 1, ...b], ["L", ...v], ["A", u2, u2, 0, 0, 1, ...S], ["L", ...k], ["A", u2, u2, 0, 0, 1, ...M], ["L", ...C], ["A", c2, c2, 0, 0, 1, ...m2], ["Z"]), r2;
        }
        ...
        return function(t3) {
          ...
          function l(t4, e4) {
            ...
            let c = a2 && a2.ruleIds;
            l2 === c || (a2 && (this.currentResponsive = void 0, this.updatingResponsive = true, this.update(a2.undoOptions, t4, true), this.updatingResponsive = false), l2 ? ((h = i2(d, this.options, true, this.collectionsWithUpdate)).isResponsiveOptions = true, this.currentResponsive = { ruleIds: l2, mergedOptions: d, undoOptions: h }, this.updatingResponsive || this.update(d, t4, true)) : this.currentResponsive = void 0);
          }
          t3.compose = function(t4) {
            let i3 = t4.prototype;
      ...
      }), i(e, "masters/highcharts.src.js", [e["Core/Globals.js"], e["Core/Utilities.js"], e["Core/Defaults.js"], e["Core/Animation/Fx.js"], e["Core/Animation/AnimationUtilities.js"], e["Core/Renderer/HTML/AST.js"], e["Core/Templating.js"], e["Core/Renderer/RendererRegistry.js"], e["Core/Renderer/RendererUtilities.js"], e["Core/Renderer/SVG/SVGElement.js"], e["Core/Renderer/SVG/SVGRenderer.js"], e["Core/Renderer/HTML/HTMLElement.js"], e["Core/Axis/Axis.js"], e["Core/Axis/DateTimeAxis.js"], e["Core/Axis/LogarithmicAxis.js"], e["Core/Axis/PlotLineOrBand/PlotLineOrBand.js"], e["Core/Axis/Tick.js"], e["Core/Tooltip.js"], e["Core/Series/Point.js"], e["Core/Pointer.js"], e["Core/Legend/Legend.js"], e["Core/Legend/LegendSymbol.js"], e["Core/Chart/Chart.js"], e["Extensions/ScrollablePlotArea.js"], e["Core/Axis/Stacking/StackingAxis.js"], e["Core/Axis/Stacking/StackItem.js"], e["Core/Series/Series.js"], e["Core/Series/SeriesRegistry.js"], e["Series/Column/ColumnDataLabel.js"], e["Series/Pie/PieDataLabel.js"], e["Core/Series/DataLabel.js"], e["Extensions/OverlappingDataLabels.js"], e["Extensions/BorderRadius.js"], e["Core/Responsive.js"], e["Core/Color/Color.js"], e["Core/Time.js"]], function(t2, e2, i2, s, o, r, a, n, l, h, d, c, p, u, g, f, m, x, y, b, v, S, k, M, C, A, w, T, P, O, L, D, E, B, j, R) {
        return t2.AST = r, t2.Axis = p, t2.Chart = k, t2.Color = j, t2.DataLabel = L, t2.Fx = s, t2.HTMLElement = c, t2.Legend = v, t2.LegendSymbol = S, t2.OverlappingDataLabels = t2.OverlappingDataLabels || D, t2.PlotLineOrBand = f, t2.Point = y, t2.Pointer = b, t2.RendererRegistry = n, t2.Series = w, t2.SeriesRegistry = T, t2.StackItem = A, t2.SVGElement = h, t2.SVGRenderer = d, t2.Templating = a, t2.Tick = m, t2.Time = R, t2.Tooltip = x, t2.animate = o.animate, t2.animObject = o.animObject, t2.chart = k.chart, t2.color = j.parse, t2.dateFormat = a.dateFormat, t2.defaultOptions = i2.defaultOptions, t2.distribute = l.distribute, t2.format = a.format, t2.getDeferredAnimation = o.getDeferredAnimation, t2.getOptions = i2.getOptions, t2.numberFormat = a.numberFormat, t2.seriesType = T.seriesType, t2.setAnimation = o.setAnimation, t2.setOptions = i2.setOptions, t2.stop = o.stop, t2.time = i2.defaultTime, t2.timers = s.timers, E.compose(t2.Series, t2.SVGElement, t2.SVGRenderer), P.compose(t2.Series.types.column), L.compose(t2.Series), u.compose(t2.Axis), c.compose(t2.SVGRenderer), v.compose(t2.Chart), g.compose(t2.Axis), D.compose(t2.Chart), O.compose(t2.Series.types.pie), f.compose(t2.Chart, t2.Axis), b.compose(t2.Chart), B.compose(t2.Chart), M.compose(t2.Axis, t2.Chart, t2.Series), C.compose(t2.Axis, t2.Chart, t2.Series), x.compose(t2.Pointer), e2.extend(t2, e2), t2;
        ...
        class d {
          ...
          toFixedRange(t3, e3, i3, s2) {
            let l2 = this.axis, h2 = (l2.pointRange || 0) / 2, d2 = n(i3, l2.translate(t3, true, !l2.horiz)), c = n(s2, l2.translate(e3, true, !l2.horiz));
            return r(i3) || (d2 = o(d2 + h2)), r(s2) || (c = o(c - h2)), a(d2) && a(c) || (d2 = c = void 0), { min: d2, max: c };
          }
        }
        return d;
        ...
        let { defaultOptions: r } = t2, { addEvent: a, correctFloat: n, crisp: l, defined: h, destroyObjectProperties: d, fireEvent: c, merge: p, pick: u, removeEvent: g } = o;
        class f {
          static compose(t3) {
            i2.compose(t3, f);
          }
          ...
          buttonToMinClick(t3) {
            ...
            this.updatePosition(n(this.from - e3), n(this.to - e3)), c(this, "changed", { from: this.from, to: this.to, trigger: "scrollbar", DOMEvent: t3 });
          }
          ...
          setRange(t3, e3) {
            ...
            i3 = Math.ceil(l2 * (t3 = Math.max(t3, 0))), this.calculatedWidth = s2 = n(c2 - i3), s2 < a2 && (i3 = (l2 - a2 + s2) * t3, s2 = a2);
        ...
        let { defaultOptions: h } = i2, { isTouchDevice: d } = s, { prototype: { symbols: c } } = n, { addEvent: p, clamp: u, correctFloat: g, defined: f, destroyObjectProperties: m, erase: x, extend: y, find: b, fireEvent: v, isArray: S, isNumber: k, merge: M, pick: C, removeEvent: A, splat: w } = l;
        function T(t3, ...e3) {
        ...
        class P {
          ...
          drawOutline(t3, e3, i3, s2) {
            ...
            i3 ? (f2 = d2 + e3 + n2, e3 = d2 + t3 + n2, m2 = [["M", g2 + c2, d2 - l2 - n2], ["L", g2 + c2, f2], ["L", g2, f2], ["M", g2, e3], ["L", g2 + c2, e3], ["L", g2 + c2, d2 + h2 + l2]], o2 && m2.push(["M", g2 + c2, f2 - a2], ["L", g2 + c2, e3 + a2])) : (g2 -= l2, t3 += g2 + l2 - n2, e3 += g2 + l2 - n2, m2 = [["M", g2, p2], ["L", t3, p2], ["L", t3, u2], ["M", e3, u2], ["L", e3, p2], ["L", g2 + h2 + 2 * l2, p2]], o2 && m2.push(["M", t3 - a2, p2], ["L", e3 + a2, p2])), this.outline[s2]({ d: m2 });
          }
          ...
          update(t3, e3 = false) {
            ...
            if (M(true, i3.options.navigator, t3), this.navigatorOptions = i3.options.navigator || {}, this.setOpposite(), f(t3.enabled) || s2) return this.destroy(), this.navigatorEnabled = t3.enabled || this.navigatorEnabled, this.init(i3);
          ...
          render(t3, e3, i3, s2) {
            let o2 = this.chart, r2 = this.xAxis, a2 = r2.pointRange || 0, n2 = r2.navigatorAxis.fake ? o2.xAxis[0] : r2, l2 = this.navigatorEnabled, h2 = this.rendered, d2 = o2.inverted, c2 = o2.xAxis[0].minRange, p2 = o2.xAxis[0].options.maxRange, m2 = this.scrollButtonSize, x2, y2, b2, S2 = this.scrollbarHeight, M2, A2;
            if (this.hasDragged && !f(i3)) return;
            if (this.isDirty && this.renderElements(), t3 = g(t3 - a2 / 2), e3 = g(e3 + a2 / 2), !k(t3) || !k(e3)) {
              if (!h2) return;
              i3 = 0, s2 = C(r2.width, n2.width);
            }
            this.left = C(r2.left, o2.plotLeft + m2 + (d2 ? o2.plotWidth : 0));
            let w2 = this.size = M2 = C(r2.len, (d2 ? o2.plotHeight : o2.plotWidth) - 2 * m2);
            x2 = d2 ? S2 : M2 + 2 * m2, i3 = C(i3, r2.toPixels(t3, true)), s2 = C(s2, r2.toPixels(e3, true)), k(i3) && Math.abs(i3) !== 1 / 0 || (i3 = 0, s2 = x2);
            let T2 = r2.toValue(i3, true), P2 = r2.toValue(s2, true), O = Math.abs(g(P2 - T2));
            O < c2 ? this.grabbedLeft ? i3 = r2.toPixels(P2 - c2 - a2, true) : this.grabbedRight && (s2 = r2.toPixels(T2 + c2 + a2, true)) : f(p2) && g(O - a2) > p2 && (this.grabbedLeft ? i3 = r2.toPixels(P2 - p2 - a2, true) : this.grabbedRight && (s2 = r2.toPixels(T2 + p2 + a2, true))), this.zoomedMax = u(Math.max(i3, s2), 0, w2), this.zoomedMin = u(this.fixedWidth ? this.zoomedMax - this.fixedWidth : Math.min(i3, s2), 0, w2), this.range = this.zoomedMax - this.zoomedMin, w2 = Math.round(this.zoomedMax);
            let L = Math.round(this.zoomedMin);
            l2 && (this.navigatorGroup.attr({ visibility: "inherit" }), A2 = h2 && !this.hasDragged ? "animate" : "attr", this.drawMasks(L, w2, d2, A2), this.drawOutline(L, w2, d2, A2), this.navigatorOptions.handles.enabled && (this.drawHandle(L, 0, d2, A2), this.drawHandle(w2, 1, d2, A2))), this.scrollbar && (d2 ? (b2 = this.top - m2, y2 = this.left - S2 + (l2 || !n2.opposite ? 0 : (n2.titleOffset || 0) + n2.axisTitleMargin), S2 = M2 + 2 * m2) : (b2 = this.top + (l2 ? this.height : -S2), y2 = this.left - m2), this.scrollbar.position(y2, b2, x2, S2), this.scrollbar.setRange(this.zoomedMin / (M2 || 1), this.zoomedMax / (M2 || 1))), this.rendered = true, this.isDirty = false, v(this, "afterRender");
          }
          addMouseEvents() {
          ...
          onMouseMove(t3) {
            ...
            (!t3.touches || 0 !== t3.touches[0].pageX) && (l2 = (t3 = ((_a = i3.pointer) == null ? void 0 : _a.normalize(t3)) || t3).chartX, a2 && (n2 = e3.top, l2 = t3.chartY), e3.grabbedLeft ? (e3.hasDragged = true, e3.render(0, 0, l2 - n2, e3.otherHandlePos)) : e3.grabbedRight ? (e3.hasDragged = true, e3.render(0, 0, e3.otherHandlePos, l2 - n2)) : e3.grabbedCenter && (e3.hasDragged = true, l2 < r2 ? l2 = r2 : l2 > s2 + r2 - o2 && (l2 = s2 + r2 - o2), e3.render(0, 0, l2 - r2, l2 - r2 + o2)), e3.hasDragged && e3.scrollbar && C(e3.scrollbar.options.liveRedraw, !d && !this.chart.boosted) && (t3.DOMType = t3.type, setTimeout(function() {
              e3.onMouseUp(t3);
            }, 0)));
          }
          onMouseUp(t3) {
          ...
          init(e3) {
            var _a;
            let i3 = e3.options, s2 = i3.navigator || {}, r2 = s2.enabled, n2 = i3.scrollbar || {}, l2 = n2.enabled, h2 = r2 && s2.height || 0, d2 = l2 && n2.height || 0, c2 = n2.buttonsEnabled && d2 || 0;
            this.handles = [], this.shades = [], this.chart = e3, this.setBaseSeries(), this.height = h2, this.scrollbarHeight = d2, this.scrollButtonSize = c2, this.scrollbarEnabled = l2, this.navigatorEnabled = r2, this.navigatorOptions = s2, this.scrollbarOptions = n2, this.setOpposite();
            ...
            if (e3.isDirtyBox = true, u2.navigatorEnabled) {
              ...
              u2.xAxis = new t2(e3, M({ breaks: x2.options.breaks, ordinal: x2.options.ordinal, overscroll: x2.options.overscroll }, s2.xAxis, { type: "datetime", yAxis: (_a = s2.yAxis) == null ? void 0 : _a.id, index: f2, isInternal: true, offset: 0, keepOrdinalPadding: true, startOnTick: false, endOnTick: false, minPadding: x2.options.ordinal ? 0 : x2.options.minPadding, maxPadding: x2.options.ordinal ? 0 : x2.options.maxPadding, zoomEnabled: false }, e3.inverted ? { offsets: i4, width: h2 } : { offsets: i4, height: h2 }), "xAxis"), u2.yAxis = new t2(e3, M(s2.yAxis, { alignTicks: false, offset: 0, index: m2, isInternal: true, reversed: C(s2.yAxis && s2.yAxis.reversed, e3.yAxis[0] && e3.yAxis[0].reversed, false), zoomEnabled: false }, e3.inverted ? { width: h2 } : { height: h2 }), "yAxis"), g2 || s2.series.data ? u2.updateNavigatorSeries(false) : 0 === e3.series.length && (u2.unbindRedraw = p(e3, "beforeRedraw", function() {
              ...
              let s3 = e3.xAxis[0], o2 = s3.getExtremes(), r3 = s3.len - 2 * c2, a2 = T("min", s3.options.min, o2.dataMin), n3 = T("max", s3.options.max, o2.dataMax) - a2;
            ...
            if (e3.options.scrollbar.enabled) {
              ...
              !k(t3.margin) && u2.navigatorEnabled && (t3.margin = e3.inverted ? -3 : 3), e3.scrollbar = u2.scrollbar = new a(e3.renderer, t3, e3), p(u2.scrollbar, "changed", function(t4) {
          ...
          getUnionExtremes(t3) {
            ...
            return t3 && null === i3.dataMin || (e3 = { dataMin: C(o2 && o2.min, T("min", r2.min, i3.dataMin, s2.dataMin, s2.min)), dataMax: C(o2 && o2.max, T("max", r2.max, i3.dataMax, s2.dataMax, s2.max)) }), e3;
          }
          setBaseSeries(t3, e3) {
          ...
          updateNavigatorSeries(t3, e3) {
            ...
            }), n2, l2, d2 = i3.navigatorOptions.series, c2;
            o2 && o2.length && o2.forEach((t4) => {
              let p2 = t4.navigatorSeries, u2 = y({ color: t4.color, visible: t4.visible }, S(d2) ? h.navigator.series : d2);
              if (p2 && false === i3.navigatorOptions.adaptToUpdatedData) return;
              r2.name = "Navigator " + o2.length, c2 = (n2 = t4.options || {}).navigatorOptions || {}, u2.dataLabels = w(u2.dataLabels), (l2 = M(n2, r2, u2, c2)).pointRange = C(u2.pointRange, c2.pointRange, h.plotOptions[l2.type || "line"].pointRange);
              let g2 = c2.data || u2.data;
              i3.hasNavigatorData = i3.hasNavigatorData || !!g2, l2.data = g2 || n2.data && n2.data.slice(0), p2 && p2.options ? p2.update(l2, e3) : (t4.navigatorSeries = s2.initSeries(l2), s2.setSortedData(), t4.navigatorSeries.baseSeries = t4, a2.push(t4.navigatorSeries));
            }), (d2.data && !(o2 && o2.length) || S(d2)) && (i3.hasNavigatorData = false, (d2 = w(d2)).forEach((t4, e4) => {
              r2.name = "Navigator " + (a2.length + 1), (l2 = M(h.navigator.series, { color: s2.series[e4] && !s2.series[e4].options.isInternal && s2.series[e4].color || s2.options.colors[e4] || s2.options.colors[0] }, r2, t4)).data = t4.data, l2.data && (i3.hasNavigatorData = true, a2.push(s2.initSeries(l2)));
          ...
          modifyBaseAxisExtremes() {
            var _a;
            let t3, e3;
            let i3 = this.chart.navigator, s2 = this.getExtremes(), o2 = s2.min, r2 = s2.max, a2 = s2.dataMin, n2 = s2.dataMax, l2 = r2 - o2, h2 = i3.stickToMin, d2 = i3.stickToMax, c2 = C((_a = this.ordinal) == null ? void 0 : _a.convertOverscroll(this.options.overscroll), 0), p2 = i3.series && i3.series[0], u2 = !!this.setExtremes;
            !(this.eventArgs && "rangeSelectorButton" === this.eventArgs.trigger) && (h2 && (t3 = (e3 = a2) + l2), d2 && (t3 = n2 + c2, h2 || (e3 = Math.max(a2, t3 - l2, i3.getBaseSeriesMin(p2 && p2.xData ? p2.xData[0] : -Number.MAX_VALUE)))), u2 && (h2 || d2) && k(e3) && (this.min = this.userMin = e3, this.max = this.userMax = t3)), i3.stickToMin = i3.stickToMax = null;
          }
          updatedDataHandler() {
          ...
          shouldStickToMin(t3, e3) {
            ...
            return !!(k(o2) && k(r2)) && (a2 && o2 - i3 > 0 ? o2 - i3 < a2 : r2 <= i3);
          }
          addChartEvents() {
        ...
        return function(t3) {
          function s2(t4, e3, i3, o3, r2 = [], a2 = 0, n2) {
            let d2 = {}, c2 = this.options.tickPixelInterval, u2 = this.chart.time, g2 = [], f2, m2, x2, y2, b2, v2 = 0, S2 = [], k2 = -Number.MAX_VALUE;
            if (!this.options.ordinal && !this.options.breaks || !r2 || r2.length < 3 || void 0 === e3) return u2.getTimeTicks.apply(u2, arguments);
            let M2 = r2.length;
            for (f2 = 0; f2 < M2; f2++) {
              if (b2 = f2 && r2[f2 - 1] > i3, r2[f2] < e3 && (v2 = f2), f2 === M2 - 1 || r2[f2 + 1] - r2[f2] > 5 * a2 || b2) {
                if (r2[f2] > k2) {
                  for (m2 = u2.getTimeTicks(t4, r2[v2], r2[f2], o3); m2.length && m2[0] <= k2; ) m2.shift();
                  m2.length && (k2 = m2[m2.length - 1]), g2.push(S2.length), S2 = S2.concat(m2);
                }
                v2 = f2 + 1;
              }
              if (b2) break;
            ...
            if (m2) {
              if (y2 = m2.info, n2 && y2.unitRange <= p.hour) {
                for (v2 = 1, f2 = S2.length - 1; v2 < f2; v2++) u2.dateFormat("%d", S2[v2]) !== u2.dateFormat("%d", S2[v2 - 1]) && (d2[S2[v2]] = "day", x2 = true);
                x2 && (d2[S2[0]] = "day"), y2.higherRanks = d2;
              }
              y2.segmentStarts = g2, S2.info = y2;
            } else h(12, false, this.chart);
            if (n2 && l(c2)) {
              let t5 = S2.length, e4 = [], s3 = [], o4, r3, a3, n3, l2, h2 = t5;
              for (; h2--; ) r3 = this.translate(S2[h2]), a3 && (s3[h2] = a3 - r3), e4[h2] = a3 = r3;
              for (s3.sort((t6, e5) => t6 - e5), (n3 = s3[Math.floor(s3.length / 2)]) < 0.6 * c2 && (n3 = null), h2 = S2[t5 - 1] > i3 ? t5 - 1 : t5, a3 = void 0; h2--; ) l2 = Math.abs(a3 - (r3 = e4[h2])), a3 && l2 < 0.8 * c2 && (null === n3 || l2 < 0.8 * n3) ? (d2[S2[h2]] && !d2[S2[h2 + 1]] ? (o4 = h2 + 1, a3 = r3) : o4 = h2, S2.splice(o4, 1)) : a3 = r3;
            }
            return S2;
          }
          function o2(t4) {
          ...
          function v(t4) {
            ...
            if (o3 && "y" !== o3.type && e3.options.ordinal && e3.series.length && (!t4.touches || t4.touches.length <= 1)) {
              let t5, o4;
              let a2 = this.mouseDownX, l2 = e3.getExtremes(), h2 = l2.dataMin, d2 = l2.dataMax, c2 = l2.min, p2 = l2.max, u2 = this.hoverPoints, g2 = e3.closestPointRange || e3.ordinal && e3.ordinal.overscrollPointsRange, f2 = Math.round((a2 - s3) / (e3.translationSlope * (e3.ordinal.slope || g2))), m2 = e3.ordinal.getExtendedPositions(), x2 = { ordinal: { positions: m2, extendedOrdinalPositions: m2 } }, y2 = e3.index2val, b2 = e3.val2lin;
              if (c2 <= h2 && f2 < 0 || p2 + i3 >= d2 && f2 > 0) return;
              x2.ordinal.positions ? Math.abs(f2) > 1 && (u2 && u2.forEach(function(t6) {
                t6.setState();
              }), d2 > (o4 = x2.ordinal.positions)[o4.length - 1] && o4.push(d2), this.setFixedRange(p2 - c2), (t5 = e3.navigatorAxis.toFixedRange(void 0, void 0, y2.apply(x2, [b2.apply(x2, [c2, true]) + f2]), y2.apply(x2, [b2.apply(x2, [p2, true]) + f2]))).min >= Math.min(l2.dataMin, c2) && t5.max <= Math.max(d2, p2) + i3 && e3.setExtremes(t5.min, t5.max, true, false, { trigger: "pan" }), this.mouseDownX = s3, n(this.container, { cursor: "move" })) : r2 = true;
            } else r2 = true;
          ...
          t3.compose = function(t4, e3, i3) {
            let a2 = t4.prototype;
            return a2.ordinal2lin || (a2.getTimeTicks = s2, a2.index2val = o2, a2.lin2val = g, a2.val2lin = k, a2.ordinal2lin = a2.val2lin, r(t4, "afterInit", m), r(t4, "foundExtremes", x), r(t4, "afterSetScale", y), r(t4, "initialAxisTranslation", b), r(i3, "pan", v), r(i3, "touchpan", v), r(e3, "updatedData", S)), t4;
          };
          class M {
            constructor(t4) {
            ...
            beforeSetTickPositions() {
              var _a;
              let t4 = this.axis, e3 = t4.ordinal, i3 = t4.getExtremes(), s3 = i3.min, o3 = i3.max, r2 = (_a = t4.brokenAxis) == null ? void 0 : _a.hasBreaks, a2 = t4.options.ordinal, n2, l2, h2, d2, p2, u2, g2, f2 = [], m2 = Number.MAX_VALUE, x2 = false, y2 = false, b2 = false;
              if (a2 || r2) {
                let i4 = 0;
                if (t4.series.forEach(function(t5, e4) {
                  ...
                  for (h2 = f2[1] - f2[0], g2 = n2 - 1; g2-- && !x2; ) f2[g2 + 1] - f2[g2] !== h2 && (x2 = true);
                  !t4.options.keepOrdinalPadding && (f2[0] - s3 > h2 || o3 - f2[f2.length - 1] > h2) && (x2 = true);
                } else t4.options.overscroll && (2 === n2 ? m2 = f2[1] - f2[0] : 1 === n2 ? (m2 = t4.ordinal.convertOverscroll(t4.options.overscroll), f2 = [f2[0], f2[0] + m2]) : m2 = e3.overscrollPointsRange);
            ...
            getExtendedPositions(t4 = true) {
              var _a;
              let s3 = this, o3 = s3.axis, r2 = o3.constructor.prototype, a2 = o3.chart, n2 = (_a = o3.series[0]) == null ? void 0 : _a.currentDataGrouping, l2 = n2 ? n2.count + n2.unitName : "raw", h2 = t4 ? o3.ordinal.convertOverscroll(o3.options.overscroll) : 0, d2 = o3.getExtremes(), c2, p2, u2 = s3.index;
              return u2 || (u2 = s3.index = {}), u2[l2] || ((c2 = { series: [], chart: a2, forceOrdinal: false, getExtremes: function() {
                ...
                var _a2, _b, _c;
                p2 = { xAxis: c2, xData: o4.xData.slice(), chart: a2, groupPixelWidth: o4.groupPixelWidth, destroyGroupedData: e2.noop, getProcessedData: i2.prototype.getProcessedData, applyGrouping: i2.prototype.applyGrouping, reserveSpace: i2.prototype.reserveSpace, visible: o4.visible }, t4 && (p2.xData = p2.xData.concat(s3.getOverscrollPositions())), p2.options = { dataGrouping: n2 ? { firstAnchor: (_a2 = o4.options.dataGrouping) == null ? void 0 : _a2.firstAnchor, anchor: (_b = o4.options.dataGrouping) == null ? void 0 : _b.anchor, lastAnchor: (_c = o4.options.dataGrouping) == null ? void 0 : _c.firstAnchor, enabled: true, forced: true, approximation: "open", units: [[n2.unitName, [n2.count]]] } : { enabled: false } }, c2.series.push(p2), o4.processData.apply(p2);
            ...
            getIndexOfPoint(t4, e3) {
              ...
              return M.findIndexOf(e3, o3, true) + h2;
            }
        ...
        let o;
        let { defaultOptions: r } = t2, { composed: a } = e2, { addEvent: n, defined: l, extend: h, isNumber: d, merge: c, pick: p, pushUnique: u } = s, g = [];
        function f() {
          let t3, e3;
          ...
          let n2 = p(this.dataMin, Number.MIN_VALUE);
          return d(t3) || (t3 = n2), t3 <= n2 && (t3 = n2, void 0 === e3 && (e3 = a2(t3, i3.count)), this.newMax = Math.min(t3 + e3, p(this.dataMax, Number.MAX_VALUE))), d(o2) ? !d(i3) && i3 && i3._offsetMin && (t3 += i3._offsetMin) : t3 = void 0, t3;
        }
        function m() {
        ...
        return { compose: function(t3, e3, s2) {
          if (o = s2, u(a, "RangeSelector")) {
            let s3 = e3.prototype;
            t3.prototype.minFromRange = f, n(e3, "afterGetContainer", m), n(e3, "beforeRender", x), n(e3, "destroy", b), n(e3, "getMargins", v), n(e3, "redraw", y), n(e3, "update", S), s3.callbacks.push(y), h(r, { rangeSelector: i2.rangeSelector }), h(r.lang, i2.lang);
          }
        } };
      }), i(e, "Stock/RangeSelector/RangeSelector.js", [e["Core/Axis/Axis.js"], e["Core/Defaults.js"], e["Core/Globals.js"], e["Stock/RangeSelector/RangeSelectorComposition.js"], e["Core/Renderer/SVG/SVGElement.js"], e["Core/Utilities.js"], e["Core/Axis/OrdinalAxis.js"]], function(e2, i2, s, o, r, a, n) {
        let { defaultOptions: l } = i2, { addEvent: h, createElement: d, css: c, defined: p, destroyObjectProperties: u, discardElement: g, extend: f, fireEvent: m, isNumber: x, merge: y, objectEach: b, pad: v, pick: S, pInt: k, splat: M } = a;
        class C {
          ...
          clickButton(t2, i3) {
            let s2 = this.chart, o2 = this.buttonOptions[t2], r2 = s2.xAxis[0], a2 = s2.scroller && s2.scroller.getUnionExtremes() || r2 || {}, n2 = o2.type, l2 = o2.dataGrouping, d2 = a2.dataMin, c2 = a2.dataMax, u2, g2 = r2 && Math.round(Math.min(r2.max, S(c2, r2.max))), f2, y2 = o2._range, b2, v2, k2, C2 = true;
            if (null !== d2 && null !== c2) {
              if (this.setSelected(t2), l2 && (this.forcedDataGrouping = true, e2.prototype.setDataGrouping.call(r2 || { chart: this.chart }, l2, false), this.frozenStates = o2.preserveDataGrouping), "month" === n2 || "year" === n2) r2 ? (v2 = { range: o2, max: g2, chart: s2, dataMin: d2, dataMax: c2 }, u2 = r2.minFromRange.call(v2), x(v2.newMax) && (g2 = v2.newMax), C2 = false) : y2 = o2;
              ...
              if (C2 && o2._offsetMin && p(u2) && (u2 += o2._offsetMin), o2._offsetMax && p(g2) && (g2 += o2._offsetMax), this.dropdown && (this.dropdown.selectedIndex = t2 + 1), r2) r2.setExtremes(u2, g2, S(i3, true), void 0, { trigger: "rangeSelectorButton", rangeSelectorButton: o2 }), s2.setFixedRange(o2._range);
              else {
                f2 = M(s2.options.xAxis)[0];
          ...
          updateButtonStates() {
            let t2 = this, e3 = this.chart, i3 = this.dropdown, s2 = this.dropdownLabel, o2 = e3.xAxis[0], r2 = Math.round(o2.max - o2.min), a2 = !o2.hasVisibleSeries, h2 = 24 * 36e5, d2 = e3.scroller && e3.scroller.getUnionExtremes() || o2, p2 = d2.dataMin, u2 = d2.dataMax, g2 = t2.getYTDExtremes(u2, p2, e3.time.useUTC), f2 = g2.min, m2 = g2.max, y2 = t2.selected, b2 = t2.options.allButtonsEnabled, v2 = Array(t2.buttonOptions.length).fill(0), S2 = x(y2), k2 = t2.buttons, M2 = false, C2 = null;
            t2.buttonOptions.forEach((e4, i4) => {
              var _a;
              let s3 = e4._range, l2 = e4.type, d3 = e4.count || 1, c2 = e4._offsetMax - e4._offsetMin, g3 = i4 === y2, x2 = s3 > u2 - p2, k3 = s3 < o2.minRange, A = false, w = s3 === r2;
              if (g3 && x2 && (M2 = true), o2.isOrdinal && ((_a = o2.ordinal) == null ? void 0 : _a.positions) && s3 && r2 < s3) {
                let t3 = o2.ordinal.positions, e5 = n.Additions.findIndexOf(t3, o2.min, true), i5 = Math.min(n.Additions.findIndexOf(t3, o2.max, true) + 1, t3.length - 1);
                t3[i5] - t3[e5] > s3 && (w = true);
              } else ("month" === l2 || "year" === l2) && r2 + 36e5 >= { month: 28, year: 365 }[l2] * h2 * d3 - c2 && r2 - 36e5 <= { month: 31, year: 366 }[l2] * h2 * d3 + c2 ? w = true : "ytd" === l2 ? (w = m2 - f2 + c2 === r2, A = !g3) : "all" === l2 && (w = o2.max - o2.min >= u2 - p2);
              let T = !b2 && !(M2 && "all" === l2) && (x2 || k3 || a2), P = M2 && "all" === l2 || !A && w || g3 && t2.frozenStates;
              T ? v2[i4] = 3 : P && (!S2 || i4 === y2) && (C2 = i4);
            }), null !== C2 ? (v2[C2] = 2, t2.setSelected(C2)) : (t2.setSelected(), s2 && (s2.setState(0), s2.attr({ text: (l.lang.rangeSelectorZoom || "") + " ▾" })));
            for (let e4 = 0; e4 < v2.length; e4++) {
              let o3 = v2[e4], r3 = k2[e4];
              if (r3.state !== o3 && (r3.setState(o3), i3)) {
                i3.options[e4 + 1].disabled = 3 === o3, 2 === o3 && (s2 && (s2.setState(2), s2.attr({ text: t2.buttonOptions[e4].text + " ▾" })), i3.selectedIndex = e4 + 1);
                let r4 = s2.getBBox();
                c(i3, { width: `${r4.width}px`, height: `${r4.height}px` });
              }
            }
          }
          computeButtonRange(t2) {
            let e3 = t2.type, i3 = t2.count || 1, s2 = { millisecond: 1, second: 1e3, minute: 6e4, hour: 36e5, day: 864e5, week: 6048e5 };
            s2[e3] ? t2._range = s2[e3] * i3 : ("month" === e3 || "year" === e3) && (t2._range = 24 * { month: 30, year: 365 }[e3] * 36e5 * i3), t2._offsetMin = S(t2.offsetMin, 0), t2._offsetMax = S(t2.offsetMax, 0), t2._range += t2._offsetMax - t2._offsetMin;
          }
          getInputValue(t2) {
          ...
          setInputValue(t2, e3) {
            ...
            if (o2) {
              let t3 = o2.getAttribute("data-hc-time"), a2 = p(t3) ? Number(t3) : void 0;
              if (p(e3)) {
                let t4 = a2;
                p(t4) && o2.setAttribute("data-hc-time-previous", t4), o2.setAttribute("data-hc-time", e3), a2 = e3;
              }
          ...
          showInput(t2) {
            ...
            if (i3 && e3 && this.inputGroup) {
              ...
              c(i3, { width: t3 ? a2 + (l2 ? -2 : 20) + "px" : "auto", height: n2 - 2 + "px", border: "2px solid silver" }), t3 && l2 ? c(i3, { left: s2 + r2 + "px", top: o2 + "px" }) : c(i3, { left: Math.min(Math.round(r2 + s2 - (i3.offsetWidth - a2) / 2), this.chart.chartWidth - i3.offsetWidth) + "px", top: o2 - (i3.offsetHeight - n2) / 2 + "px" });
            }
          }
          hideInput(t2) {
            let e3 = "min" === t2 ? this.minInput : this.maxInput;
            e3 && c(e3, { top: "-9999em", border: 0, width: "1px", height: "1px" });
          }
          ...
          drawInput(t2) {
            let { chart: e3, div: i3, inputGroup: o2 } = this, r2 = this, a2 = e3.renderer.style || {}, n2 = e3.renderer, h2 = e3.options.rangeSelector, p2 = l.lang, u2 = "min" === t2;
            function g2(t3) {
              var _a;
              let { maxInput: i4, minInput: s2 } = r2, o3 = e3.xAxis[0], a3 = ((_a = e3.scroller) == null ? void 0 : _a.getUnionExtremes()) || o3, n3 = a3.dataMin, l2 = a3.dataMax, h3 = e3.xAxis[0].getExtremes()[t3], d2 = r2.getInputValue(t3);
              x(d2) && d2 !== h3 && (u2 && i4 && x(n3) ? d2 > Number(i4.getAttribute("data-hc-time")) ? d2 = void 0 : d2 < n3 && (d2 = n3) : s2 && x(l2) && (d2 < Number(s2.getAttribute("data-hc-time")) ? d2 = void 0 : d2 > l2 && (d2 = l2)), void 0 !== d2 && o3.setExtremes(u2 ? d2 : o3.min, u2 ? o3.max : d2, void 0, void 0, { trigger: "rangeSelectorInput" }));
            }
            let m2 = p2[u2 ? "rangeSelectorFrom" : "rangeSelectorTo"] || "", b2 = n2.label(m2, 0).addClass("highcharts-range-label").attr({ padding: m2 ? 2 : 0, height: m2 ? h2.inputBoxHeight : 0 }).add(o2), v2 = n2.label("", 0).addClass("highcharts-range-input").attr({ padding: 2, width: h2.inputBoxWidth, height: h2.inputBoxHeight, "text-align": "center" }).on("click", function() {
              r2.showInput(t2), r2[t2 + "Input"].focus();
            });
            e3.styledMode || v2.attr({ stroke: h2.inputBoxBorderColor, "stroke-width": 1 }), v2.add(o2);
            let S2 = d("input", { name: t2, className: "highcharts-range-selector" }, void 0, i3);
            ...
            }(h2.inputDateFormat || "%e %b %Y")), e3.styledMode || (b2.css(y(a2, h2.labelStyle)), v2.css(y({ color: "#333333" }, a2, h2.inputStyle)), c(S2, f({ position: "absolute", border: 0, boxShadow: "0 0 15px rgba(0,0,0,0.3)", width: "1px", height: "1px", padding: 0, textAlign: "center", fontSize: a2.fontSize, fontFamily: a2.fontFamily, top: "-9999em" }, h2.inputStyle))), S2.onfocus = () => {
              r2.showInput(t2);
            }, S2.onblur = () => {
              S2 === s.doc.activeElement && g2(t2), r2.hideInput(t2), r2.setInputValue(t2), S2.blur();
            };
            let k2 = false;
            return S2.onchange = () => {
              k2 || (g2(t2), r2.hideInput(t2), S2.blur());
            }, S2.onkeypress = (e4) => {
              13 === e4.keyCode && g2(t2);
            }, S2.onkeydown = (e4) => {
          ...
          createElements() {
            var _a;
            let t2 = this.chart, e3 = t2.renderer, i3 = t2.container, s2 = t2.options, o2 = s2.rangeSelector, r2 = o2.inputEnabled, a2 = S((_a = s2.chart.style) == null ? void 0 : _a.zIndex, 0) + 1;
            if (false !== o2.enabled && (this.group = e3.g("range-selector-group").attr({ zIndex: 7 }).add(), this.div = d("div", void 0, { position: "relative", height: 0, zIndex: a2 }), this.buttonOptions.length && this.renderButtons(), i3.parentNode && i3.parentNode.insertBefore(this.div, i3), r2)) {
                ...
                if (this.inputGroup) {
                  ...
                  [this.minLabel, this.minDateBox, this.maxLabel, this.maxDateBox].forEach((e4) => {
                    if (e4) {
                      ...
                      i4 && (e4.attr({ x: t3 }), t3 += i4 + s2.inputSpacing);
                    }
                  });
                }
              }
          ...
          renderButtons() {
            var _a;
            let { buttons: t2, chart: e3, options: i3 } = this, o2 = l.lang, r2 = e3.renderer, a2 = y(i3.buttonTheme), n2 = a2 && a2.states, c2 = a2.width || 28;
            delete a2.width, delete a2.states, this.buttonGroup = r2.g("range-selector-buttons").add(this.group);
            let p2 = this.dropdown = d("select", void 0, { position: "absolute", padding: 0, border: 0, cursor: "pointer", opacity: 1e-4 }, this.div), u2 = (_a = e3.userOptions.rangeSelector) == null ? void 0 : _a.buttonTheme;
            this.dropdownLabel = r2.button("", 0, 0, () => {
            }, y(a2, { "stroke-width": S(a2["stroke-width"], 0), width: "auto", paddingLeft: S(i3.buttonTheme.paddingLeft, u2 == null ? void 0 : u2.padding, 8), paddingRight: S(i3.buttonTheme.paddingRight, u2 == null ? void 0 : u2.padding, 8) }), n2 && n2.hover, n2 && n2.select, n2 && n2.disabled).hide().add(this.group), h(p2, "touchstart", () => {
            ...
            }), this.zoomText = r2.label(o2.rangeSelectorZoom || "", 0).attr({ padding: i3.buttonTheme.padding, height: i3.buttonTheme.height, paddingLeft: 0, paddingRight: 0 }).add(this.buttonGroup), this.chart.styledMode || (this.zoomText.css(i3.labelStyle), a2["stroke-width"] = S(a2["stroke-width"], 0)), d("option", { textContent: this.zoomText.textStr, disabled: true }, void 0, p2), this.buttonOptions.forEach((e4, i4) => {
              d("option", { textContent: e4.title || e4.text }, void 0, p2), t2[i4] = r2.button(e4.text, 0, 0, (t3) => {
                let s2;
                let o3 = e4.events && e4.events.click;
                o3 && (s2 = o3.call(e4, t3)), false !== s2 && this.clickButton(i4), this.isActive = true;
              }, a2, n2 && n2.hover, n2 && n2.select, n2 && n2.disabled).attr({ "text-align": "center", width: c2 }).add(this.buttonGroup), e4.title && t2[i4].attr("title", e4.title);
            });
          }
          alignElements() {
            var _a;
            ...
            if (s2 && h2 && d2) {
              ...
              if (t2) {
                ...
                u2 -= i3.spacing[3];
                let o3 = p2(t2, h2);
                this.alignButtonGroup(o3), ((_a = this.buttonGroup) == null ? void 0 : _a.translateY) && this.dropdownLabel.attr({ y: this.buttonGroup.translateY }), s2.placed = t2.placed = i3.hasLoaded;
              }
              let l3 = 0;
              ...
              if ("bottom" === c2) {
                ...
                m2 = g2 - (f2 = f2 + (t3 && "bottom" === t3.verticalAlign && t3.enabled && !t3.floating ? i3.legend.legendHeight + S(t3.margin, 10) : 0) - 20) - (r2.floating ? 0 : r2.y) - (i3.titleOffset ? i3.titleOffset[2] : 0) - 10;
              }
          ...
          alignButtonGroup(t2, e3) {
            ...
            "right" === r2.align ? n2 += t2 - a2 : "center" === r2.align && (n2 -= a2 / 2), o2 && o2.align({ y: r2.y, width: S(e3, this.initialButtonGroupWidth), align: r2.align, x: n2 }, true, i3.spacingBox);
          }
          positionButtons() {
            ...
            s2 && "hidden" !== s2.visibility && (s2[o2]({ x: S(a2 + r2.x, a2) }), n2 += r2.x + s2.getBBox().width + 5);
            for (let e4 = 0, s3 = this.buttonOptions.length; e4 < s3; ++e4) "hidden" !== t2[e4].visibility ? (t2[e4][o2]({ x: n2 }), n2 += (t2[e4].width || 0) + i3.buttonSpacing) : t2[e4][o2]({ x: a2 });
          }
          handleCollision(t2) {
            let { chart: e3, buttonGroup: i3, inputGroup: s2 } = this, { buttonPosition: o2, dropdown: r2, inputPosition: a2 } = this.options, n2 = () => {
              ...
              if ((s2 == null ? void 0 : s2.alignOptions) && i3) {
                let r3 = s2.alignAttr.translateX + s2.alignOptions.x - t2 + s2.getBBox().x + 2, n3 = s2.alignOptions.width || 0, l3 = i3.alignAttr.translateX + i3.getBBox().x;
          ...
          collapseButtons() {
            let { buttons: t2, zoomText: e3 } = this;
          ...
          showDropdown() {
            let { buttonGroup: t2, chart: e3, dropdownLabel: i3, dropdown: s2 } = this;
            if (t2 && s2) {
              let { translateX: o2 = 0, translateY: r2 = 0 } = t2, a2 = e3.plotLeft + o2;
              i3.attr({ x: a2, y: r2 }).show(), c(s2, { left: a2 + "px", top: r2 + "px", visibility: "inherit" }), this.hasVisibleDropdown = true;
            }
          }
          hideDropdown() {
            let { dropdown: t2 } = this;
            t2 && (this.dropdownLabel.hide(), c(t2, { visibility: "hidden", width: "1px", height: "1px" }), this.hasVisibleDropdown = false);
          }
          getHeight() {
        ...
        let { format: l } = e2, { getOptions: h } = i2, { setFixedRange: d } = a, { addEvent: c, clamp: p, crisp: u, defined: g, extend: f, find: m, isNumber: x, isString: y, merge: b, pick: v, splat: S } = n;
        function k(t3, e3, i3) {
          var _a, _b;
        ...
        class C extends t2 {
          init(t3, e3) {
            ...
            t3.xAxis = a2, t3.yAxis = n2, d2.xAxis = S(t3.xAxis || {}).map((e4) => b(k("xAxis", e4, i3.xAxis), e4, M("xAxis", t3))), d2.yAxis = S(t3.yAxis || {}).map((t4) => b(k("yAxis", t4, i3.yAxis), t4)), super.init(d2, e3);
          }
          createAxis(t3, e3) {
            return e3.axis = b(k(t3, e3.axis, h()[t3]), e3.axis, M(t3, this.userOptions)), super.createAxis(t3, e3);
          }
        }
        return c(t2, "update", function(t3) {
          let e3 = t3.options;
          "scrollbar" in e3 && this.navigator && (b(true, this.options.scrollbar, e3.scrollbar), this.navigator.update({ enabled: !!this.navigator.navigatorEnabled }), delete e3.scrollbar);
        }), function(t3) {
          function e3(t4) {
            if (!this.crosshair || !this.crosshair.label || !this.crosshair.label.enabled || !this.cross || !x(this.min) || !x(this.max)) return;
            let e4 = this.chart, i4 = this.logarithmic, s3 = this.crosshair.label, o3 = this.horiz, r3 = this.opposite, a3 = this.left, n3 = this.top, h3 = this.width, d2 = "inside" === this.options.tickPosition, c2 = false !== this.crosshair.snap, p2 = t4.e || this.cross && this.cross.e, u2 = t4.point, g2 = this.crossLabel, m2, y2, b2 = s3.format, S2 = "", k2, M2 = 0, C2 = this.min, A = this.max;
            i4 && (C2 = i4.lin2log(this.min), A = i4.lin2log(this.max));
            let w = o3 ? "center" : r3 ? "right" === this.labelAlign ? "right" : "left" : "left" === this.labelAlign ? "left" : "center";
            g2 || (g2 = this.crossLabel = e4.renderer.label("", 0, void 0, s3.shape || "callout").addClass("highcharts-crosshair-label highcharts-color-" + (u2 && u2.series ? u2.series.colorIndex : this.series[0] && this.series[0].colorIndex)).attr({ align: s3.align || w, padding: v(s3.padding, 8), r: v(s3.borderRadius, 3), zIndex: 2 }).add(this.labelGroup), e4.styledMode || g2.attr({ fill: s3.backgroundColor || u2 && u2.series && u2.series.color || "#666666", stroke: s3.borderColor || "", "stroke-width": s3.borderWidth || 0 }).css(f({ color: "#ffffff", fontWeight: "normal", fontSize: "0.7em", textAlign: "center" }, s3.style || {}))), o3 ? (m2 = c2 ? (u2.plotX || 0) + a3 : p2.chartX, y2 = n3 + (r3 ? 0 : this.height)) : (m2 = a3 + this.offset + (r3 ? h3 : 0), y2 = c2 ? (u2.plotY || 0) + n3 : p2.chartY), b2 || s3.formatter || (this.dateTime && (S2 = "%b %d, %Y"), b2 = "{value" + (S2 ? ":" + S2 : "") + "}");
            let T = c2 ? this.isXAxis ? u2.x : u2.y : this.toValue(o3 ? p2.chartX : p2.chartY), P = u2 && u2.series ? u2.series.isPointInside(u2) : x(T) && T > C2 && T < A, O = "";
            b2 ? O = l(b2, { value: T }, e4) : s3.formatter && x(T) && (O = s3.formatter.call(this, T)), g2.attr({ text: O, x: m2, y: y2, visibility: P ? "inherit" : "hidden" });
            let L = g2.getBBox();
            !x(g2.x) || o3 || r3 || (m2 = g2.x - L.width / 2), x(g2.y) && (o3 ? (d2 && !r3 || !d2 && r3) && (y2 = g2.y - L.height) : y2 = g2.y - L.height / 2), k2 = o3 ? { left: a3, right: a3 + this.width } : { left: "left" === this.labelAlign ? a3 : 0, right: "right" === this.labelAlign ? a3 + this.width : e4.chartWidth };
            let D = g2.translateX || 0;
            D < k2.left && (M2 = k2.left - D), D + L.width >= k2.right && (M2 = -(D + L.width - k2.right)), g2.attr({ x: m2 + M2, y: y2, anchorX: o3 ? m2 : this.opposite ? 0 : e4.chartWidth, anchorY: o3 ? this.opposite ? e4.chartHeight : 0 : y2 + L.height / 2 });
          }
          function i3() {
          ...
          function r2(t4) {
            let e4 = this, i4 = e4.isLinked && !e4.series && e4.linkedParent ? e4.linkedParent.series : e4.series, s3 = e4.chart, o3 = s3.renderer, r3 = e4.left, a3 = e4.top, n3 = [], l2 = t4.translatedValue, h3 = t4.value, d2 = t4.force, c2, u2, f2, b2, S2 = [], k2, M2;
            if (s3.options.isStock && false !== t4.acrossPanes && "xAxis" === e4.coll || "yAxis" === e4.coll) {
              for (let o4 of (t4.preventDefault(), S2 = ((t5) => {
                ...
                return x(r4) ? [s3[o5][r4]] : y(r4) ? [s3.get(r4)] : i4.map((t6) => t6[o5]);
              })(e4.coll), e4.isXAxis ? s3.yAxis : s3.xAxis)) if (!o4.options.isInternal) {
                let t5 = o4.isXAxis ? "yAxis" : "xAxis";
                e4 === (g(o4.options[t5]) ? s3[t5][o4.options[t5]] : s3[t5][0]) && S2.push(o4);
              }
              for (let t5 of (k2 = S2.length ? [] : [e4.isXAxis ? s3.yAxis[0] : s3.xAxis[0]], S2)) -1 !== k2.indexOf(t5) || m(k2, (e5) => e5.pos === t5.pos && e5.len === t5.len) || k2.push(t5);
              if (x(M2 = v(l2, e4.translate(h3 || 0, void 0, void 0, t4.old)))) {
                if (e4.horiz) for (let t5 of k2) {
                  let i5;
                  b2 = (u2 = t5.pos) + t5.len, c2 = f2 = Math.round(M2 + e4.transB), "pass" !== d2 && (c2 < r3 || c2 > r3 + e4.width) && (d2 ? c2 = f2 = p(c2, r3, r3 + e4.width) : i5 = true), i5 || n3.push(["M", c2, u2], ["L", f2, b2]);
                }
                else for (let t5 of k2) {
                  let i5;
                  f2 = (c2 = t5.pos) + t5.len, u2 = b2 = Math.round(a3 + e4.height - M2), "pass" !== d2 && (u2 < a3 || u2 > a3 + e4.height) && (d2 ? u2 = b2 = p(u2, a3, a3 + e4.height) : i5 = true), i5 || n3.push(["M", c2, u2], ["L", f2, b2]);
                }
              }
        ...
        let { composed: r } = t2, { hlc: a } = s.seriesTypes, { addEvent: n, crisp: l, extend: h, merge: d, pushUnique: c } = o;
        function p(t3) {
        ...
        class g extends a {
          static compose(t3, ...e3) {
            c(r, "OHLCSeries") && (n(t3, "afterSetOptions", p), n(t3, "init", u));
          }
          getPointPath(t3, e3) {
        ...
        class n extends o {
          ...
          drawPoints() {
            ...
            for (let s2 of t3) {
              let t4 = s2.graphic, o2, a2, n2, l, h, d, c, p, u, g = !t4;
              if (void 0 !== s2.plotY) {
        ...
        return function(t3) {
          ...
          function i3() {
            ...
            let t4 = this, e4 = t4.options, i4 = t4.chart, s2 = t4.points, o2 = e4.onSeries, r2 = o2 && i4.get(o2), n2 = r2 && r2.options.step, h2 = r2 && r2.points, c = i4.inverted, p = t4.xAxis, u = t4.yAxis, g = s2.length - 1, f, m, x = e4.onKey || "y", y = h2 && h2.length, b = 0, v, S, k, M, C;
            if (r2 && r2.visible && y) {
              for (b = (r2.pointXOffset || 0) + (r2.barW || 0) / 2, M = r2.currentDataGrouping, S = h2[y - 1].x + (M ? M.totalRange : 0), d(s2, (t5, e5) => t5.x - e5.x), x = "plot" + x[0].toUpperCase() + x.substr(1); y-- && s2[g]; ) if (v = h2[y], (f = s2[g]).y = v.y, v.x <= f.x && void 0 !== v[x]) {
                if (f.x <= S && (f.plotY = v[x], v.x < f.x && !n2 && (k = h2[y + 1]) && void 0 !== k[x])) {
                  if (l(f.plotX) && r2.is("spline")) {
                    let t5 = [v.plotX || 0, v.plotY || 0], e5 = [k.plotX || 0, k.plotY || 0], i5 = ((_a = v.controlPoints) == null ? void 0 : _a.high) || t5, s3 = ((_b = k.controlPoints) == null ? void 0 : _b.low) || e5, o3 = (o4, r4) => Math.pow(1 - o4, 3) * t5[r4] + 3 * (1 - o4) * (1 - o4) * o4 * i5[r4] + 3 * (1 - o4) * o4 * o4 * s3[r4] + o4 * o4 * o4 * e5[r4], r3 = 0, a2 = 1, n3;
                  ...
                  } else C = (f.x - v.x) / (k.x - v.x), f.plotY += C * (k[x] - v[x]), f.y += C * (k.y - v.y);
                }
                if (g--, y++, g < 0) break;
              }
            }
        ...
        let { noop: h } = s, { distribute: d } = r, { series: c, seriesTypes: { column: p } } = a, { addEvent: u, defined: g, extend: f, isNumber: m, merge: x, objectEach: y, wrap: b } = l;
        class v extends p {
          animate(t3) {
            t3 && this.setClip();
          }
          drawPoints() {
            ...
            let u2 = this.points, f2 = this.chart, v2 = f2.renderer, S = f2.inverted, k = this.options, M = k.y, C = this.yAxis, A = {}, w = [], T = m(k.borderRadius) ? k.borderRadius : 0;
            for (s2 = u2.length; s2--; ) o2 = u2[s2], c2 = (S ? o2.plotY : o2.plotX) > this.xAxis.len, t3 = o2.plotX, a2 = o2.stackIndex, i3 = o2.options.shape || k.shape, void 0 !== (e3 = o2.plotY) && (e3 = o2.plotY + M - (void 0 !== a2 && a2 * k.stackDistance)), o2.anchorX = a2 ? void 0 : o2.plotX, l2 = a2 ? void 0 : o2.plotY, p2 = "flag" !== i3, r2 = o2.graphic, void 0 !== e3 && t3 >= 0 && !c2 ? (r2 && o2.hasNewShapeType() && (r2 = r2.destroy()), r2 || (r2 = o2.graphic = v2.label("", 0, void 0, i3, void 0, void 0, k.useHTML).addClass("highcharts-point").add(this.markerGroup), o2.graphic.div && (o2.graphic.div.point = o2), r2.isNew = true), r2.attr({ align: p2 ? "center" : "left", width: k.width, height: k.height, "text-align": k.textAlign, r: T }), f2.styledMode || r2.attr(this.pointAttribs(o2)).css(x(k.style, o2.style)).shadow(k.shadow), t3 > 0 && (t3 -= r2.strokeWidth() % 2), h2 = { y: e3, anchorY: l2 }, k.allowOverlapX && (h2.x = t3, h2.anchorX = o2.anchorX), r2.attr({ text: o2.options.title ?? k.title ?? "A" })[r2.isNew ? "attr" : "animate"](h2), k.allowOverlapX || (A[o2.plotX] ? A[o2.plotX].size = Math.max(A[o2.plotX].size, r2.width || 0) : A[o2.plotX] = { align: p2 ? 0.5 : 0, size: r2.width || 0, target: t3, anchorX: t3 }), o2.tooltipPos = [t3, e3 + C.pos - f2.plotTop]) : r2 && (o2.graphic = r2.destroy());
            if (!k.allowOverlapX) {
              let t4 = 100;
              for (let e4 of (y(A, function(e5) {
                e5.plotX = e5.anchorX, w.push(e5), t4 = Math.max(e5.size, t4);
              }), d(w, S ? C.len : this.xAxis.len, t4), u2)) {
                let t5 = e4.plotX, i4 = e4.graphic, s3 = i4 && A[t5];
            ...
            k.useHTML && this.markerGroup && b(this.markerGroup, "on", function(t4) {
        ...
        return v.compose = i2.compose, v.defaultOptions = x(p.defaultOptions, e2), o.compose(v), f(v.prototype, { allowDG: false, forceCrop: true, invertible: false, noSharedTooltip: true, pointClass: t2, sorted: false, takeOrdinalPosition: false, trackerGroups: ["markerGroup"], buildKDTree: h, init: c.prototype.init }), a.registerSeriesType("flags", v), v;
        ...
        return function(e3) {
          ...
          class m {
            ...
            isInAnyBreak(t3, e4) {
              ...
              if (o2 && n(t3)) {
                for (; o2--; ) m.isInBreak(s2[o2], t3) && (r2 = true, a2 || (a2 = l(s2[o2].showPoints, !i4.isXAxis)));
                h2 = r2 && e4 ? r2 && !a2 : r2;
              }
              return h2;
            }
                ...
                if (s2.constructor.prototype.setAxisTranslation.call(this), i4.unitLength = void 0, i4.hasBreaks) {
                  ...
                  t4.forEach(function(t5) {
                    ...
                    if (g2 = t5.from, c2 = t5.repeat || 1 / 0, n(p2) && n(u2)) {
                      for (; g2 - c2 > p2; ) g2 -= c2;
                      for (; g2 < p2; ) g2 += c2;
                      for (f2 = g2; f2 < u2; f2 += c2) e5.push({ value: f2, move: "in" }), e5.push({ value: f2 + t5.to - t5.from, move: "out", size: t5.breakSize });
                    }
        ...
        function f(t3) {
          ...
          if (y2 && (this.requireSorting = false), b2) return;
          this.destroyGroupedData();
          let v2 = d2.groupAll ? this.xData : this.processedXData, S = d2.groupAll ? this.yData : this.processedYData, k = n2.plotSizeX, M = this.xAxis, C = M.options.ordinal, A = this.groupPixelWidth;
          if (A && v2 && v2.length && k) {
            r2 = true, this.isDirty = true, this.points = null;
            let t4 = M.getExtremes(), p3 = t4.min, u2 = t4.max, f3 = C && M.ordinal && M.ordinal.getGroupIntervalFactor(p3, u2, this) || 1, y3 = A * (u2 - p3) / k * f3, b3 = M.getTimeTicks(i2.Additions.prototype.normalizeTimeTickInterval(y3, d2.units || e2.units), Math.min(p3, v2[0]), Math.max(u2, v2[v2.length - 1]), M.options.startOfWeek, v2, this.closestPointRange), w = a.groupData.apply(this, [v2, S, b3, d2.approximation]), T = w.groupedXData, P = w.groupedYData, O = 0;
            for (d2 && d2.smoothed && T.length && (d2.firstAnchor = "firstPoint", d2.anchor = "middle", d2.lastAnchor = "lastPoint", h(32, false, n2, { "dataGrouping.smoothed": "use dataGrouping.anchor" })), o2 = 1; o2 < b3.length; o2++) b3.info.segmentStarts && -1 !== b3.info.segmentStarts.indexOf(o2) || (O = Math.max(b3[o2] - b3[o2 - 1], O));
            (m2 = b3.info).gapSize = O, this.closestPointRange = b3.info.totalRange, this.groupMap = w.groupMap, this.currentDataGrouping = m2, function(t5, e3, i3) {
            ...
            }(this, T, u2), g2 && (l((s2 = T)[0]) && c(M.min) && c(M.dataMin) && s2[0] < M.min && ((!l(M.options.min) && M.min <= M.dataMin || M.min === M.dataMin) && (M.min = Math.min(s2[0], M.min)), M.dataMin = Math.min(s2[0], M.dataMin)), l(s2[s2.length - 1]) && c(M.max) && c(M.dataMax) && s2[s2.length - 1] > M.max && ((!l(M.options.max) && c(M.dataMax) && M.max >= M.dataMax || M.max === M.dataMax) && (M.max = Math.max(s2[s2.length - 1], M.max)), M.dataMax = Math.max(s2[s2.length - 1], M.dataMax))), d2.groupAll && (this.allGroupedData = P, T = (x2 = this.cropData(T, P, M.min, M.max)).xData, P = x2.yData, this.cropStart = x2.start), this.processedXData = T, this.processedYData = P;
        ...
        function b(e3, i3, s2, o2) {
          let r2 = this, a2 = r2.data, n2 = r2.options && r2.options.data, h2 = [], d2 = [], u2 = [], g2 = e3.length, f2 = !!i3, m2 = [], x2 = r2.pointArrayMap, y2 = x2 && x2.length, b2 = ["x"].concat(x2 || ["y"]), v2 = this.options.dataGrouping && this.options.dataGrouping.groupAll, S, k, M, C = 0, A = 0, w = "function" == typeof o2 ? o2 : o2 && t2[o2] ? t2[o2] : t2[r2.getDGApproximation && r2.getDGApproximation() || "average"];
          if (y2) {
            let t3 = x2.length;
            for (; t3--; ) m2.push([]);
          } else m2.push([]);
          ...
          for (let t3 = 0; t3 <= g2; t3++) if (!(e3[t3] < s2[0])) {
            for (; void 0 !== s2[C + 1] && e3[t3] >= s2[C + 1] || t3 === g2; ) {
              S = s2[C], r2.dataGroupInfo = { start: v2 ? A : r2.cropStart + A, length: m2[0].length, groupStart: S }, M = w.apply(r2, m2), r2.pointClass && !l(r2.dataGroupInfo.options) && (r2.dataGroupInfo.options = p(r2.pointClass.prototype.optionsToObject.call({ series: r2 }, r2.options.data[r2.cropStart + A])), b2.forEach(function(t4) {
                delete r2.dataGroupInfo.options[t4];
              })), void 0 !== M && (h2.push(S), d2.push(M), u2.push(r2.dataGroupInfo)), A = t3;
              for (let t4 = 0; t4 < T; t4++) m2[t4].length = 0, m2[t4].hasNulls = false;
              if (C += 1, t3 === g2) break;
            }
            if (t3 === g2) break;
            if (x2) {
              ...
              for (let t4 = 0; t4 < y2; t4++) c(e4 = s3[x2[t4]]) ? m2[t4].push(e4) : null === e4 && (m2[t4].hasNulls = true);
            } else c(k = f2 ? i3[t3] : null) ? m2[0].push(k) : null === k && (m2[0].hasNulls = true);
          }
        ...
        function u(t3) {
          ...
          if (g && "datetime" === g.options.type && u2 && d(o2.key)) {
            ...
            let l3 = c((_a = r2.groupMap) == null ? void 0 : _a[n2.index].groupStart, o2.key), d2 = l3 + (x == null ? void 0 : x.totalRange) - 1;
        ...
        function u() {
          ...
          t3.enabled && s(this.container, "wheel", (e3) => {
            ...
            if (this.isInsidePlot(e3.chartX - this.plotLeft, e3.chartY - this.plotTop) && s2) {
              ...
              p(this, Math.pow(s3, o2), r2 ? [r2.axis] : this.xAxis, a2 ? [a2.axis] : this.yAxis, e3.chartX, e3.chartY, t3) && ((_b = e3.preventDefault) == null ? void 0 : _b.call(e3));
            }
          });
        }
        return { compose: function(t3) {
