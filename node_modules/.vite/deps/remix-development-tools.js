import {
  ...
  serializeStyles
} from "./chunk-G67QOWCP.js";
import {
  $addc16e1bbe58fd0$export$3a72a57244d6e765
} from "./chunk-LNAK4D7V.js";
import {
  _extends
...
import {
  createCollection
} from "./chunk-PKOBUDR5.js";
import {
  useDirection
} from "./chunk-2XG6YO57.js";
import {
  useId
} from "./chunk-6JYGHC6U.js";
import {
  useControllableState
} from "./chunk-4UIJD6M6.js";
import {
  composeEventHandlers
} from "./chunk-OD433RWB.js";
import {
  useLayoutEffect2
} from "./chunk-HJOO75GU.js";
import {
  createContextScope
} from "./chunk-KII7BNBA.js";
import {
  Primitive
} from "./chunk-7MYKCDSQ.js";
import {
  useComposedRefs
...
var $7e8f5cd07187803e$export$21b07c8f274aebd5 = (0, import_react13.forwardRef)((props, forwardedRef) => {
  ...
  }), props.asChild ? children2 : (0, import_react13.createElement)("polygon", {
...
var $cc7e05a45900e73f$export$ef9b1a59e592288f = (props) => {
  ...
  }, children2)), isFormControl ? (0, import_react20.createElement)($cc7e05a45900e73f$var$BubbleSelect, {
    key: nativeSelectKey,
    "aria-hidden": true,
    required,
    tabIndex: -1,
...
var RDTContext = (0, import_react22.createContext)({ state: initialState, dispatch: () => null });
...
var RDTContextProvider = ({ children: children2 }) => {
  const [state, dispatch2] = (0, import_react22.useReducer)(rdtReducer, getExistingStateFromStorage());
  const value = (0, import_react22.useMemo)(() => ({ state, dispatch: dispatch2 }), [state, dispatch2]);
  useRemoveBody(state);
...
var useRDTContext = () => {
  const context = (0, import_react26.useContext)(RDTContext);
  if (context === void 0) {
...
var useHtmlErrors = () => {
  ...
  const setHtmlErrors = (0, import_react26.useCallback)(
    (htmlErrors2) => {
      dispatch2({
...
var useServerInfo = () => {
  const { state, dispatch: dispatch2 } = useRDTContext();
  const { server } = state;
  const setServerInfo = (0, import_react26.useCallback)(
    (serverInfo) => {
      dispatch2({
...
var useDetachedWindowControls = () => {
  ...
  const setDetachedWindowOwner = (0, import_react26.useCallback)(
...
var useSettingsContext = () => {
  ...
  const setSettings = (0, import_react26.useCallback)(
    (settings2) => {
      dispatch2({
        type: "SET_SETTINGS",
        payload: settings2
...
var usePersistOpen = () => {
  ...
  const setPersistOpen = (0, import_react26.useCallback)(
    (persistOpen2) => {
      dispatch2({
...
var useTimelineContext = () => {
  ...
  const setTimelineEvent = (0, import_react26.useCallback)(
    (payload) => {
      dispatch2({ type: "SET_TIMELINE_EVENT", payload });
    },
    [dispatch2]
  );
  const clearTimeline = (0, import_react26.useCallback)(() => {
...
var useTerminalContext = () => {
  ...
  const addOrRemoveTerminal = (0, import_react26.useCallback)(
    (terminalId) => {
      dispatch2({ type: "ADD_OR_REMOVE_TERMINAL", payload: terminalId });
    },
    [dispatch2]
  );
  const toggleTerminalLock = (0, import_react26.useCallback)(
    (terminalId, locked) => {
      dispatch2({
  ...
  const addTerminalOutput = (0, import_react26.useCallback)(
    (terminalId, output) => {
      dispatch2({
  ...
  const clearTerminalOutput = (0, import_react26.useCallback)(
    (terminalId) => {
      dispatch2({ type: "CLEAR_TERMINAL_OUTPUT", payload: terminalId });
    },
    [dispatch2]
  );
  const addTerminalHistory = (0, import_react26.useCallback)(
    (terminalId, history2) => {
      dispatch2({
  ...
  const setProcessId = (0, import_react26.useCallback)(
...
var useTimelineHandler = () => {
  ...
  const navigationEventQueue = (0, import_react25.useRef)([]);
  ...
  const fetcherEventQueue = (0, import_react25.useRef)([]);
  (0, import_react25.useEffect)(() => {
...
var useResize = () => {
  ...
  const [isResizing, setIsResizing] = (0, import_react28.useState)(false);
  const enableResize = (0, import_react28.useCallback)(() => {
    setIsResizing(true);
  }, [setIsResizing]);
  const disableResize = (0, import_react28.useCallback)(() => {
    setIsResizing(false);
  }, [setIsResizing]);
  const resize = (0, import_react28.useCallback)(
    (e) => {
      var _a2;
      if (isResizing) {
...
var useAttachListenerToNode = (listener, node, fn, shouldAttach = true) => {
  const callbackRef = (0, import_react30.useRef)(fn);
...
function useDebounce(callback, delay = 300) {
  const callbackRef = import_react31.default.useRef(callback);
  import_react31.default.useEffect(() => {
    callbackRef.current = callback;
  });
  return import_react31.default.useMemo(() => debounce((...args) => callbackRef.current(...args), delay), [delay]);
}
var useResizeDetachedPanel = () => {
  const { isDetached } = useDetachedWindowControls();
  const [state, setState] = (0, import_react29.useState)(0);
...
var useWebSocket = (url, options = DEFAULT_OPTIONS, connect = true) => {
  const [lastMessage, setLastMessage] = (0, import_react32.useState)(null);
  const [readyState, setReadyState] = (0, import_react32.useState)({});
  const lastJsonMessage = (0, import_react32.useMemo)(() => {
    if (lastMessage) {
      try {
  ...
  const convertedUrl = (0, import_react32.useRef)(null);
  const webSocketRef = (0, import_react32.useRef)(null);
  const startRef = (0, import_react32.useRef)(() => void 0);
  const reconnectCount = (0, import_react32.useRef)(0);
  const messageQueue = (0, import_react32.useRef)([]);
  const webSocketProxy = (0, import_react32.useRef)(null);
  const optionsCache = (0, import_react32.useRef)(options);
  ...
  const sendMessage = (0, import_react32.useCallback)((message, keep = true) => {
    var _a2;
  ...
  const sendJsonMessage = (0, import_react32.useCallback)(
    (message, keep = true) => {
      sendMessage(JSON.stringify(message), keep);
    },
    [sendMessage]
  );
  const getWebSocket = (0, import_react32.useCallback)(() => {
...
var useRemixForgeSocket = (options) => {
  ...
  const [retryCount, setRetryCount] = (0, import_react33.useState)(0);
  const opts = {
    ...options,
    share: true,
...
var useCountdown = (targetDate) => {
  ...
  const [countDown, setCountDown] = (0, import_react37.useState)(countDownDate - (/* @__PURE__ */ new Date()).getTime());
...
var initialState2 = {};
var Context = (0, import_react41.createContext)(initialState2);
...
var DispatchShowTools = (0, import_react41.createContext)(() => {
});
DispatchShowTools.displayName = "JVR.DispatchShowTools";
function useShowTools() {
  return (0, import_react41.useReducer)(reducer, initialState2);
}
function useShowToolsDispatch() {
  return (0, import_react41.useContext)(DispatchShowTools);
}
...
var initialState3 = {};
var Context2 = (0, import_react42.createContext)(initialState3);
var reducer2 = (state, action) => ({
  ...state,
  ...action
});
var useExpandsStore = () => {
  return (0, import_react42.useContext)(Context2);
};
var DispatchExpands = (0, import_react42.createContext)(() => {
});
DispatchExpands.displayName = "JVR.DispatchExpands";
function useExpands() {
  return (0, import_react42.useReducer)(reducer2, initialState3);
}
function useExpandsDispatch() {
  return (0, import_react42.useContext)(DispatchExpands);
}
...
var Context3 = (0, import_react43.createContext)(initialState4);
var reducer3 = (state, action) => ({
  ...state,
  ...action
});
var useTypesStore = () => {
  return (0, import_react43.useContext)(Context3);
};
var DispatchTypes = (0, import_react43.createContext)(() => {
});
DispatchTypes.displayName = "JVR.DispatchTypes";
function useTypes() {
  return (0, import_react43.useReducer)(reducer3, initialState4);
}
function useTypesDispatch() {
  return (0, import_react43.useContext)(DispatchTypes);
}
...
var Context4 = (0, import_react44.createContext)(initialState5);
var reducer4 = (state, action) => ({
  ...state,
  ...action
});
var useSymbolsStore = () => {
  return (0, import_react44.useContext)(Context4);
};
var DispatchSymbols = (0, import_react44.createContext)(() => {
});
DispatchSymbols.displayName = "JVR.DispatchSymbols";
function useSymbols() {
  return (0, import_react44.useReducer)(reducer4, initialState5);
}
function useSymbolsDispatch() {
  return (0, import_react44.useContext)(DispatchSymbols);
}
...
var Context5 = (0, import_react45.createContext)(initialState6);
var reducer5 = (state, action) => ({
  ...state,
  ...action
});
var useSectionStore = () => {
  return (0, import_react45.useContext)(Context5);
};
var DispatchSection = (0, import_react45.createContext)(() => {
});
DispatchSection.displayName = "JVR.DispatchSection";
function useSection() {
  return (0, import_react45.useReducer)(reducer5, initialState6);
}
function useSectionDispatch() {
  return (0, import_react45.useContext)(DispatchSection);
}
...
var Context6 = (0, import_react40.createContext)(initialState7);
Context6.displayName = "JVR.Context";
var DispatchContext = (0, import_react40.createContext)(() => {
});
...
var useStore = () => {
  return (0, import_react40.useContext)(Context6);
};
var Provider = ({
  children: children2,
  initialState: init2,
  ...
  const [state, dispatch2] = (0, import_react40.useReducer)(reducer6, Object.assign({}, initialState7, init2));
  ...
  (0, import_react40.useEffect)(() => dispatch2({ ...init2 }), [init2]);
...
var TypeString = ({ children: children2 = "", expandKey, keyName }) => {
  ...
  const [shorten, setShorten] = (0, import_react48.useState)(length && childrenStr.length >= length);
  const Comp = as || "span";
  const style = {
    ...defalutStyle,
    ...Str.style || {}
  ...
  return (0, import_jsx_runtime20.jsxs)(import_react48.Fragment, { children: [
    displayDataTypes && (type || (0, import_jsx_runtime20.jsx)(Comp, { ...reset, style })),
    child || (0, import_jsx_runtime20.jsxs)(import_react48.Fragment, { children: [
...
function useSymbolsRender(currentProps, props, key) {
  ...
  (0, import_react50.useEffect)(() => dispatch2({ [key]: reset }), [props]);
}
...
var KayName = (props) => {
  ...
  const highlightContainer = (0, import_react47.useRef)(null);
  useHighlight({ value, highlightUpdates, highlightContainer });
  return (0, import_jsx_runtime23.jsxs)(import_react47.Fragment, { children: [
...
var JsonView = (0, import_react39.forwardRef)((props, ref) => {
  const {
    className = "",
    style,
    value,
...
var JsonRenderer = ({ data }) => {
  const { settings } = useSettingsContext();
  const originalData = (0, import_react38.useMemo)(
  ...
  const [json, setJson] = (0, import_react38.useState)(originalData);
...
var PageTab = () => {
  ...
  const reversed = (0, import_react36.useMemo)(() => routes.reverse(), [routes]);
...
var NewRouteForm = () => {
  ...
  const [newRouteInfo, setNewRouteInfo] = (0, import_react56.useState)(DEFAULT_VALUES);
  const handleSubmit = () => {
...
var useListenToRouteChange = () => {
  ...
  const ref = (0, import_react58.useRef)(locationRoute);
...
var TransitionGroupContext_default = import_react62.default.createContext(null);
function getChildMapping(children2, mapFn) {
  let mapper = (child) => mapFn && (0, import_react63.isValidElement)(child) ? mapFn(child) : child;
  let result = /* @__PURE__ */ Object.create(null);
  if (children2)
    import_react63.Children.map(children2, (c) => c).forEach((child) => {
...
function getNextChildMapping(nextProps, prevChildMapping, onExited) {
  ...
  Object.keys(children2).forEach((key) => {
    ...
    const isLeaving = (0, import_react63.isValidElement)(prevChild) && !prevChild.props.in;
    if (hasNext && (!hasPrev || isLeaving)) {
      children2[key] = (0, import_react63.cloneElement)(child, {
        onExited: onExited.bind(null, child),
        in: true,
      ...
      children2[key] = (0, import_react63.cloneElement)(child, { in: false });
    } else if (hasNext && hasPrev && (0, import_react63.isValidElement)(prevChild)) {
      children2[key] = (0, import_react63.cloneElement)(child, {
        onExited: onExited.bind(null, child),
...
var TransitionGroup = class extends import_react61.default.Component {
...
var Node2 = class extends import_react64.default.Component {
  constructor() {
    super(...arguments);
...
var Link2 = class extends import_react65.default.PureComponent {
  constructor() {
    super(...arguments);
...
`;
var _a;
var Tree = (_a = class extends import_react60.default.Component {
  constructor() {
    super(...arguments);
    __publicField(this, "state", {
...
var RoutesTab = () => {
  ...
  const { detachedWindow } = useDetachedWindowControls();
  const [activeRoute, setActiveRoute] = (0, import_react54.useState)(null);
  const [routes] = (0, import_react54.useState)(createExtendedRoutes());
  const [treeRoutes] = (0, import_react54.useState)(createRouteTree(window.__remixManifest.routes));
  const isTreeView = routeViewMode === "tree";
...
var useTerminalShortcuts = ({
  ...
  const [historyIndex, setHistoryIndex] = (0, import_react67.useState)();
  const [projectCommandIndex, setProjectCommandIndex] = (0, import_react67.useState)();
...
var Terminal = ({ onClose, terminal, projectCommands }) => {
  ...
  const [command, setCommand] = (0, import_react66.useState)("");
...
var TerminalTab = () => {
  ...
  const [projectCommands, setProjectCommands] = (0, import_react66.useState)();
  const { sendJsonMessage } = useRemixForgeSocket({
    onMessage: (message) => {
      try {
        const data = JSON.parse(message.data);
...
var SettingsTab = () => {
  const { settings, setSettings } = useSettingsContext();
  const [minHeight, setMinHeight] = (0, import_react68.useState)(settings.minHeight.toString());
  const [maxHeight, setMaxHeight] = (0, import_react68.useState)(settings.maxHeight.toString());
  const [expansionLevel, setExpansionLevel] = (0, import_react68.useState)(settings.expansionLevel.toString());
  const [wsPort, setWsPort] = (0, import_react68.useState)(settings.wsPort.toString());
...
var ErrorsTab = () => {
  ...
  const [SSRHtml, setSSRHtml] = (0, import_react69.useState)("");
  const [CSRHtml, setCSRHtml] = (0, import_react69.useState)("");
  const [hasHydrationMismatch, setHasHydrationMismatch] = (0, import_react69.useState)(false);
...
var useTabs = (isConnected, isConnecting, pluginsArray) => {
  ...
  const allTabs = (0, import_react34.useMemo)(() => [...tabs, ...plugins ? plugins : []], [plugins]);
  const { Component, hideTimeline } = (0, import_react34.useMemo)(() => {
  ...
  const visibleTabs = (0, import_react34.useMemo)(
...
var ContentPanel = ({ plugins }) => {
  ...
  return (0, import_jsx_runtime56.jsxs)("div", { className: "rdt-flex rdt-h-full rdt-w-full rdt-overflow-y-hidden", children: [
    ...
    !hideTimeline && (0, import_jsx_runtime56.jsxs)(import_react71.Fragment, { children: [
...
function useBorderedRoutes() {
  const invalidHtmlCollection = (0, import_react72.useRef)([]);
  ...
  const navigation = useNavigation();
  const traverseComponentTree = (0, import_react72.useCallback)((fiberNode, callback) => {
    callback(fiberNode);
  ...
  const styleNearestElement = (0, import_react72.useCallback)((fiberNode) => {
    var _a2, _b;
    if (!fiberNode)
      return;
  ...
  const findIncorrectHtml = (0, import_react72.useCallback)((fiberNode, originalFiberNode, originalTag) => {
    if (!fiberNode)
      return;
...
var useCheckIfStillDetached = () => {
  const { dispatch: dispatch2 } = (0, import_react74.useContext)(RDTContext);
  const [checking, setChecking] = (0, import_react74.useState)(false);
  ...
  const checkDetachment = (0, import_react74.useCallback)(
    (e) => {
...
var useSetRouteBoundaries = () => {
  ...
  const { settings, setSettings } = useSettingsContext();
  const { detachedWindow } = useDetachedWindowControls();
  const applyOrRemoveClasses = (0, import_react75.useCallback)(
    (isHovering) => {
...
var DevTools = ({ plugins: pluginArray }) => {
  ...
  const [isOpen, setIsOpen] = (0, import_react21.useState)(isDetached || settings.defaultOpen || persistOpen);
...
function useHydrated() {
  const [hydrated, setHydrated] = (0, import_react78.useState)(() => !hydrating);
  (0, import_react78.useEffect)(function hydrate() {
    hydrating = false;
    setHydrated(true);
  }, []);
  return hydrated;
...
function useHydrated2() {
  const [hydrated, setHydrated] = (0, import_react79.useState)(() => !hydrating2);
