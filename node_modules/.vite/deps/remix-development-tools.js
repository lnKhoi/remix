...
<<<<<<< Updated upstream
<<<<<<< Updated upstream
} from "./chunk-ODL3LN5V.js";
=======
} from "./chunk-BFMDCTQK.js";
>>>>>>> Stashed changes
=======
} from "./chunk-BFMDCTQK.js";
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
<<<<<<< Updated upstream
} from "./chunk-KWKRNSFN.js";
import {
  useComposedRefs
} from "./chunk-BZJKQTX3.js";
import {
  Link,
  useActionData,
  useMatches
...
=======
} from "./chunk-PCWWMDOJ.js";
import {
  useComposedRefs
} from "./chunk-OXCMPPQ7.js";
...
var $7e8f5cd07187803e$export$21b07c8f274aebd5 = (0, import_react14.forwardRef)((props, forwardedRef) => {
  ...
  }), props.asChild ? children2 : (0, import_react14.createElement)("polygon", {
...
var $cf1ac5d9fe0e8206$export$bc4ae5855d3c4fc = (0, import_react16.forwardRef)((props, forwardedRef) => {
  ...
  const [arrow2, setArrow] = (0, import_react16.useState)(null);
...
var $cc7e05a45900e73f$export$ef9b1a59e592288f = (props) => {
  ...
  }, children2)), isFormControl ? (0, import_react21.createElement)($cc7e05a45900e73f$var$BubbleSelect, {
    key: nativeSelectKey,
    "aria-hidden": true,
    required,
    tabIndex: -1,
...
var RDTContext = (0, import_react23.createContext)({ state: initialState, dispatch: () => null });
...
var RDTContextProvider = ({ children: children2 }) => {
  const [state, dispatch2] = (0, import_react23.useReducer)(rdtReducer, getExistingStateFromStorage());
  const value = (0, import_react23.useMemo)(() => ({ state, dispatch: dispatch2 }), [state, dispatch2]);
  useRemoveBody(state);
...
var useRDTContext = () => {
  const context = (0, import_react27.useContext)(RDTContext);
  if (context === void 0) {
...
var useHtmlErrors = () => {
  ...
  const setHtmlErrors = (0, import_react27.useCallback)(
    (htmlErrors2) => {
      dispatch2({
...
var useServerInfo = () => {
  const { state, dispatch: dispatch2 } = useRDTContext();
  const { server } = state;
  const setServerInfo = (0, import_react27.useCallback)(
    (serverInfo) => {
      dispatch2({
...
var useDetachedWindowControls = () => {
  ...
  const setDetachedWindowOwner = (0, import_react27.useCallback)(
...
var useSettingsContext = () => {
  ...
  const setSettings = (0, import_react27.useCallback)(
    (settings2) => {
      dispatch2({
        type: "SET_SETTINGS",
        payload: settings2
...
var usePersistOpen = () => {
  ...
  const setPersistOpen = (0, import_react27.useCallback)(
    (persistOpen2) => {
      dispatch2({
...
var useTimelineContext = () => {
  ...
  const setTimelineEvent = (0, import_react27.useCallback)(
    (payload) => {
      dispatch2({ type: "SET_TIMELINE_EVENT", payload });
    },
    [dispatch2]
  );
  const clearTimeline = (0, import_react27.useCallback)(() => {
...
var useTerminalContext = () => {
  ...
  const addOrRemoveTerminal = (0, import_react27.useCallback)(
    (terminalId) => {
      dispatch2({ type: "ADD_OR_REMOVE_TERMINAL", payload: terminalId });
    },
    [dispatch2]
  );
  const toggleTerminalLock = (0, import_react27.useCallback)(
    (terminalId, locked) => {
      dispatch2({
  ...
  const addTerminalOutput = (0, import_react27.useCallback)(
    (terminalId, output) => {
      dispatch2({
  ...
  const clearTerminalOutput = (0, import_react27.useCallback)(
    (terminalId) => {
      dispatch2({ type: "CLEAR_TERMINAL_OUTPUT", payload: terminalId });
    },
    [dispatch2]
  );
  const addTerminalHistory = (0, import_react27.useCallback)(
    (terminalId, history2) => {
      dispatch2({
  ...
  const setProcessId = (0, import_react27.useCallback)(
...
var useTimelineHandler = () => {
  ...
  const navigationEventQueue = (0, import_react26.useRef)([]);
  ...
  const fetcherEventQueue = (0, import_react26.useRef)([]);
  (0, import_react26.useEffect)(() => {
...
var useResize = () => {
  ...
  const enableResize = (0, import_react29.useCallback)(() => {
    setIsResizing(true);
  }, [setIsResizing]);
  const disableResize = (0, import_react29.useCallback)(() => {
    setIsResizing(false);
  }, [setIsResizing]);
  const resize = (0, import_react29.useCallback)(
    (e) => {
      var _a2;
      if (isResizing) {
...
var useAttachListenerToNode = (listener, node, fn, shouldAttach = true) => {
  const callbackRef = (0, import_react31.useRef)(fn);
...
function useDebounce(callback, delay = 300) {
  const callbackRef = import_react32.default.useRef(callback);
  import_react32.default.useEffect(() => {
    callbackRef.current = callback;
  });
  return import_react32.default.useMemo(() => debounce((...args) => callbackRef.current(...args), delay), [delay]);
}
var useResizeDetachedPanel = () => {
  const { isDetached } = useDetachedWindowControls();
  const [state, setState] = (0, import_react30.useState)(0);
...
var useWebSocket = (url, options = DEFAULT_OPTIONS, connect = true) => {
  const [lastMessage, setLastMessage] = (0, import_react33.useState)(null);
  const [readyState, setReadyState] = (0, import_react33.useState)({});
  const lastJsonMessage = (0, import_react33.useMemo)(() => {
    if (lastMessage) {
      try {
  ...
  const convertedUrl = (0, import_react33.useRef)(null);
  const webSocketRef = (0, import_react33.useRef)(null);
  const startRef = (0, import_react33.useRef)(() => void 0);
  const reconnectCount = (0, import_react33.useRef)(0);
  const messageQueue = (0, import_react33.useRef)([]);
  const webSocketProxy = (0, import_react33.useRef)(null);
  const optionsCache = (0, import_react33.useRef)(options);
  ...
  const sendMessage = (0, import_react33.useCallback)((message, keep = true) => {
    var _a2;
  ...
  const sendJsonMessage = (0, import_react33.useCallback)(
    (message, keep = true) => {
      sendMessage(JSON.stringify(message), keep);
    },
    [sendMessage]
  );
  const getWebSocket = (0, import_react33.useCallback)(() => {
...
var useCountdown = (targetDate) => {
  ...
  const [countDown, setCountDown] = (0, import_react38.useState)(countDownDate - (/* @__PURE__ */ new Date()).getTime());
...
var initialState2 = {};
var Context = (0, import_react42.createContext)(initialState2);
...
var DispatchShowTools = (0, import_react42.createContext)(() => {
});
DispatchShowTools.displayName = "JVR.DispatchShowTools";
function useShowTools() {
  return (0, import_react42.useReducer)(reducer, initialState2);
}
function useShowToolsDispatch() {
  return (0, import_react42.useContext)(DispatchShowTools);
}
...
var initialState3 = {};
var Context2 = (0, import_react43.createContext)(initialState3);
var reducer2 = (state, action) => ({
  ...state,
  ...action
});
var useExpandsStore = () => {
  return (0, import_react43.useContext)(Context2);
};
var DispatchExpands = (0, import_react43.createContext)(() => {
});
DispatchExpands.displayName = "JVR.DispatchExpands";
function useExpands() {
  return (0, import_react43.useReducer)(reducer2, initialState3);
}
function useExpandsDispatch() {
  return (0, import_react43.useContext)(DispatchExpands);
}
...
var Context3 = (0, import_react44.createContext)(initialState4);
var reducer3 = (state, action) => ({
  ...state,
  ...action
});
var useTypesStore = () => {
  return (0, import_react44.useContext)(Context3);
};
var DispatchTypes = (0, import_react44.createContext)(() => {
});
DispatchTypes.displayName = "JVR.DispatchTypes";
function useTypes() {
  return (0, import_react44.useReducer)(reducer3, initialState4);
}
function useTypesDispatch() {
  return (0, import_react44.useContext)(DispatchTypes);
}
...
var Context4 = (0, import_react45.createContext)(initialState5);
var reducer4 = (state, action) => ({
  ...state,
  ...action
});
var useSymbolsStore = () => {
  return (0, import_react45.useContext)(Context4);
};
var DispatchSymbols = (0, import_react45.createContext)(() => {
});
DispatchSymbols.displayName = "JVR.DispatchSymbols";
function useSymbols() {
  return (0, import_react45.useReducer)(reducer4, initialState5);
}
function useSymbolsDispatch() {
  return (0, import_react45.useContext)(DispatchSymbols);
}
...
var Context5 = (0, import_react46.createContext)(initialState6);
var reducer5 = (state, action) => ({
  ...state,
  ...action
});
var useSectionStore = () => {
  return (0, import_react46.useContext)(Context5);
};
var DispatchSection = (0, import_react46.createContext)(() => {
});
DispatchSection.displayName = "JVR.DispatchSection";
function useSection() {
  return (0, import_react46.useReducer)(reducer5, initialState6);
}
function useSectionDispatch() {
  return (0, import_react46.useContext)(DispatchSection);
}
...
var Context6 = (0, import_react41.createContext)(initialState7);
Context6.displayName = "JVR.Context";
var DispatchContext = (0, import_react41.createContext)(() => {
});
...
var useStore = () => {
  return (0, import_react41.useContext)(Context6);
};
var Provider = ({
  children: children2,
  initialState: init2,
  ...
  const [state, dispatch2] = (0, import_react41.useReducer)(reducer6, Object.assign({}, initialState7, init2));
  ...
  (0, import_react41.useEffect)(() => dispatch2({ ...init2 }), [init2]);
...
var TypeString = ({ children: children2 = "", expandKey, keyName }) => {
  ...
  const [shorten, setShorten] = (0, import_react49.useState)(length && childrenStr.length >= length);
  const Comp = as || "span";
  const style = {
    ...defalutStyle,
    ...Str.style || {}
  ...
  return (0, import_jsx_runtime20.jsxs)(import_react49.Fragment, { children: [
    displayDataTypes && (type || (0, import_jsx_runtime20.jsx)(Comp, { ...reset, style })),
    child || (0, import_jsx_runtime20.jsxs)(import_react49.Fragment, { children: [
...
function useSymbolsRender(currentProps, props, key) {
  ...
  (0, import_react51.useEffect)(() => dispatch2({ [key]: reset }), [props]);
}
...
var KayName = (props) => {
  ...
  const highlightContainer = (0, import_react48.useRef)(null);
  useHighlight({ value, highlightUpdates, highlightContainer });
  return (0, import_jsx_runtime23.jsxs)(import_react48.Fragment, { children: [
...
var Container = (0, import_react47.forwardRef)((props, ref) => {
  ...
  const dispatch2 = useShowToolsDispatch();
  const subkeyid = (0, import_react47.useId)();
...
var JsonView = (0, import_react40.forwardRef)((props, ref) => {
  const {
    className = "",
    style,
    value,
...
var JsonRenderer = ({ data }) => {
  const { settings } = useSettingsContext();
  const originalData = (0, import_react39.useMemo)(
  ...
  const [json, setJson] = (0, import_react39.useState)(originalData);
...
var PageTab = () => {
  ...
  const reversed = (0, import_react37.useMemo)(() => routes.reverse(), [routes]);
...
var NewRouteForm = () => {
  ...
  const [newRouteInfo, setNewRouteInfo] = (0, import_react57.useState)(DEFAULT_VALUES);
  const handleSubmit = () => {
...
var useListenToRouteChange = () => {
  ...
  const ref = (0, import_react59.useRef)(locationRoute);
...
var TransitionGroupContext_default = import_react63.default.createContext(null);
function getChildMapping(children2, mapFn) {
  let mapper = (child) => mapFn && (0, import_react64.isValidElement)(child) ? mapFn(child) : child;
  let result = /* @__PURE__ */ Object.create(null);
  if (children2)
    import_react64.Children.map(children2, (c) => c).forEach((child) => {
...
function getNextChildMapping(nextProps, prevChildMapping, onExited) {
  ...
  Object.keys(children2).forEach((key) => {
    ...
    const isLeaving = (0, import_react64.isValidElement)(prevChild) && !prevChild.props.in;
    if (hasNext && (!hasPrev || isLeaving)) {
      children2[key] = (0, import_react64.cloneElement)(child, {
        onExited: onExited.bind(null, child),
        in: true,
      ...
      children2[key] = (0, import_react64.cloneElement)(child, { in: false });
    } else if (hasNext && hasPrev && (0, import_react64.isValidElement)(prevChild)) {
      children2[key] = (0, import_react64.cloneElement)(child, {
        onExited: onExited.bind(null, child),
...
var TransitionGroup = class extends import_react62.default.Component {
...
var Node2 = class extends import_react65.default.Component {
  constructor() {
    super(...arguments);
...
var Link2 = class extends import_react66.default.PureComponent {
  constructor() {
    super(...arguments);
...
`;
var _a;
var Tree = (_a = class extends import_react61.default.Component {
  constructor() {
    super(...arguments);
    __publicField(this, "state", {
...
var RoutesTab = () => {
  ...
  const { detachedWindow } = useDetachedWindowControls();
  const [activeRoute, setActiveRoute] = (0, import_react55.useState)(null);
  const [routes] = (0, import_react55.useState)(createExtendedRoutes());
  const [treeRoutes] = (0, import_react55.useState)(createRouteTree(window.__remixManifest.routes));
  const isTreeView = routeViewMode === "tree";
...
var useTerminalShortcuts = ({
  ...
  const [historyIndex, setHistoryIndex] = (0, import_react68.useState)();
  const [projectCommandIndex, setProjectCommandIndex] = (0, import_react68.useState)();
...
var Terminal = ({ onClose, terminal, projectCommands }) => {
  ...
  const [command, setCommand] = (0, import_react67.useState)("");
...
var TerminalTab = () => {
  ...
  const [projectCommands, setProjectCommands] = (0, import_react67.useState)();
  const { sendJsonMessage } = useRemixForgeSocket({
    onMessage: (message) => {
      try {
        const data = JSON.parse(message.data);
...
var SettingsTab = () => {
  const { settings, setSettings } = useSettingsContext();
  const [minHeight, setMinHeight] = (0, import_react69.useState)(settings.minHeight.toString());
  const [maxHeight, setMaxHeight] = (0, import_react69.useState)(settings.maxHeight.toString());
  const [expansionLevel, setExpansionLevel] = (0, import_react69.useState)(settings.expansionLevel.toString());
  const [wsPort, setWsPort] = (0, import_react69.useState)(settings.wsPort.toString());
...
var ErrorsTab = () => {
  ...
  const [SSRHtml, setSSRHtml] = (0, import_react70.useState)("");
  const [CSRHtml, setCSRHtml] = (0, import_react70.useState)("");
  const [hasHydrationMismatch, setHasHydrationMismatch] = (0, import_react70.useState)(false);
...
var useTabs = (isConnected, isConnecting, pluginsArray) => {
  ...
  const allTabs = (0, import_react35.useMemo)(() => [...tabs, ...plugins ? plugins : []], [plugins]);
  const { Component, hideTimeline } = (0, import_react35.useMemo)(() => {
  ...
  const visibleTabs = (0, import_react35.useMemo)(
...
var ContentPanel = ({ plugins }) => {
  ...
  return (0, import_jsx_runtime56.jsxs)("div", { className: "rdt-flex rdt-h-full rdt-w-full rdt-overflow-y-hidden", children: [
    ...
    !hideTimeline && (0, import_jsx_runtime56.jsxs)(import_react72.Fragment, { children: [
...
function useBorderedRoutes() {
  const invalidHtmlCollection = (0, import_react73.useRef)([]);
  ...
  const navigation = useNavigation();
  const traverseComponentTree = (0, import_react73.useCallback)((fiberNode, callback) => {
    callback(fiberNode);
  ...
  const styleNearestElement = (0, import_react73.useCallback)((fiberNode) => {
    var _a2, _b;
    if (!fiberNode)
      return;
  ...
  const findIncorrectHtml = (0, import_react73.useCallback)((fiberNode, originalFiberNode, originalTag) => {
    if (!fiberNode)
      return;
...
var useCheckIfStillDetached = () => {
  const { dispatch: dispatch2 } = (0, import_react75.useContext)(RDTContext);
  const [checking, setChecking] = (0, import_react75.useState)(false);
  ...
  const checkDetachment = (0, import_react75.useCallback)(
    (e) => {
...
var useSetRouteBoundaries = () => {
  ...
  const { settings, setSettings } = useSettingsContext();
  const { detachedWindow } = useDetachedWindowControls();
  const applyOrRemoveClasses = (0, import_react76.useCallback)(
    (isHovering) => {
...
var DevTools = ({ plugins: pluginArray }) => {
  ...
  const [isOpen, setIsOpen] = (0, import_react22.useState)(isDetached || settings.defaultOpen || persistOpen);
...
function useHydrated() {
  const [hydrated, setHydrated] = (0, import_react79.useState)(() => !hydrating);
  (0, import_react79.useEffect)(function hydrate() {
    hydrating = false;
    setHydrated(true);
  }, []);
  return hydrated;
...
function useHydrated2() {
  const [hydrated, setHydrated] = (0, import_react80.useState)(() => !hydrating2);
