import {
  ...
  useId,
  useLayoutEffect2
} from "./chunk-G7D4YDF3.js";
import {
  Primitive
} from "./chunk-UQQE3EFE.js";
import {
  arrow,
  autoUpdate,
  computePosition,
  ...
  shift,
  size
} from "./chunk-YUB7OJMG.js";
import {
  useComposedRefs
} from "./chunk-ENPVDYUW.js";
import {
  clsx,
  clsx_default
...
import {
  ...
  useNavigation,
  useRevalidator
} from "./chunk-XYYZ7DPA.js";
import {
  require_jsx_runtime
} from "./chunk-DLONAFAN.js";
import "./chunk-7LQPUWRJ.js";
...
var require_apply = __commonJS({
  "node_modules/diff/lib/patch/apply.js"(exports) {
    ...
    function applyPatch(source, uniDiff) {
      ...
      }, errorCount = 0, fuzzFactor = options.fuzzFactor || 0, minLine = 0, offset3 = 0, removeEOFNL, addEOFNL;
      ...
      for (var i = 0; i < hunks.length; i++) {
        var hunk = hunks[i], maxLine = lines.length - hunk.oldLines, localOffset = 0, toPos = offset3 + hunk.oldStart - 1;
        var iterator = (
          /*istanbul ignore start*/
          (0, /*istanbul ignore end*/
          /*istanbul ignore start*/
        ...
        for (; localOffset !== void 0; localOffset = iterator()) {
          if (hunkFits(hunk, toPos + localOffset)) {
            hunk.offset = offset3 += localOffset;
            break;
          }
        }
...
var require_merge = __commonJS({
  "node_modules/diff/lib/patch/merge.js"(exports) {
    ...
    function cloneHunk(hunk, offset3) {
      return {
        oldStart: hunk.oldStart,
        oldLines: hunk.oldLines,
        newStart: hunk.newStart + offset3,
    ...
    var DiffViewer2 = class extends React13.Component {
      constructor(props) {
        ...
        this.renderSplitView = ({ left, right }, index2) => {
          return (0, jsx_runtime_1.jsxs)("tr", { className: this.styles.line, children: [this.renderLine(left.lineNumber, left.type, LineNumberPrefix.LEFT, left.value), this.renderLine(right.lineNumber, right.type, LineNumberPrefix.RIGHT, right.value)] }, index2);
        };
        this.renderInlineView = ({ left, right }, index2) => {
          ...
          return (0, jsx_runtime_1.jsx)("tr", { className: this.styles.line, children: content }, index2);
        };
  ...
  "node_modules/cssbeautify/cssbeautify.js"(exports, module) {
    (function() {
      ...
      function cssbeautify(style, opt) {
        var options, index2 = 0, length = style.length, blocks, formatted = "", ch, ch2, str, state, State, depth, quote, comment, openbracesuffix = true, autosemicolon = false, trimRight;
        ...
        style = style.replace(/\r\n/g, "\n");
        while (index2 < length) {
          ch = style.charAt(index2);
          ch2 = style.charAt(index2 + 1);
          index2 += 1;
          if (isQuote(quote)) {
            formatted += ch;
            if (ch === quote) {
...
function $c512c27ab02ef895$export$50c7b4e9d9f19c1(scopeName, createContextScopeDeps = []) {
  ...
  function $c512c27ab02ef895$export$fd42f52fd3ae1109(rootComponentName, defaultContext) {
    ...
    function Provider2(props) {
      ...
      const Context7 = (scope === null || scope === void 0 ? void 0 : scope[scopeName][index2]) || BaseContext;
...
// node_modules/remix-development-tools/node_modules/@radix-ui/react-use-escape-keydown/dist/index.mjs
...
function $db6c3485150b8e66$export$1ab7ae714698c4b8(element) {
  const [size3, setSize] = (0, import_react16.useState)(void 0);
  $9f79659886946c16$export$e5c5a5f917a5871c(() => {
    if (element) {
      setSize({
...
var RemoveScroll = React8.forwardRef(function(props, parentRef) {
  ...
  return React8.createElement(
    ...
    forwardProps ? React8.cloneElement(React8.Children.only(children2), __assign(__assign({}, containerProps), { ref: containerRef })) : React8.createElement(Container2, __assign({}, containerProps, { className, ref: containerRef }), children2)
  );
});
...
function RemoveScrollSideCar(props) {
  ...
  var id2 = React11.useState(idCounter++)[0];
  ...
  return React11.createElement(
    React11.Fragment,
    null,
    inert ? React11.createElement(Style2, { styles: generateStyle(id2) }) : null,
...
var $cc7e05a45900e73f$export$ef9b1a59e592288f = (props) => {
  ...
  return (0, import_react25.createElement)($cf1ac5d9fe0e8206$export$be92b6f5f03c0fe9, popperScope, (0, import_react25.createElement)($cc7e05a45900e73f$var$SelectProvider, {
  ...
  }, children2)), isFormControl ? (0, import_react25.createElement)($cc7e05a45900e73f$var$BubbleSelect, {
    key: nativeSelectKey,
    "aria-hidden": true,
    required,
    tabIndex: -1,
    ...
    disabled
  }, value === void 0 ? (0, import_react25.createElement)("option", {
    value: ""
...
var $cc7e05a45900e73f$var$SelectContentImpl = (0, import_react25.forwardRef)((props, forwardedRef) => {
  ...
  const itemRefCallback = (0, import_react25.useCallback)((node, value, disabled) => {
  ...
  const itemTextRefCallback = (0, import_react25.useCallback)((node, value, disabled) => {
    const isFirstValidItem = !firstValidItemFoundRef.current && !disabled;
    const isSelectedItem = context.value !== void 0 && context.value === value;
...
var RDTContext = (0, import_react27.createContext)({ state: initialState, dispatch: () => null });
...
var RDTContextProvider = ({ children: children2 }) => {
  const [state, dispatch2] = (0, import_react27.useReducer)(rdtReducer, getExistingStateFromStorage());
  const value = (0, import_react27.useMemo)(() => ({ state, dispatch: dispatch2 }), [state, dispatch2]);
  useRemoveBody(state);
...
var useRDTContext = () => {
  const context = (0, import_react31.useContext)(RDTContext);
  if (context === void 0) {
...
var useHtmlErrors = () => {
  ...
  const setHtmlErrors = (0, import_react31.useCallback)(
    (htmlErrors2) => {
      dispatch2({
...
var useServerInfo = () => {
  const { state, dispatch: dispatch2 } = useRDTContext();
  const { server } = state;
  const setServerInfo = (0, import_react31.useCallback)(
    (serverInfo) => {
      dispatch2({
...
var useDetachedWindowControls = () => {
  ...
  const setDetachedWindowOwner = (0, import_react31.useCallback)(
...
var useSettingsContext = () => {
  ...
  const setSettings = (0, import_react31.useCallback)(
    (settings2) => {
      dispatch2({
        type: "SET_SETTINGS",
        payload: settings2
...
var usePersistOpen = () => {
  ...
  const setPersistOpen = (0, import_react31.useCallback)(
    (persistOpen2) => {
      dispatch2({
...
var useTimelineContext = () => {
  ...
  const setTimelineEvent = (0, import_react31.useCallback)(
    (payload) => {
      dispatch2({ type: "SET_TIMELINE_EVENT", payload });
    },
    [dispatch2]
  );
  const clearTimeline = (0, import_react31.useCallback)(() => {
...
var useTerminalContext = () => {
  ...
  const addOrRemoveTerminal = (0, import_react31.useCallback)(
    (terminalId) => {
      dispatch2({ type: "ADD_OR_REMOVE_TERMINAL", payload: terminalId });
    },
    [dispatch2]
  );
  const toggleTerminalLock = (0, import_react31.useCallback)(
    (terminalId, locked) => {
      dispatch2({
  ...
  const addTerminalOutput = (0, import_react31.useCallback)(
    (terminalId, output) => {
      dispatch2({
  ...
  const clearTerminalOutput = (0, import_react31.useCallback)(
    (terminalId) => {
      dispatch2({ type: "CLEAR_TERMINAL_OUTPUT", payload: terminalId });
    },
    [dispatch2]
  );
  const addTerminalHistory = (0, import_react31.useCallback)(
    (terminalId, history2) => {
      dispatch2({
  ...
  const setProcessId = (0, import_react31.useCallback)(
  ...
  for (const key of formData.keys()) {
    if (key.includes(".")) {
      ...
      if (isNaN(parseInt(suffix))) {
        ...
        obj[prefix] ?? (obj[prefix] = []);
        for (const [index2, element] of formData.getAll(key).entries()) {
          if (index2 > 1) {
...
var useTimelineHandler = () => {
  ...
  const navigationEventQueue = (0, import_react30.useRef)([]);
  ...
  const fetcherEventQueue = (0, import_react30.useRef)([]);
  (0, import_react30.useEffect)(() => {
...
var useResize = () => {
  ...
  const [isResizing, setIsResizing] = (0, import_react33.useState)(false);
  const enableResize = (0, import_react33.useCallback)(() => {
    setIsResizing(true);
  }, [setIsResizing]);
  const disableResize = (0, import_react33.useCallback)(() => {
    setIsResizing(false);
  }, [setIsResizing]);
  const resize = (0, import_react33.useCallback)(
    (e) => {
      var _a2;
      if (isResizing) {
...
var useAttachListenerToNode = (listener, node, fn, shouldAttach = true) => {
  const callbackRef = (0, import_react35.useRef)(fn);
...
function useDebounce(callback, delay = 300) {
  const callbackRef = import_react36.default.useRef(callback);
  import_react36.default.useEffect(() => {
    callbackRef.current = callback;
  });
  return import_react36.default.useMemo(() => debounce((...args) => callbackRef.current(...args), delay), [delay]);
}
var useResizeDetachedPanel = () => {
  const { isDetached } = useDetachedWindowControls();
  const [state, setState] = (0, import_react34.useState)(0);
...
var useWebSocket = (url, options = DEFAULT_OPTIONS, connect = true) => {
  const [lastMessage, setLastMessage] = (0, import_react37.useState)(null);
  const [readyState, setReadyState] = (0, import_react37.useState)({});
  const lastJsonMessage = (0, import_react37.useMemo)(() => {
    if (lastMessage) {
      try {
  ...
  const convertedUrl = (0, import_react37.useRef)(null);
  const webSocketRef = (0, import_react37.useRef)(null);
  const startRef = (0, import_react37.useRef)(() => void 0);
  const reconnectCount = (0, import_react37.useRef)(0);
  const messageQueue = (0, import_react37.useRef)([]);
  const webSocketProxy = (0, import_react37.useRef)(null);
  const optionsCache = (0, import_react37.useRef)(options);
  ...
  const sendMessage = (0, import_react37.useCallback)((message, keep = true) => {
    var _a2;
  ...
  const sendJsonMessage = (0, import_react37.useCallback)(
    (message, keep = true) => {
      sendMessage(JSON.stringify(message), keep);
    },
    [sendMessage]
  );
  const getWebSocket = (0, import_react37.useCallback)(() => {
...
var useRemixForgeSocket = (options) => {
  ...
  const [retryCount, setRetryCount] = (0, import_react38.useState)(0);
  const opts = {
    ...options,
    share: true,
...
var useCountdown = (targetDate) => {
  ...
  const [countDown, setCountDown] = (0, import_react42.useState)(countDownDate - (/* @__PURE__ */ new Date()).getTime());
...
var initialState2 = {};
var Context = (0, import_react46.createContext)(initialState2);
...
var DispatchShowTools = (0, import_react46.createContext)(() => {
});
DispatchShowTools.displayName = "JVR.DispatchShowTools";
function useShowTools() {
  return (0, import_react46.useReducer)(reducer, initialState2);
}
function useShowToolsDispatch() {
  return (0, import_react46.useContext)(DispatchShowTools);
}
...
var initialState3 = {};
var Context2 = (0, import_react47.createContext)(initialState3);
var reducer2 = (state, action) => ({
  ...state,
  ...action
});
var useExpandsStore = () => {
  return (0, import_react47.useContext)(Context2);
};
var DispatchExpands = (0, import_react47.createContext)(() => {
});
DispatchExpands.displayName = "JVR.DispatchExpands";
function useExpands() {
  return (0, import_react47.useReducer)(reducer2, initialState3);
}
function useExpandsDispatch() {
  return (0, import_react47.useContext)(DispatchExpands);
}
...
var Context3 = (0, import_react48.createContext)(initialState4);
var reducer3 = (state, action) => ({
  ...state,
  ...action
});
var useTypesStore = () => {
  return (0, import_react48.useContext)(Context3);
};
var DispatchTypes = (0, import_react48.createContext)(() => {
});
DispatchTypes.displayName = "JVR.DispatchTypes";
function useTypes() {
  return (0, import_react48.useReducer)(reducer3, initialState4);
}
function useTypesDispatch() {
  return (0, import_react48.useContext)(DispatchTypes);
}
...
var Context4 = (0, import_react49.createContext)(initialState5);
var reducer4 = (state, action) => ({
  ...state,
  ...action
});
var useSymbolsStore = () => {
  return (0, import_react49.useContext)(Context4);
};
var DispatchSymbols = (0, import_react49.createContext)(() => {
});
DispatchSymbols.displayName = "JVR.DispatchSymbols";
function useSymbols() {
  return (0, import_react49.useReducer)(reducer4, initialState5);
}
function useSymbolsDispatch() {
  return (0, import_react49.useContext)(DispatchSymbols);
}
...
var Context5 = (0, import_react50.createContext)(initialState6);
var reducer5 = (state, action) => ({
  ...state,
  ...action
});
var useSectionStore = () => {
  return (0, import_react50.useContext)(Context5);
};
var DispatchSection = (0, import_react50.createContext)(() => {
});
DispatchSection.displayName = "JVR.DispatchSection";
function useSection() {
  return (0, import_react50.useReducer)(reducer5, initialState6);
}
function useSectionDispatch() {
  return (0, import_react50.useContext)(DispatchSection);
}
...
var Context6 = (0, import_react45.createContext)(initialState7);
Context6.displayName = "JVR.Context";
var DispatchContext = (0, import_react45.createContext)(() => {
});
...
var useStore = () => {
  return (0, import_react45.useContext)(Context6);
};
var Provider = ({
  children: children2,
  initialState: init2,
  ...
  const [state, dispatch2] = (0, import_react45.useReducer)(reducer6, Object.assign({}, initialState7, init2));
  ...
  (0, import_react45.useEffect)(() => dispatch2({ ...init2 }), [init2]);
...
var TypeString = ({ children: children2 = "", expandKey, keyName }) => {
  ...
  const [shorten, setShorten] = (0, import_react53.useState)(length && childrenStr.length >= length);
  const Comp = as || "span";
  const style = {
    ...defalutStyle,
    ...Str.style || {}
  ...
  return (0, import_jsx_runtime20.jsxs)(import_react53.Fragment, { children: [
    displayDataTypes && (type || (0, import_jsx_runtime20.jsx)(Comp, { ...reset, style })),
    child || (0, import_jsx_runtime20.jsxs)(import_react53.Fragment, { children: [
...
function useSymbolsRender(currentProps, props, key) {
  ...
  (0, import_react55.useEffect)(() => dispatch2({ [key]: reset }), [props]);
}
...
function useHighlight({ value, highlightUpdates, highlightContainer }) {
  ...
  const isHighlight = (0, import_react56.useMemo)(() => {
...
var KayName = (props) => {
  ...
  const highlightContainer = (0, import_react52.useRef)(null);
  useHighlight({ value, highlightUpdates, highlightContainer });
  return (0, import_jsx_runtime23.jsxs)(import_react52.Fragment, { children: [
...
var KeyValuesItem = (props) => {
  ...
  const subkeyid = (0, import_react52.useId)();
  const isMyArray = Array.isArray(value);
  const isMySet = value instanceof Set;
...
var JsonView = (0, import_react44.forwardRef)((props, ref) => {
  const {
    className = "",
    style,
    value,
...
var JsonRenderer = ({ data }) => {
  const { settings } = useSettingsContext();
  const originalData = (0, import_react43.useMemo)(
  ...
  const [json, setJson] = (0, import_react43.useState)(originalData);
...
var emptyFill = [];
var strokeIcon = [];
var Icon = ({ name, testId, className, size: size3 = "sm", ...props }) => {
  const iconSize = IconSize[size3];
...
var PageTab = () => {
  ...
  const reversed = (0, import_react41.useMemo)(() => routes.reverse(), [routes]);
...
var AccordionItem2 = React62.forwardRef(({ className, ...props }, ref) => (0, import_jsx_runtime35.jsx)(Item, { ref, className: cn("rdt-border-b rdt-border-b-gray-500", className), ...props }));
AccordionItem2.displayName = "AccordionItem";
var AccordionTrigger2 = React62.forwardRef(({ className, children: children2, ...props }, ref) => (0, import_jsx_runtime35.jsx)(Header, { className: "rdt-flex", children: (0, import_jsx_runtime35.jsxs)(
  Trigger2,
  {
    ref,
    className: cn(
...
var AccordionContent2 = React62.forwardRef(({ className, children: children2, ...props }, ref) => (0, import_jsx_runtime35.jsx)(
  Content2,
  {
    ref,
    className: cn(
...
var NewRouteForm = () => {
  ...
  const [newRouteInfo, setNewRouteInfo] = (0, import_react61.useState)(DEFAULT_VALUES);
  const handleSubmit = () => {
...
var useListenToRouteChange = () => {
  ...
  const ref = (0, import_react63.useRef)(locationRoute);
...
function executeShifts(v) {
  var shift3 = 0, change = 0, children2 = v.children, i = children2.length, w;
  while (--i >= 0) {
    w = children2[i];
    w.z += shift3;
    w.m += shift3;
...
function tree_default() {
  ...
  function apportion(v, w, ancestor) {
    if (w) {
      var vip = v, vop = v, vim = w, vom = vip.parent.children[0], sip = vip.m, sop = vop.m, sim = vim.m, som = vom.m, shift3;
      while (vim = nextRight(vim), vip = nextLeft(vip), vim && vip) {
        ...
        if (shift3 > 0) {
          moveSubtree(nextAncestor(vim, v, ancestor), v, shift3);
          sip += shift3;
          sop += shift3;
        }
        sim += vim.m;
...
var TransitionGroupContext_default = import_react67.default.createContext(null);
function getChildMapping(children2, mapFn) {
  let mapper = (child) => mapFn && (0, import_react68.isValidElement)(child) ? mapFn(child) : child;
  let result = /* @__PURE__ */ Object.create(null);
  if (children2)
    import_react68.Children.map(children2, (c) => c).forEach((child) => {
...
function getNextChildMapping(nextProps, prevChildMapping, onExited) {
  ...
  Object.keys(children2).forEach((key) => {
    ...
    const isLeaving = (0, import_react68.isValidElement)(prevChild) && !prevChild.props.in;
    if (hasNext && (!hasPrev || isLeaving)) {
      children2[key] = (0, import_react68.cloneElement)(child, {
        onExited: onExited.bind(null, child),
        in: true,
      ...
      children2[key] = (0, import_react68.cloneElement)(child, { in: false });
    } else if (hasNext && hasPrev && (0, import_react68.isValidElement)(prevChild)) {
      children2[key] = (0, import_react68.cloneElement)(child, {
        onExited: onExited.bind(null, child),
...
var TransitionGroup = class extends import_react66.default.Component {
...
var Node2 = class extends import_react69.default.Component {
  constructor() {
    super(...arguments);
...
var Link2 = class extends import_react70.default.PureComponent {
  constructor() {
    super(...arguments);
...
`;
var _a;
var Tree = (_a = class extends import_react65.default.Component {
  constructor() {
    super(...arguments);
    __publicField(this, "state", {
...
var RoutesTab = () => {
  ...
  const { detachedWindow } = useDetachedWindowControls();
  const [activeRoute, setActiveRoute] = (0, import_react59.useState)(null);
  const [routes] = (0, import_react59.useState)(createExtendedRoutes());
  const [treeRoutes] = (0, import_react59.useState)(createRouteTree(window.__remixManifest.routes));
  const isTreeView = routeViewMode === "tree";
...
var useTerminalShortcuts = ({
  ...
  const [historyIndex, setHistoryIndex] = (0, import_react72.useState)();
  const [projectCommandIndex, setProjectCommandIndex] = (0, import_react72.useState)();
...
var Terminal = ({ onClose, terminal, projectCommands }) => {
  ...
  const [command, setCommand] = (0, import_react71.useState)("");
...
var TerminalTab = () => {
  ...
  const [projectCommands, setProjectCommands] = (0, import_react71.useState)();
  const { sendJsonMessage } = useRemixForgeSocket({
    onMessage: (message) => {
      try {
        const data = JSON.parse(message.data);
...
var SelectTrigger = React122.forwardRef(({ className, children: children2, ...props }, ref) => (0, import_jsx_runtime50.jsxs)(
...
var SelectContent = React122.forwardRef(({ className, children: children2, position = "popper", ...props }, ref) => (0, import_jsx_runtime50.jsx)($cc7e05a45900e73f$export$602eac185826482c, { children: (0, import_jsx_runtime50.jsx)(
...
var SelectLabel = React122.forwardRef(({ className, ...props }, ref) => (0, import_jsx_runtime50.jsx)(
...
var SelectItem = React122.forwardRef(({ className, children: children2, ...props }, ref) => (0, import_jsx_runtime50.jsxs)(
...
var SelectSeparator = React122.forwardRef(({ className, ...props }, ref) => (0, import_jsx_runtime50.jsx)(
...
var SettingsTab = () => {
  const { settings, setSettings } = useSettingsContext();
  const [minHeight, setMinHeight] = (0, import_react73.useState)(settings.minHeight.toString());
  const [maxHeight, setMaxHeight] = (0, import_react73.useState)(settings.maxHeight.toString());
  const [expansionLevel, setExpansionLevel] = (0, import_react73.useState)(settings.expansionLevel.toString());
  const [wsPort, setWsPort] = (0, import_react73.useState)(settings.wsPort.toString());
...
var ErrorsTab = () => {
  ...
  const [SSRHtml, setSSRHtml] = (0, import_react74.useState)("");
  const [CSRHtml, setCSRHtml] = (0, import_react74.useState)("");
  const [hasHydrationMismatch, setHasHydrationMismatch] = (0, import_react74.useState)(false);
...
var useTabs = (isConnected, isConnecting, pluginsArray) => {
  ...
  const allTabs = (0, import_react39.useMemo)(() => [...tabs, ...plugins ? plugins : []], [plugins]);
  const { Component, hideTimeline } = (0, import_react39.useMemo)(() => {
  ...
  const visibleTabs = (0, import_react39.useMemo)(
...
var ContentPanel = ({ plugins }) => {
  ...
  return (0, import_jsx_runtime56.jsxs)("div", { className: "rdt-flex rdt-h-full rdt-w-full rdt-overflow-y-hidden", children: [
    ...
    !hideTimeline && (0, import_jsx_runtime56.jsxs)(import_react76.Fragment, { children: [
...
function useBorderedRoutes() {
  const invalidHtmlCollection = (0, import_react77.useRef)([]);
  ...
  const navigation = useNavigation();
  const traverseComponentTree = (0, import_react77.useCallback)((fiberNode, callback) => {
    callback(fiberNode);
  ...
  const styleNearestElement = (0, import_react77.useCallback)((fiberNode) => {
    var _a2, _b;
    if (!fiberNode)
      return;
  ...
  const findIncorrectHtml = (0, import_react77.useCallback)((fiberNode, originalFiberNode, originalTag) => {
    if (!fiberNode)
      return;
...
var useCheckIfStillDetached = () => {
  const { dispatch: dispatch2 } = (0, import_react79.useContext)(RDTContext);
  const [checking, setChecking] = (0, import_react79.useState)(false);
  ...
  const checkDetachment = (0, import_react79.useCallback)(
    (e) => {
...
var useSetRouteBoundaries = () => {
  ...
  const { settings, setSettings } = useSettingsContext();
  const { detachedWindow } = useDetachedWindowControls();
  const applyOrRemoveClasses = (0, import_react80.useCallback)(
    (isHovering) => {
...
var DevTools = ({ plugins: pluginArray }) => {
  ...
  const [isOpen, setIsOpen] = (0, import_react26.useState)(isDetached || settings.defaultOpen || persistOpen);
...
function useHydrated() {
  const [hydrated, setHydrated] = (0, import_react83.useState)(() => !hydrating);
  (0, import_react83.useEffect)(function hydrate() {
    hydrating = false;
    setHydrated(true);
  }, []);
  return hydrated;
...
function useHydrated2() {
  const [hydrated, setHydrated] = (0, import_react84.useState)(() => !hydrating2);
  (0, import_react84.useEffect)(function hydrate() {
    hydrating2 = false;
    setHydrated(true);
  }, []);
  return hydrated;
