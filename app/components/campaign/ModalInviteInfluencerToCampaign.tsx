...
const initialFilter = { age: [0, 100], gender: [], location: '', socialMedias: [], minFollow: 0, maxFollow: 5000000 }
                                        ...
                                        <div className='mt-3'>
                                            ...
                                            <div className='mt-4'>
                                                ...
                                                <div className='flex items-center gap-2'>
                                                    ...
                                                    <Slider max={5000000} step={50000} onChange={(value: number[]) => setFilter({ ...filter, minFollow: value[0], maxFollow: value[1] })}
