                        ...
                        <div className='flex mt-5 items-center justify-between'>
                            ...
                            <div className='flex items-center gap-3'>
                                <div className='flex items-center gap-2'>
                                   <Tooltip title='The final date and time by which content must be submitted.'>
                                   <QuestionMarkCircleIcon className='w-5 h-5 cursor-pointer text-gray-800' />
                                   </Tooltip>
                                    <span className='text-sm font-medium text-gray-800'>Deadline</span>
                                    <DatePicker style={{ maxHeight: 36 }} className='h-[36px] bg-gray-100 border-none' />
                                </div>
                                <Popover
                                    content={
